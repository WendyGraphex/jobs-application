...
class CustomerContactEmailEngine extends  mfEmailEngineCore  {
    
    protected $user=null,$settings=null;
        
    function __construct(CustomerContact $user,$options=array()) {
       $this->user=$user;     
       $this->settings=new CustomerContactSettings();
    ...
    {                 
         ...
         {                        
            ...
            $this->getMailer()->sendMail('customers_contact','emailRegistration',$this->getCompany()->getEmailWithName(), 
                                $this->getCustomer()->get('email'), 
