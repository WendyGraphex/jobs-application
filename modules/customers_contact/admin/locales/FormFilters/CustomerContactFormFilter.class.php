...
class CustomerContactFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerContact');
       
       $this->setFields(array(
           'lastname'=>array(            
              'search'=>array('conditions'=>
                                                 "(".
               CustomerContact::getTableField('lastname')." COLLATE UTF8_GENERAL_CI LIKE '%%{lastname}%%' OR ".
               CustomerContact::getTableField('firstname')." COLLATE UTF8_GENERAL_CI LIKE '%%{firstname}%%'".
                                                 ")")
                                ),
           'firstname'=>array(             
              'search'=>array('conditions'=>
           ...
           'email'=>array(                     
                        'search'=>array('conditions'=>CustomerContact::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{email}%%' ")
                        ),          
           'adress1'=>array(                       
                        'search'=>array('conditions'=>CustomerContact::getTableField('adress1')." COLLATE UTF8_GENERAL_CI LIKE '%%{adress1}%%' ")
                        ),
           'adress2'=>array(                       
                        'search'=>array('conditions'=>CustomerContact::getTableField('adress2')." COLLATE UTF8_GENERAL_CI LIKE '%%{adress2}%%' ")
                        ),
           'city'=>array(                       
                        'search'=>array('conditions'=>CustomerContact::getTableField('city')." COLLATE UTF8_GENERAL_CI LIKE '%%{city}%%' ")
                        ),
       ));
       $this->setQuery("SELECT {fields} FROM ".CustomerContact::getTable().                            
                       ";"); 
       // Validators 
