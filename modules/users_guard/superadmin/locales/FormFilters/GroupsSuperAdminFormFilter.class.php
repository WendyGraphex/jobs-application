...
class GroupsSuperAdminFormFilter extends mfFormFilterBase {
    ...
    function configure()
    {
      $this->setDefaults(array(
       ...
       // Base Query
       $this->setQuery("SELECT id,name,is_active,updated_at,created_at FROM t_groups WHERE application=@@APPLICATION@@;");
       // Validators
