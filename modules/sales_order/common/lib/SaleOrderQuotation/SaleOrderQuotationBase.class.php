...
class SaleOrderQuotationBase extends mfObject3 {
     
    protected static $fields=array('signature','order_id','quotation_id','tax_id',
                                   'in_at','out_at','number_of_hours','employer_user_id',
                                   'cart_quotation_id','cart_id','project_id',
   ...
   const table="t_sale_order_quotation"; 
   protected static $foreignKeys=array('order_id'=>'SaleOrder',
   ...
   protected static $fieldsNull=array('in_at','out_at','tax_id','project_id'); // By default
    ...
    {
        return $this->formatter=$this->formatter===null?new SaleOrderQuotationFormatter($this):$this->formatter;
    }
   ...
   /*  function getEngine()
    ...
    {
        $values=$this->toArray(array('order_id','quotation_id','tax_id',
                                   'in_at','out_at','number_of_hours','employer_user_id',
                                   'project_id',
                                   'sale_price_with_tax','sale_price_without_tax','employee_user_id',
                                   'total_sale_price_with_tax','total_sale_price_without_tax',
                                   'quantity','comments'));
        $values['order_quotation_id']= $this->get('id');
        return $values;
    }
}
