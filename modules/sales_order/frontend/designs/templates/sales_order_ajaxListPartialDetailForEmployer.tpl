                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div><a href="{$item->getQuotation()->getEmployerAdvertI18n()->getUrl()}" target="_blank">{$item->getQuotation()->getEmployerAdvertI18n()->get('reference')}</a></div>
                                            <div>{$item->getQuotation()->getEmployerAdvertI18n()->getFormatter()->getTitle()->ucfirst()}</div>
                                        </td>    
