...
class SaleOrderForEmployerFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('SaleOrder');
       
       $this->setFields(array(
          
         
           ));
       $this->setQuery("SELECT {fields} FROM ".SaleOrder::getTable().   
                       " LEFT JOIN ".SaleOrder::getOuterForJoin('payment_id').  
                     /*  " INNER JOIN ".SaleOrderQuotation::getOuterForJoin('employee_user_id').   
                       ...
                       " WHERE ".SaleOrder::getTableField('status')."='ACTIVE' AND ".
                                SaleOrder::getTableField('employer_user_id')."='{employer_user_id}'".
                       ";"); 
       // Validators 
