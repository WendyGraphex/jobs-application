...
require_once __DIR__."/../locales/Forms/SiteEmailSettingForm.class.php";

class site_ajaxPartialEmailSettingsAction extends mfAction {

     function execute(mfWebRequest $request) 
    {           
        $messages = mfMessages::getInstance();
        $this->settings= new SiteSettings();
        $this->form=new SiteEmailSettingForm($this->settings,$request->getPostParameter('Settings'));                     
        $this->getEventDispather()->notify(new mfEvent($this->form,'site.email.settings.form'));
