...
require_once __DIR__."/../locales/Forms/SiteSettingForm.class.php";

class site_ajaxPartialSettingsAction extends mfAction {

     function execute(mfWebRequest $request) 
    {           
        $messages = mfMessages::getInstance();
        $this->settings= new SiteSettings();
        $this->form=new SiteSettingForm($this->settings,$request->getPostParameter('Settings'));                     
        $this->getEventDispather()->notify(new mfEvent($this->form,'site.settings.form'));
