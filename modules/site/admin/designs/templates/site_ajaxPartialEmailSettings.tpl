    ...
    <!-- Begin page heading -->
          <div class="row admin-header-container">
            <div class="col-sm">
              ...
              <h3 class="admin-header-small-text">{__('Emails Settings management')}</h3>
            </div>
          ...
          <!-- Begin breadcrumb -->
            <div class="breadcrumb-title">
                <p>
                    ...
                    <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('Emails Settings')}
                </p>
            </div>        
      ...
      $('#Save').click(function(){
       ...
       //      alert("Params="+params.toSource());   return ;
          return $.ajax2({ data : params,
                           url: "{url_to('site_ajax',['action'=>'PartialEmailSettings'])}",
                           target: "#actions"});
        });
</script>
