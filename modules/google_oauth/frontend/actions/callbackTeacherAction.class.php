...
class google_oauth_callbackTeacherAction extends mfActions {
    ...
    function execute(mfWebRequest $request) {    
        ...
        {                      
            ...
            $client->setRedirectUri($settings->getTeacherUri());      
           ...
           if (!$access_token) 
            ...
            $teacher = new EmployerUser($user->getEMail()); 
            $teacher->add(array(
                'firstname'=>$user->getGivenName(),                       
                'lastname'=>$user->getFamilyName(),
                'is_locked'=>'NO'
            ))->validate();
            $teacher->uploadAvatarFromUrl(new GooglePicture($user->getPicture()));
