...
class EmployeeAdvertI18nAbuseFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployeeAdvertI18nAbuse');
       
       $this->setFields(array(
           'lastname'=>array(            
              'search'=>array('conditions'=>
                                                 "(".
               EmployeeAdvertI18nAbuse::getTableField('lastname')." COLLATE UTF8_GENERAL_CI LIKE '%%{lastname}%%' OR ".
               EmployeeAdvertI18nAbuse::getTableField('firstname')." COLLATE UTF8_GENERAL_CI LIKE '%%{firstname}%%'".
                                                 ")")
                                ),
           'firstname'=>array(             
              'search'=>array('conditions'=>
           ...
           'email'=>array(                     
                        'search'=>array('conditions'=>EmployeeAdvertI18nAbuse::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{email}%%' ")
             ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployeeAdvertI18nAbuse::getTable().  
                       " INNER JOIN ".EmployeeAdvertI18nAbuse::getOuterForJoin('advert_i18n_id').  
                       " LEFT JOIN ".EmployeeAdvertI18nAbuse::getOuterForJoin('type_id').  
