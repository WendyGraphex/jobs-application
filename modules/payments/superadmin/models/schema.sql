...
CREATE TABLE IF NOT EXISTS `t_payment_method_settings` (
  ...
  `amount_maximum` decimal(10,3) NOT NULL DEFAULT 0,  
  `amount_minimum` decimal(10,3) NOT NULL DEFAULT 0,    
  `adder` decimal(10,3) NOT NULL DEFAULT 0,    
  `adder_rate` decimal(5,3) NOT NULL DEFAULT 0,    
...
ALTER TABLE `t_payment_method_settings` ADD CONSTRAINT `payment_method_settings_fk0` FOREIGN KEY (`method_id`) REFERENCES `t_payment_method` (`id`) ON DELETE CASCADE;
