...
{* =================================== PAGER/FILTER ======================================================== *}
        ...
        {          
           return $.ajax2({ data: getFilterParameters(), 
                            url:"{url_to('customers_academy_cart_ajax',['action'=>'ListPartial'])}" ,                          
                            target: "#actions"
                             });
        }
...
{* =================================== ACTIONS ======================================================== *}
        ...
        $(".pager").click(function () {                     
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('customers_academy_cart_ajax',['action'=>'ListPartial'])}?page="+$(this).attr('data-page'),                                
                                 target: "#actions"
                });
        });
    ...
    /*  $(".Products").click( function () {                    
                  return $.ajax2({ data : { Cart : $(this).attr('id') },                               
                                  url:"{url_to('customers_academy_cart_ajax',['action'=>'ListPartialProductForCart'])}", 
                                  target: "#actions"});
          });
    ...
    $(".Display").click( function () {                    
                  return $.ajax2({ data : { Cart : $(this).attr('id') },                               
                                  url:"{url_to('customers_academy_cart_ajax',['action'=>'DisplayCart'])}", 
                                  target: "#actions"});
          });
