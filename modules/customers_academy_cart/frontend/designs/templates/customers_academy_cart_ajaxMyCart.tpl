                ...
                <div class="row py-5 bg-white" style="padding: 20px;">
                    <div class="col-lg-12">
                        ...
                        <p class="font-italic mb-4">
                            ...
                            may also collect taxes (such as value added tax (VAT) in Europe) on Service Fees.
                            Additionally, the use of various Payment Methods offered through the Site, and the Site Services may incur added fees or charges. All Payment Methods are posted on the Site along with any associated fees or charges, which we may update from time to time at our sole discretion. You hereby authorize us to charge to you and to collect from you (consistent with this Agreement, the User Agreement, or elsewhere in the Terms of Service) any fees, charges, or taxes.
                        </p>           
                    </div>
                    <div class="mb-4">
    ...
    {JqueryScriptsReady}
       ...
       $(".CartQuotation-Delete").click(function () {    
           ...
           return $.ajax2({ data : { CartQuotation : $(this).attr('id') },
                            url :"{url_to('customers_academy_cart_ajax',['action'=>'DeleteCartQuotation'])}",                            
