...
class customers_newsletter_ajaxDeleteMultipleEmailAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {             
      ...
      {         
          ...
          $newsletters= new CustomerNewsletterCollection($request->getPostParameter('selection'));
          $newsletters->delete();          
