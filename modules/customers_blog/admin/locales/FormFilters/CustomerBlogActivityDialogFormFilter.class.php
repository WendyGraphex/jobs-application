...
class CustomerBlogActivityDialogFormFilter extends mfFormFilterBase {
       ...
       $this->setFields(array(                      
           'title'=>array(
              ...
              'search'=>array('conditions'=>
                                                 "(".
               CustomerBlogActivityI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' OR ".
                  CustomerBlogActivity::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%'".
                                                 ")")
                                ),  
           ));
