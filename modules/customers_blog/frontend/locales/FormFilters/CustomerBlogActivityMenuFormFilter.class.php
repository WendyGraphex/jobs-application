...
class CustomerBlogActivityMenuFormFilter extends mfFormFilter2 {
    ...
    {  
       ...
       $this->setValidators(array( 
        ...
        $this->setQuery(mfQuery::getInstance()->select("{fields}")
                    ->from(CustomerBlogActivityMenu::getTable())               
                    ->inner(CustomerBlogActivityMenu::getOuterForJoin('activity_id'))           
                    ->inner(CustomerBlogActivityI18n::getInnerForJoin('activity_id'))                     
                    ->where(CustomerBlogActivityMenu::getTableField('lb')." >= {lb} ".
                            " AND ".CustomerBlogActivityMenu::getTableField('rb')." <= {rb} ". 
                            " AND ".CustomerBlogActivityMenu::getTableField('level')."='{level_plus_one}' ".     
