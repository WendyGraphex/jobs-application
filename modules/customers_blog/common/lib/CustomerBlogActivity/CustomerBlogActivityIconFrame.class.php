...
class CustomerBlogActivityIconFrame  extends Pictures {
    ...
    {   
        return new PictureObject3(array(
                 ...
                 "transparent"=>true,
                 "urlPath"=>url("/data/activities/icon/".$this->getItem()->get('id')."/".$type,"web","frontend"),
                 "url"=>url("/data/activities/icon/".$this->getItem()->get('id')."/".$type."/".$this->getItem()->get('icon'),"web","frontend")
              ));
    }
