...
class CustomerBlogArticlePictureFrame  extends Pictures {
    ...
    {   
        return new PictureObject3(array(
                 ...
                 "transparent"=>true,
                 "urlPath"=>url("/data/articles/pictures/".$this->getItem()->get('id')."/".$type,"web","frontend"),
                 "url"=>url("/data/articles/pictures/".$this->getItem()->get('id')."/".$type."/".$this->getItem()->get('picture'),"web","frontend")
              ));
    }
