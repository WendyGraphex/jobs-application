...
class CustomerBlogActivityMenuIconFrame  extends Pictures {
   ...
   /* function generate()
    ...
    protected function getPicture($type="")
    {
        return new PictureObject3(array(
                 ...
                 "transparent"=>true,
                 "urlPath"=>url("/data/activities/menu/icon/".$this->getItem()->get('id')."/".$type,"web","frontend"),
                 "url"=>url("/data/activities/menu/icon/".$this->getItem()->get('id')."/".$type."/".$this->getItem()->get('icon'),"web","frontend")
              ));
    }
