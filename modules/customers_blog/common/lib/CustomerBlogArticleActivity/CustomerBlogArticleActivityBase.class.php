...
class CustomerBlogArticleActivityBase extends mfObject3 {
    
     protected static $fields=array('activity_id','article_id','created_at','updated_at');    
    const table="t_customer_blog_article_activity"; 
    protected static $foreignKeys=array('article_id'=>'CustomerBlogArticle','activity_id'=>'CustomerBlogActivity'); // By default
