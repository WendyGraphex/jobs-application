...
class GalleryI18nCollectionExistsValidator extends mfValidatorString {
    ...
    {        
        ...
        $db->setQuery("SELECT count(".GalleryI18n::getKeyName().") FROM ".GalleryI18n::getTable().
                           " WHERE ".GalleryI18n::getTableField('id')." IN('".implode("','",$escapes)."')".
                           ";")               
                ->makeSiteSqlQuery(); 
         $row=$db->fetchRow();
