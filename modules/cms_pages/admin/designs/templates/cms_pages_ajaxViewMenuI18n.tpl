       ...
       <div style="float: right;"> 
          ...
          <div class="breadcrumb-title">
            <p>                
                ...
                <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('View menu')} 
            </p>
          </div>
          <!-- End breadcrumb -->
{alerts}
...
<div class="tablewhiteback" style="padding: 20px;">
      <div class="row">
            ...
            <div class="form-group col-md-6" style="display: flex;line-height: 36px;">                                              
                    {if $item_i18n->getMenu()->hasPage()}                
                         <h4 id="page-ctn" style="margin-right: 10px;" class="CmsPage" name="page_id" data-id="{$item_i18n->getMenu()->get('page_id')}">{$item_i18n->getMenu()->getPage()->getI18n()->getFormatter()->getMetaTitle()}                       
                         </h4>                        
                    {else}
                         <h4 id="page-ctn" style="margin-right: 10px;" class="CmsPage" name="page_id">{__('No Page')}</h4>    
                    {/if}                         
                     ...
                     <a href="#" id="DeletePage" class="{if !$item_i18n->getMenu()->hasPage()}hide{else}show{/if}"><i class="fa fa-times" aria-hidden="true"></i></a>                   
           ...
           {* <div class="form-group col-md-2" style="text-align: right;">
                ...
                <a href="#" id="List" title="{__('Select a page')}"><i class="fa fa-list-ul" aria-hidden="true"></i></a>            
                <a href="#" id="New" class="{if $item_i18n->getMenu()->hasPage()}hide{/if}" title="{__('New page')}"><i class="fa fa-plus" aria-hidden="true"></i></a>
               {* <a href="#" id="Delete" class="{if !$item_i18n->getMenu()->hasPage()}hide{/if}" title="{__('Remove page')}" class="hide"><i class="fa fa-minus" aria-hidden="true"></i></a> *}
            {*  </div>  *}
      </div>
      <ul class="nav nav-tabs" id="myTab" role="tablist">    
           ...
           <li class="nav-item">
           <a class="nav-link {if !$item_i18n->getMenu()->hasPage() && !$form->hasPage()}hide{/if} CmsPageTab" id="t-control-tab" data-toggle="tab" href="#t-control" role="tab" aria-controls="t-control" aria-selected="false">{__('Control')}</a>
         </li>
         <li class="nav-item">
           <a class="nav-link {if !$item_i18n->getMenu()->hasPage() && !$form->hasPage()}hide{/if} CmsPageTab" id="t-referencement-tab" data-toggle="tab" href="#t-referencement" role="tab" aria-controls="t-referencement" aria-selected="false">{__('Referencement')} </a>
         </li>                   
           <li class="nav-item">
           <a class="nav-link {if !$item_i18n->getMenu()->hasPage() && !$form->hasPage()}hide{/if} CmsPageTab" id="t-picture-tab" data-toggle="tab" href="#t-picture" role="tab" aria-controls="t-picture" aria-selected="false">{__('Picture')} </a>
         </li>
           <li class="nav-item">
           <a class="nav-link {if !$item_i18n->getMenu()->hasPage() && !$form->hasPage()}hide{/if} CmsPageTab" id="t-design-tab" data-toggle="tab" href="#t-design" role="tab" aria-controls="t-design" aria-selected="false">{__('Design')} </a>
         </li>
           <li class="nav-item">
           <a class="nav-link {if !$item_i18n->getMenu()->hasPage() && !$form->hasPage()}hide{/if} CmsPageTab" id="t-content-tab" data-toggle="tab" href="#t-content" role="tab" aria-controls="t-content" aria-selected="false">{__('Content')} </a>
         </li>
      ...
      <div id="tab-ctn" class="tab-content" style="margin-top: 15px;"> 
          ...
          <div class="tab-pane fade CmsPagePanel" id="t-referencement" role="tabpanel" aria-labelledby="t-referencement-tab">
                 <div class="row">                                                                              
                    <div class="form-group col-md-12">
                      ...
                      <div class="field_with_errors"><input class="CmsPageI18n Clear form-control Fields Input" type="text" value="{$item_i18n->getPageI18n()->get('url')}" name="url" id="url"></div>
                    </div>
                </div>               
                <div class="row"> 
                    <div class="form-group col-md-12">
                      ...
                      <div class="field_with_errors"><input class="CmsPageI18n Clear form-control Fields Input" type="text" value="{$item_i18n->getPageI18n()->get('meta_title')}" name="meta_title" id="meta_title"></div>
                    </div>
                </div>
                <div class="row"> 
                    <div class="form-group col-md-12">
                      ...
                      <div class="field_with_errors">
                          <textarea cols="80" rows="2" class="CmsPageI18n Clear  form-control Fields Input" type="text" name="meta_description" id="meta_description">{$item_i18n->getPageI18n()->get('meta_description')}</textarea></div>
                    </div>
                </div>
                <div class="row"> 
                    <div class="form-group col-md-12">
                      ...
                      <div class="field_with_errors">
                          <textarea cols="80" rows="2" class="CmsPageI18n Clear form-control Fields Input" type="text" name="meta_keywords" id="meta_keywords">{$item_i18n->getPageI18n()->get('meta_keywords')}</textarea></div>
                    </div>
                </div>
                <div class="row"> 
                    <div class="form-group col-md-12">
                      ...
                      <div class="field_with_errors">
                          <textarea cols="80" rows="2" class="CmsPageI18n Clear  form-control Fields Input" type="text" name="meta_robots" id="meta_robots">{$item_i18n->getPageI18n()->get('meta_robots')}</textarea></div>
                    </div>
                </div>
          </div>  
      ...
      <div class="tab-pane fade CmsPagePanel" id="t-design" role="tabpanel" aria-labelledby="t-design-tab">
        <div class="row"> 
            <div class="form-group col-md-12">
                ...
                <div class="field_with_errors">                          
                  <input class="CmsPageI18n form-control Fields Input" type="text" value="{$item_i18n->getPageI18n()->get('layout')}" name="layout" id="meta_title">
                </div>
            </div>
        </div>
        <div class="row"> 
            <div class="form-group col-md-12">
              ...
              <div class="field_with_errors">
                  <input class="CmsPageI18n form-control Fields Input" type="text" value="{$item_i18n->getPageI18n()->get('template')}" name="template" id="template">
            </div>
            </div>
        </div> 
      </div> 
        ...
        <div class="tab-pane fade CmsPagePanel" id="t-content" role="tabpanel" aria-labelledby="t-content-tab">
          <div class="row"> 
            <div class="form-group col-md-12">
                <textarea id="Content" name="content" rows="15" class="form-control CmsPageI18n Clear Input" style="margin-top: 15px;" name="content">{$item_i18n->getPageI18n()->get('content')}</textarea>
            </div>
          </div>
      </div> 
...
<script type="text/javascript">
     ...
     $("#Cancel").click(function () {                     
                return $.ajax2({ data : { CmsMenu : { node: '{$item_i18n->getMenu()->getFather()->get('id')}', 
     ...
     $("#Save").click(function () {          
         var params = { CmsMenuI18n : { lang: '{$item_i18n->get('lang')}' , menu_id : '{$item_i18n->get('menu_id')}' , token :'{mfForm::getToken('CmsMenuI18nNodeForm')}'},
                        CmsMenuPageI18n : {  menu : { page_id: $(".CmsPage[name=page_id]").attr('data-id') }, menu_i18n : { }, page : { }, page_i18n: { }, token:'{$form->getCSRFToken()}' }
                            };
          ...
          return $.ajax2({ data : params,
                                 url:"{url_to('cms_pages_ajax',['action'=>'SaveMenuI18n'])}",
                                 target: "#actions"
                });
        });
     ...
     $("#New").click(function () { 
            ...
            $(".CmsPage.Clear,.CmsPageI18n.Clear").val(""); 
            $("#page-ctn").html("{__('New page')}"); 
            $("#DeletePage").addClass('show').removeClass('hide');
        });
      ...
      $("#dialog-Select").click(function () {            
       ...
       $("#DeletePage").click(function () { 
            ...
            $("#t-menu-tab,#t-menu").addClass('show active').removeClass('hide');
             $(".CmsPage[name=page_id]").attr('data-id',null);
        });    
</script> 
