...
class PaymentPaypalTransactionReturnForm extends mfForm {
    ...
    function checkData($validator,$values)
    {
     ...
     //   $settings=new PaypalSettings();                    
      /*  if ($settings->getPayerID()!=$values['PayerID'])
        ...
        $this->payment_employer_user=new PaymentEmployerUser(array('reference'=>$values['token']),$this->getEmployerUser());         
