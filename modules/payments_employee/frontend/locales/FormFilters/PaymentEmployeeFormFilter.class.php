...
class PaymentEmployeeFormFilter extends mfFormFilterBase{
    ...
    {                    
       ...
       $this->setValidators(array( 
            ...
            'equal' => new mfValidatorSchema(array(   
                             //"state"=>new mfValidatorChoice(array("choices"=>PaymentEmployeeState::getChoices()->unshift(array(''=>'')),"key"=>true,"required"=>false)), 
