...
class CustomerAcademyTeacherUserGuardValidator extends mfValidatorBase
{
  ...
  {      
    if (isset($values[$this->getOption('username_field')]) && isset($values[$this->getOption('password_field')]))
    {
      ...
      if ($user=CustomerAcademyTeacherUserUtils::findByEmailOrUsernameAndPassword($username, $password)) 
      {                
