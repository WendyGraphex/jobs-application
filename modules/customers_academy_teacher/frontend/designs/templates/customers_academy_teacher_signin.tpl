...
<body class="signInBody" style="background-image: url('/web/files/pictures/sign5.jpg');background-repeat: no-repeat;background-size: cover;">
            ...
            <div id="actions" class="SignInDiv">
                ...
                <div class="custom-control custom-checkbox custom-control-inline">
                  ...
                  <label class="custom-control-label" for="defaultInline1">
                      <a href="xxxxxxxx" target="_blank">{__('I agree to all Terms & Conditions')}</a>
                  </label>
                </div>
                </div>
                <div class="mt-3">
                ...
                <div class="text-center mt-4 font-weight-light">
                  ...
                  <a href="{link_i18n("customers_academy_teacher_login")}" class="text-primary">{__('Login')}</a>
                </div> 
    ...
    $('#defaultInline1').change(function() {
       ...
       $(function(){
            ...
            $("#Signup").click(function () {  
                ...
                var params = { Signup: { token : '{mfForm::getToken('CustomerAcademyTeacherUserSigninForm')}' } };
                ...
                return $.ajax2({  data : params,                               
                                  url:"{url_to('customers_academy_teacher_ajax',['action'=>'Signin'])}", 
