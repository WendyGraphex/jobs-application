                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            {if $form->hasErrors()}
                                                {html_options class="form-control AcademyTeacherUser Select" name="birthday_day" style="display: inline-block;width: 32%;" options=$form->birthday_day->getChoices()->toArray() selected=$form.birthday_day}
                                                {html_options class="form-control AcademyTeacherUser Select" name="birthday_month" style="display: inline-block;width: 32%;" options=$form->birthday_month->getChoices() selected=$form.birthday_month}
                                                {html_options class="form-control AcademyTeacherUser Select" name="birthday_year" style="display: inline-block;width: 32%;" options=$form->birthday_year->getChoices()->toArray() selected=$form.birthday_year}
                                            {elseif $teacher_user->hasBirthDay()}    
                                                {html_options class="form-control AcademyTeacherUser Select" name="birthday_day" style="display: inline-block;width: 32%;" options=$form->birthday_day->getChoices()->toArray() selected=$teacher_user->getFormatter()->getBirthday()->getDay()}
                                                {html_options class="form-control AcademyTeacherUser Select" name="birthday_month" style="display: inline-block;width: 32%;" options=$form->birthday_month->getChoices() selected=$teacher_user->getFormatter()->getBirthday()->getMonth()}
                                                {html_options class="form-control AcademyTeacherUser Select" name="birthday_year" style="display: inline-block;width: 32%;" options=$form->birthday_year->getChoices()->toArray() selected=$teacher_user->getFormatter()->getBirthday()->getYear()}                                     
                                            {else}    
                                                {html_options class="form-control AcademyTeacherUser Select" name="birthday_day" style="display: inline-block;width: 32%;" options=$form->birthday_day->getChoices()->toArray()}
                                                {html_options class="form-control AcademyTeacherUser Select" name="birthday_month" style="display: inline-block;width: 32%;" options=$form->birthday_month->getChoices()}
                                                {html_options class="form-control AcademyTeacherUser Select" name="birthday_year" style="display: inline-block;width: 32%;" options=$form->birthday_year->getChoices()->toArray()}                                                                    
                                            {/if}
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">   
    ...
    $(".ModeLogo").click(function(){
      ...
      $('#Save').click(function(){                             
          ...
          $(".AcademyTeacherUser.Input").each(function() { params.MyProfile[$(this).attr('name')]=$(this).val(); });                                       
          $(".AcademyTeacherUser.Select option:selected").each(function () { params.MyProfile[$(this).parent().attr('name')]=$(this).val(); });  
