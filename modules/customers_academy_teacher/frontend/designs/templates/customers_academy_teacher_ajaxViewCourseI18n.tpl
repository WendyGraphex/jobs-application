        ...
        <div class="card-body">             
            ...
            <div class="tab-content" style="padding-top: 20px;">
                <div class="tab-pane fade show active" id="content" role="tabpanel" aria-labelledby="content-tab">    
                    <div class="row mt-3">                       
                        <div class="form col-md-12">                                   
                            <div class="form-group">                          
                                 {component name="/site_languages/selectListLanguagesFrontend" selected=$course_i18n->get('lang')}
                            </div>                    
                        </div>  
                    </div>                    
                    ...
                    <input type="text" class="CustomerAcademyCourseI18n Input form-control" name="title" value="{$course_i18n->get('title')|escape}">
                    </div>                    
                    </div>  
                    </div>
                    <div class="row mt-3">                       
                    ...
                    <textarea cols="40" rows="5" class="CustomerAcademyCourseI18n Input form-control" name="short_description">{$course_i18n->get('short_description')|escape}</textarea>
                    </div>                    
                    </div>  
                    ...
                    <textarea cols="40" rows="10" class="CustomerAcademyCourseI18n Textarea Input form-control" name="content">{$course_i18n->get('content')|escape}</textarea>
                    </div>                    
                    </div>  
                    </div>  
                </div>         
                    ...
                    <div class="row mt-3">                       
                        <div class="form col-md-3">                                   
                            <div class="form-group">                          
                                ...
                                <input type="text" class="CustomerAcademyCourseI18n Input form-control" name="price" value="{if $form->hasErrors()}{$form.price}{else}{$course_i18n->getFormatter()->getPrice()}{/if}">
                ...
                <div class="form col-md-3">                                   
                    <div class="form-group">                          
                        <label>{__("Duration")}{if $form->price->getOption('required')}*{/if}</label>
                        <div>{$form.price->getError()}</div>
                        <input type="text" class="CustomerAcademyCourseI18n Input form-control" name="duration" value="{if $form->hasErrors()}{$form.duration}{else}{$course_i18n->getFormatter()->getDuration()}{/if}">
...
<script type="text/javascript">
     ...
     $("#Save").click(function () { 
        var params = {  CustomerAcademyCourseI18n :  { lang:  $("#SelectListLanguages option:selected").attr('id'), id: '{$course_i18n->get('id')}', categories :  [],token : '{$form->getCSRFToken()}' } };             
       ...
       // console.log(params); return ;
        return $.ajax2({
            data : params,
            url: "{url_to('customers_academy_teacher_ajax',['action'=>'SaveCourseI18n'])}",           
            target: "#actions"
        });
         ...
         $("#DropZone").dropzone({
          ...
          //  clickable: false,
            ...
            params: {  
                      "UploadCourseDocument[id]" : '{$course_i18n->get('id')}',
