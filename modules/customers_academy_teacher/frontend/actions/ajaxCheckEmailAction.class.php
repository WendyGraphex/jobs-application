...
require_once __DIR__."/../locales/Forms/CustomerAcademyTeacherUserCheckEmailForm.class.php";

class customers_academy_teacher_ajaxCheckEmailAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {           
        ...
        {           
            ...
            $form = new CustomerAcademyTeacherUserCheckEmailForm($request->getPostParameter('EmailChecker'));
