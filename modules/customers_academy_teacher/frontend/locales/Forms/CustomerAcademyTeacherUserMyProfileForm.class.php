...
class CustomerAcademyTeacherUserMyProfileForm extends CustomerAcademyTeacherUserBaseForm {
    
     
    protected $user=null;
    
     function __construct(SiteEventUser $user,$defaults = array(), $options = array()) {
         $this->user=$user;
