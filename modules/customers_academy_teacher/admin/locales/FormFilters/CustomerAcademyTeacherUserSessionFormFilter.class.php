...
class CustomerAcademyTeacherUserSessionFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerAcademyTeacherUserSession');
       $this->setFields(array(
          
           
             'email'=>array(
                        'class'=>'CustomerAcademyTeacherUserSession',
                        'search'=>array('conditions'=>CustomerAcademyTeacherUserSession::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{email}%%' ")
                        ), 
           'ip'=>array(
                        'class'=>'CustomerAcademyTeacherUserSession',
                        'search'=>array('conditions'=>CustomerAcademyTeacherUserSession::getTableField('ip')." COLLATE UTF8_GENERAL_CI LIKE '%%{ip}%%' ")
                        ),  
               ));      
       $this->setQuery("SELECT {fields} FROM ".CustomerAcademyTeacherUserSession::getTable().    
                      " INNER JOIN ".CustomerAcademyTeacherUserSession::getOuterForJoin('user_id').
                       ";");
       // Validators 
       $this->setValidators(array( 
            ...
            'equal' => new mfValidatorSchema(array(   
                          ...
                          //  "customer_id"=>new mfValidatorChoice(array("choices"=>array(""=>"")+ProductFavoriteUtils::getCustomerAcademyTeacherUserFieldValuesForSelect($this->getSite()),"key"=>true,"required"=>false)),
                            ),array("required"=>false)),                                         
