...
class CustomerAcademyTeacherUserRemember extends mfObject3 {
    ...
    const table="t_customer_academy_teacher_user_remember";
   ...
   // SETTERS 
    ...
    function setKey($key)
    {
     ...
     function setUser(CustomerAcademyTeacherUser $user)
    {
    ...
    {
        return md5('CustomerAcademyTeacherUserRememberFrontend');
    }
    
    static function cleanup($time_expiration,CustomerAcademyTeacherUser $user)
    {
    ...
    static function getUserRemember($key)
    {
         $db=mfSiteDatabase::getInstance()
                ...
                ->setObjects(array('CustomerAcademyTeacherUserRemember','CustomerAcademyTeacherUser'))
        ...
        $items->getCustomerAcademyTeacherUserRemember()->set('user_id',$items->getCustomerAcademyTeacherUser());
        return $items->getCustomerAcademyTeacherUserRemember();
    }
