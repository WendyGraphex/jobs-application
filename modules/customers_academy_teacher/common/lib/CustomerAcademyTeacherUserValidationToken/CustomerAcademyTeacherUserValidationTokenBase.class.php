...
class CustomerAcademyTeacherUserValidationTokenBase extends mfObject3 {
    ...
    const table="t_customer_academy_teacher_user_validation_token";
    ...
    function __construct($parameters=null) {
      ...
      {  
         if ($parameters instanceof CustomerAcademyTeacherUser)
    ...
    {
        return array('url'=>link_i18n('customer_academy_teacher_user_validate_email',array(),null,'frontend')."?token=".$this->get('token')."&email=".$this->getUser()->get('email'));
    }
