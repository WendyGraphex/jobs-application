...
class system_texts_ajaxSaveNewModelI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {                     
        ...
        try
        {      
            $this->form= new SystemModelTextNewForm($this->getUser()->getCountry(),$request->getPostParameter('SystemModelText'));             
            $this->item_i18n=new SystemModelTextI18n();
            $this->form->bind($request->getPostParameter('SystemModelText'));
