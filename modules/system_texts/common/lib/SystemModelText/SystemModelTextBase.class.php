...
class SystemModelTextBase extends mfObject2 {
     
    protected static $fields=array('name','orientation','type');
    const table="t_system_model_text"; 
   ...
   protected function loadByName($name)
    ...
    public function getI18n($lang=null)
     {        
         if (!$this->i18n)
         {
             ...
             $this->i18n=new SystemModelTextI18n(array('lang'=>$lang,"model_id"=>$this->get('id')));
         }   
         return $this->i18n;
     } 
    ...
    static function getModelsForSelect($lang=null)
    {
        ...
        $db=mfSiteDatabase::getInstance()
                ...
                ->setQuery("SELECT ".SystemModelTextI18n::getFieldsAndKeyWithTable()." FROM ".SystemModelTextI18n::getTable().                                                 
                           " WHERE lang='{lang}';")               
                ->makeSqlQuery(); 
        if (!$db->getNumRows())
            return $list;        
        while ($item=$db->fetchObject('SystemModelTextI18n'))
        {
...
//    }
    ...
    {
        return (boolean)$this->get('orientation');
    }
}
