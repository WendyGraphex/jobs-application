...
class EmployerAlertFormFilter extends mfFormFilter2 {
    ...
    {                         
       ...
       $this->setValidators(array( 
        ...
        $this->setQuery(mfQuery::getInstance()
                        ->select("{fields}")
                        ->from(EmployerAlert::getTable())
                        ->where(EmployerAlert::getTableField('employer_user_id')."='{employer_user_id}'")); 
    }
