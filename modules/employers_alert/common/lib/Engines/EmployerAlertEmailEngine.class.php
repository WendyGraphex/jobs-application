...
class EmployerAlertEmailEngine extends mfEmailEngineCore {
    
    protected $alert=null,$settings=null;
        
    function __construct(EmployerAlert $alert,$options=array()) {
       $this->alert=$alert;
    ...
    {                 
         ...
         {                                  
            ...
            $this->getMailer()->sendMail('employers_alert','emailCreated',$this->getCompany()->getEmailWithName(), 
