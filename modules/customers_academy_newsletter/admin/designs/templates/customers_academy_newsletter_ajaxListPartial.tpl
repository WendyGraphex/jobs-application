          ...
          <div class="row admin-header-container">
            <div class="col-sm">
              ...
              <h3 class="admin-header-small-text">{__('Customer Academy management|Newsletter')}</h3>
            </div>
...
<script type="text/javascript">
     function getFilterParameters()
        ...
        {          
           return $.ajax2({ data: getFilterParameters(), 
                            url:"{url_to('customers_academy_newsletter_ajax',['action'=>'ListPartial'])}" ,                          
                            target: "#page-wrapper"
                             });
        }
        ...
        $(".pager").click(function () {                     
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('customers_academy_newsletter_ajax',['action'=>'ListPartial'])}?page="+$(this).attr('data-page'),                                
                                 target: "#page-wrapper"
                });
        });
          
       $("#init").click(function () {                     
                return $.ajax2({ url:"{url_to('customers_academy_newsletter_ajax',['action'=>'ListPartial'])}",                                
                                 target: "#actions"
                });
        });    
      $(".View").click( function () {                    
                  return $.ajax2({ data : { Customer : $(this).attr('id') },                               
                                  url:"{url_to('customers_academy_newsletter_ajax',['action'=>'View'])}",                                                       
                                  target: "#page-wrapper"});
          });
    
      $("#New").click( function () {             
                return $.ajax2({                    
                    url: "{url_to('customers_academy_newsletter_ajax',['action'=>'New'])}",               
                    target: "#actions"
              });
            });
     ...
     $(".Delete").click( function () { 
                ...
                return $.ajax2({ data :{ CustomerAcademyNewsletter: $(this).attr('id') },
                                 url :"{url_to('customers_academy_newsletter_ajax',['action'=>'DeleteEmail'])}",                               
