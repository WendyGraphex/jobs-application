...
class CustomerAcademyNewsletter extends mfObject3 {
    ...
    const table="t_customer_academy_newsletter"; 
   ...
   {
       return $this->formatter=$this->formatter===null?new CustomerAcademyNewsletterFormatter($this):$this->formatter;
   }
}
