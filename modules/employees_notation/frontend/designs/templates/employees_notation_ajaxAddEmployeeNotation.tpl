...
<script type="text/javascript">
    ...
    $("#SaveReview-btn").click(function () { 
           var params = { EmployeeReviewNotations : { notations :[ ], employee_user_id : '{$employee->get('username')}', employee_advert_i18n_id : '{$advert_i18n->get('id')}' , token : '{$form->getCSRFToken()}' } };
           ...
           return $.ajax2({ 
                            data : params,
                            url :"{url_to('employees_notation_ajax',['action'=>'SaveEmployeeNotation'])}",                           
