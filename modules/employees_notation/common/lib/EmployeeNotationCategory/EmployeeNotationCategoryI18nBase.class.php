...
class EmployeeNotationCategoryI18nBase extends mfObjectI18n {
     
    protected static $fields=array('title','category_id','lang','created_at','updated_at');
    const table="t_employee_notation_category_i18n"; 
    ...
    static function create(mfArray $values,$lang)
    {
        ...
        if ($values->isEmpty())
            return ;       
        $collection_i18n = new EmployeeNotationCategoryI18nCollection();
        foreach ($values as $value)        
        {
            $item_i18n = new EmployeeNotationCategoryI18n();
