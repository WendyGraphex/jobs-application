...
class EmployeeAdvertNotationFormFilter extends mfFormFilter2 {
    ...
    {                         
       ...
       $this->setClass('EmployeeAdvertI18nEmployeeCriteriaNotation');
       ...
       $this->setQuery(mfQuery::getInstance()->select('{fields}')
                       ->from(EmployeeAdvertI18nEmployeeCriteriaNotation::getTable())                      
                       ->inner(EmployeeAdvertI18nEmployeeCriteriaNotation::getOuterForJoin('employee_user_id'))
                       ->inner(EmployeeAdvertI18nEmployeeCriteriaNotation::getOuterForJoin('employer_user_id'))
                       ->inner(EmployeeAdvertI18nEmployeeCriteriaNotation::getOuterForJoin('employee_criteria_id'))         
                       ->inner(EmployeeNotationCriteriaI18n::getInnerForJoin('criteria_id')." AND ".EmployeeNotationCriteriaI18n::getTableField('lang')."='{lang}'")  
                       ...
                       ->where(EmployeeAdvertI18nEmployeeCriteriaNotation::getTableField('sender')."='EMPLOYER'")                   
                       ); 
    }
