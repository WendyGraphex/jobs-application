...
class EmployeeNotationCriteriaFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployeeNotationCriteria');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'EmployeeNotationCriteriaI18n',
                        'search'=>array('conditions'=>EmployeeNotationCriteriaI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'EmployeeNotationCriteria',
                        'search'=>array('conditions'=>EmployeeNotationCriteria::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployeeNotationCriteria::getTable().                      
                       " LEFT JOIN ".EmployeeNotationCriteria::getOuterForJoin('category_id').                  
                       " LEFT JOIN ".EmployeeNotationCriteriaI18n::getInnerForJoin('criteria_id'). " AND ".EmployeeNotationCriteriaI18n::getTableField('lang')."='{lang}'".                                                        
