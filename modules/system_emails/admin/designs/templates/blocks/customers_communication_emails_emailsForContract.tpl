...
<script type="text/javascript">
 ...
 {* =====================  A C T I O N S =============================== *}  
         ...
         $(".CustomerEmail-View").click( function () { 
            ...
            return $.ajax2({
                data : { CustomerContract: "{$contract->get('id')}", CustomerEmailHistory: $(this).attr('id') },                
                url: "{url_to('customers_communication_emails_ajax',['action'=>'ViewEmailForContract'])}",
                errorTarget: ".customers-email-errors",               
                loading: "#tab-site-dashboard-customers-contract-loading",
                target: "#tab-customer-contracts-customer-emails-{$contract->get('id')}"       
           });
         });
         ...
         $(".CustomerMeetings-ResendEmail").click( function () {            
            return $.ajax2({
                ...
                url: "{url_to('customers_communication_emails_ajax',['action'=>'ResendEmailForContract'])}",
                errorTarget: ".customers-email-errors",               
                loading: "#tab-site-dashboard-customers-contract-loading",            
           });
         });
