...
class CustomerContactClaimFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerContactClaim');
       
       $this->setFields(array(
           'lastname'=>array(            
              'search'=>array('conditions'=>
                                                 "(".
               CustomerContactClaim::getTableField('lastname')." COLLATE UTF8_GENERAL_CI LIKE '%%{lastname}%%' OR ".
               CustomerContactClaim::getTableField('firstname')." COLLATE UTF8_GENERAL_CI LIKE '%%{firstname}%%'".
                                                 ")")
                                ),
           'firstname'=>array(             
              'search'=>array('conditions'=>
           ...
           'email'=>array(                     
                        'search'=>array('conditions'=>CustomerContactClaim::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{email}%%' ")
                        ),                     
       ));
       $this->setQuery("SELECT {fields} FROM ".CustomerContactClaim::getTable().                            
                       ";"); 
       // Validators 
