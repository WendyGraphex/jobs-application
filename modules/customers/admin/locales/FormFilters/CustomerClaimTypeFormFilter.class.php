...
class CustomerClaimTypeFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerClaimType');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'CustomerClaimTypeI18n',
                        'search'=>array('conditions'=>CustomerClaimTypeI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'CustomerClaimType',
                        'search'=>array('conditions'=>CustomerClaimType::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".CustomerClaimType::getTable().                      
                       " LEFT JOIN ".CustomerClaimTypeI18n::getInnerForJoin('type_id'). " AND ".CustomerClaimTypeI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
