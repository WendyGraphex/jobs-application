...
<div class="row admin-header-container">
    <div class="col-sm">
           <h3 class="admin-header-big-text">{__('Configurations|Customers')}</h3>
           <h3 class="admin-header-small-text">{__('Manage Claim Types of customers')}</h3>
    </div>
    <div class="col-sm" style="padding: 0;">
        <div style="float: right;"> 
            ...
            <a href="#" class="btn btn-success admin-header-button btn-color" id="New" title="{__('New Claim Type')}">
...
<div class="breadcrumb-title">
    <p>
        ...
        <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('Claim Types')}
    </p>
</div>
    ...
    function change(action,resp) {
        ...
        function updatePager(n)
        {
          ...
          {* =====================  P A G E R  A C T I O N S =============================== *}  
           ...
           $("#init").click(function() {                   
               return $.ajax2({ url:"{url_to('customers_ajax',['action'=>'ListPartialType'])}",                                    
                         target: "#actions"}); 
           }); 
          ...
          $("[name=nbitemsbypage]").change(function() { return updateFilter(); }); 
           ...
           $(".pager").click(function () {                      
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('customers_ajax',['action'=>'ListPartialType'])}?"+this.href.substring(this.href.indexOf("?")+1, this.href.length),
                                target: "#actions"
                });
        });
          {* =====================  A C T I O N S =============================== *}  
          ...
          $("#New").click( function () {             
            return $.ajax2({
                ...
                url: "{url_to('customers_ajax',['action'=>'NewTypeI18n'])}",              
                target: "#actions"
           });
         });
         
         $(".View").click( function () {                
                return $.ajax2({ data : { CustomerClaimTypeI18n : { 
                                                type_id: $(this).attr('id'),
                                                lang: $("#SelectListLanguages option:selected").attr('id')                                            
                                    } },                                
                                url:"{url_to('customers_ajax',['action'=>'ViewTypeI18n'])}",                              
                                target: "#actions"});
         });
       $(".list").dblclick( function () {                    
                  return $.ajax2({ data : { CustomerClaimTypeI18n : { type_id: $(this).attr('id'),lang: $("#SelectListLanguages option:selected").attr('id') } },                               
                                  url:"{url_to('customers_ajax',['action'=>'ViewTypeI18n'])}", 
                                  target: "#actions"});
          });
        ...
        $(".Delete").click( function () { 
                if (!confirm('{__("Type \"#0#\" will be deleted. Confirm ?")}'.format($(this).attr('name')))) return false; 
                return $.ajax2({ data :{ CustomerClaimType: $(this).attr('id') },
                                 url :"{url_to('customers_ajax',['action'=>'DeleteType'])}",                                
        ...
        $("#Positions").click( function () {                
                return $.ajax2({ url:"{url_to('customers_ajax',['action'=>'PositionsType'])}",
                                target: "#actions"});
         });   
