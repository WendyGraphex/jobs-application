    ...
    {  
       ...
       $this->setValidators(array( 
        ...
        $this->setQuery(mfQuery::getInstance()->select("{fields}")
                    ...
                    ->where( 
                            EmployeeAdvertComment::getTableField('is_active')."='YES' AND ".
                            EmployeeAdvertComment::getTableField('employee_advert_id')."='{advert_id}' AND ".
                            EmployeeAdvertComment::getTableField('employee_advert_lang')."='{advert_lang}'"));  
    }
