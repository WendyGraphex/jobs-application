<div class="comment-form-wrap">
    <h3 class="mb-5" style="margin-bottom: 25px !important;">{__('Leave a comment for %s',$project->getEmployerUser()->get('username'))}</h3>   
{if $project->isLoaded()}
    <div>  
...
<script type="text/javascript">
    ...
    $(".ProjectEmployeeCommentI18n.Input").click(function () {
                            ...
                            success : function (resp)
                                {
                                    ...
                                    if (resp.errors)
                                    {     
                                        $(".ProjectEmployeeCommentI18n.Input").addClass('intro');                                    
                                        return ;
                                    }   
