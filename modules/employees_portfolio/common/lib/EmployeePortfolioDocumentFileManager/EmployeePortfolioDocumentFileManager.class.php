...
class EmployeePortfolioDocumentFileManager {
   ...
   /* function escapeFilename(mfString $filename)
    ...
    function getImages()
    {
        return $this->images=$this->images===null?new EmployeePortfolioDocumentFileManagerPictures($this):$this->images;
    }
   ...
   /*  function getRoot()
     ...
     function getFile()
    {
        return new FileObject2(array(
                 ...
                 "urlPath"=>url_to("employees_portfolio_download",array('file'=>''),"frontend"),
                 "url"=>url_to("employees_portfolio_download",array('file'=>$this->getItem()->get('file'),'employee'=>$this->getItem()->getEmployeeUser()->get('username')),"frontend")
              ));
    }
