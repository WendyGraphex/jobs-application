...
<script type="text/javascript">
    ...
    $('#Cancel').click(function(){ 
        return $.ajax2({ url:"{url_to('services_smsbox_ajax',['action'=>'ListPartial'])}",
                        errorTarget: ".site-smsbox-callback-errors",
                        loading: "#tab-site-dashboard-x-settings-loading",
                        target: "#actions" 
                }); 
     ...
     $('#Test').click(function(){ 
        return $.ajax2({ url:"{url_to('services_smsbox_callback_ajax',['action'=>'TestCallback'])}",
                        errorTarget: ".site-smsbox-callback-errors",
                        loading: "#tab-site-dashboard-x-settings-loading",
                        target: "#actions" 
                }); 
