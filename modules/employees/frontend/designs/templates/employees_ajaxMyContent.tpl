<div class="row RowTop">
    <div class="col-md-12 grid-margin classConducteurTop">
        ...
        {component name="/site_help/help" help="employee-myPage"}
    </div>
</div>
{alerts}  
        ...
        <div class="card-body">             
            ...
            <div class="tab-content">
                        ...
                        <div class="row mt-3">                       
                            <div class="form col-md-12">                                   
                                <div class="form-group">                          
                                    ...
                                    <input type="text" class="EmployeeContentI18n Input form-control" data-lang="{$language->get('code')}" name="meta_title" value="{if $form->hasErrors()}{$form.contents[$index].meta_title}{else}{$form->getUser()->getContents()->getItemByIndex($index)->get('meta_title')|escape}{/if}">
                                </div>                    
                            </div>  
                        </div>
                        <div class="row mt-3">                       
                            <div class="form col-md-12">                                   
                                <div class="form-group">                          
                                    ...
                                    <textarea cols="40" rows="5" class="EmployeeContentI18n Input form-control" data-lang="{$language->get('code')}" name="meta_description">{if $form->hasErrors()}{$form.contents[$index].meta_description}{else}{$form->getUser()->getContents()->getItemByIndex($index)->get('meta_description')|escape}{/if}</textarea>
                                </div>                    
                            </div>  
                        </div>
                        <div class="row mt-3">                       
                            <div class="form col-md-12">                                   
                                <div class="form-group">                          
                                    ...
                                    <textarea cols="40" rows="10" class="EmployeeContentI18n Textarea Input form-control" data-lang="{$language->get('code')}" name="description">{if $form->hasErrors()}{$form.contents[$index].description}{else}{$form->getUser()->getContents()->getItemByIndex($index)->get('description')|escape}{/if}</textarea>
                                </div>                    
                            </div>  
                        </div>                  
                    </div> 
                ...
                <div class="tab-pane fade show" id="picture" role="tabpanel" aria-labelledby="picture-tab" style="padding-top: 10px;">                                                                                    
                    ...
                    <div class="picture-list col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12">
                    ...
                    <div class="row portfolio-grid">
                        <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12">
                            <figure class="effect-text-in ModeDisplay" id="Picture">
                                <div id="DropZonePicture" class="dropzone dp-addFile pt-1" style="min-height: 200px;padding-left: 2px;padding-right: 2px;padding-bottom: 0px;">                                                  
                                    {if $form->getUser()->getContent()->isLoaded()}
                                        ...
                                        {else}
                                            <div id="NoPicture" {if $form->getUser()->getContent()->hasPicture()}style= "display:none;"{/if}>
                                                ...
                                                <img id="Picture-img" style="position: absolute; left: 0px; margin: 0px auto;top: 0px;padding: 10px;text-align: center;right: 0px;" {*style="display:none;position: absolute;left: 0px;margin: 0 auto;width: 100%;top: 20px;"*} class="img-dpzone img-product">                                
                        ...
                        <div class="col-2">  
                            <a href="#" class="list-action Mode" id="Picture" name="NORMAL"><i id="Picture" class="ModeAwe fa fa-square-o"></i></a>
...
<script type="text/javascript">
       $( '.Textarea' ).ckeditor();
        ...
        $(".Languages").each(function () { 
              ...
              $(".EmployeeContentI18n[data-lang="+$(this).attr('id')+"]").each(function () {  i18n[$(this).attr('name')]=$(this).val(); });            
              params.MyContent.contents.push(i18n);
        });           
       // console.log(params); return ;
        return $.ajax2({
            data : params,
            url: "{url_to('employees_ajax',['action'=>'MyContent'])}",           
            target: "#page-wrapper"
        });
        ...
        $('#Dashboard').click(function(){                                       
         ...
         $("#DropZonePicture").dropzone({
            url: "{url_to("employees_ajax",['action'=>'UploadPictureContent'])}",
            //clickable: false,
            dictDefaultMessage : '{__('Drop file to upload')}',
            params: {  
                      "EmployeePictureContentUpload[token]" : '{mfForm::getToken('EmployeePictureContentUploadForm')}' 
                    },   
            paramName: "EmployeePictureContentUpload[file]",
            ...
            {              
                ...
                $("#MyContent-ctn").attr('data-id',resp.id);
                $('#DeletePicture').show();
            }                  
    }); 
      ...
      $("#DeletePicture").click( function () { 
            ...
            return $.ajax2({ url :"{url_to('employees_ajax',['action'=>'DeletePictureContent'])}",                               
