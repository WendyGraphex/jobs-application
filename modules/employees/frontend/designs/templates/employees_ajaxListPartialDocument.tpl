      ...
      function updatePager(n)
        ...
        $(".Delete").click( function () { 
                ...
                return $.ajax2({ data :{ Document: $(this).attr('id') },
                                 url :"{url_to('employees_ajax',['action'=>'DeleteDocument'])}",                               
        ...
        $("#New").click( function () {                 
                return $.ajax2({ url :"{url_to('employees_ajax',['action'=>'NewDocument'])}",                               
                                 target :"#actions"
                     });                                        
            });  
            
         $(".View").click( function () {                 
                return $.ajax2({ data :{ EmployeeDocument: $(this).attr('id') },
                                 url :"{url_to('employees_ajax',['action'=>'ViewDocument'])}",                               
                                 target :"#actions"
                     });                                        
            });  
</script> 
