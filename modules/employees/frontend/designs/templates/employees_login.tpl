...
<html lang="{$_request->getLanguage()}">
    <head>
        ...
        <title>{component name="/site_company/Display" field='name' COMMENT=false} - {__('Employee - Login')}</title> 
            ...
            <div class="container-fluid page-body-wrapper full-page-wrapper">
                <div class="content-wrapper d-flex align-items-stretch auth auth-img-bg">
                    <div class="row flex-grow">
                            ...
                            <div class="auth-form-transparent text-left p-3">
                                ...
                                <form class="pt-3" id="f_authent" action="" method="post">
                                    ...
                                    <div class="my-2 d-flex justify-content-between align-items-center">                    
                                        ...
                                        <a href="{link_i18n('employees_forgot_password')}" class="auth-link text-black textSize" style="font-size: 16px;">{__('Forgot password?')}</a>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 classPaddingBottom" style="padding-right: 5px;">
                                            {component name="/facebook_oauth/oauthBtnEmployee"}    
                                        </div>
                                        <div class="col-md-6" style="padding-left: 5px;">
                                            {component name="/google_oauth/oauthBtnEmployee"} 
                                        </div>
                                    </div>
                                    <div class="row" style="padding-top: 10px;">
                                        <div class="col-md-6 classPaddingBottom"  style="padding-right: 5px;">
                                            {component name="/instagram_oauth/oauthBtnEmployee"}
                                        </div>
                                        <div class="col-md-6" style="padding-left: 5px;">
                                            {component name="/linkedin_oauth/oauthBtnEmployee"}
                                        </div>
                                    </div>
                                    <div class="text-center mt-4 font-weight-light">
                                        {__("Don't have an account?")} <a href="{link_i18n('employees_signin')}" class="text-primary">{__('Create')}</a>
                                    </div>
                        ...
                        <div class="col-lg-6 login-half-bg" style="background-color: rgb(63, 0, 78);padding-left: 0px !important;padding-right: 0px !important;">
                            ...
                            <div class="divImageLogin">
                                <img src="/web/pictures/login-employee.jpg" style="width: 100%;"/>
                            </div>
                            <div>
