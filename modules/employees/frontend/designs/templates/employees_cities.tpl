...
<html lang="{$_request->getLanguage()}">
    <head>
        ...
        <title>{component name="/site_company/Display" field='name' COMMENT=false} - {__('All employee cities')}</title> 
            ...
            <div id="page-ctn" class="container">      
                <div id="page-wrapper" class="allAdvetsInCities">  
                    ...
                    {foreach $pager as $item}
                        ...
                        {component name="/employees/cityLink" city=$item->getCity() country=$item->getCountry()}                         
                    {/foreach}
                </div> 
            </div>
        </div> 
