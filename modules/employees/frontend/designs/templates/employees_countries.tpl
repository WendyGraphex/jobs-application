...
<html lang="{$_request->getLanguage()}">
    <head>
        ...
        <title>{component name="/site_company/Display" field='name' COMMENT=false} - {__('All employee countries')}</title>  
        ...
        <section class="ftco-section bg-light sectionCategoriesTop sectionMarginTop">
            <div id="page-ctn" class="container">      
                <div id="page-wrapper" class="allAdvetsInCities">  
                    <h1>{__('All Countries')}</h1>
                    {foreach $pager as $item}
                         <h3>{$item->getCountry()->getText()}</h3>
                        ...
                        <a href="" class="seeAllAdsGlobal">
                            <span>.......{__('See all ads')}</span>
