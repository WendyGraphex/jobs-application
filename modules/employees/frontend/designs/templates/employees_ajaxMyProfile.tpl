...
<script type="text/javascript">   
    ...
    $(".ModeLogo").click(function(){
      ...
      $('#Save').click(function(){                             
          ...
          $(".Employee.Input").each(function() { params.MyProfile[$(this).attr('name')]=$(this).val(); });                                       
          $(".Employee.Select option:selected").each(function () { params.MyProfile[$(this).parent().attr('name')]=$(this).val(); });  
          $(".EmployeeCategories").each(function () { params.MyProfile.categories.push($(this).attr('id')); });
          ...
          $(".skills-ctn").each(function () {     
              var item = { i18n : [] };  
              $(".EmployeeSkill[data-index="+$(this).attr('data-index')+"].Select option:selected").each(function () { item[$(this).parent().attr('name')]= $(this).val(); });  
              $(".EmployeeSkillLanguages[data-index="+$(this).attr('data-index')+"] option").each(function () { 
                  var i18n = { };
                  $(".EmployeeSkillI18n[data-index="+$(this).attr('data-index')+"][data-lang="+$(this).val()+"]").each(function () { i18n[$(this).attr('name')]=$(this).val(); });
                  if (Object.entries(i18n).length !==0) { i18n.lang = $(this).val(); item.i18n.push(i18n); }
              }); 
              params.MyProfile.skills.push(item);
         });
         ...
         $(".diplomas-ctn").each(function () {     
              ...
              $(".EmployeeDiplomaLanguages[data-index="+$(this).attr('data-index')+"] option").each(function () { 
                  var i18n = { };
                  $(".EmployeeDiplomaI18n[data-index="+$(this).attr('data-index')+"][data-lang="+$(this).val()+"]").each(function () { i18n[$(this).attr('name')]=$(this).val(); });                  
                  if (Object.entries(i18n).length !==0) { i18n.lang = $(this).val(); item.i18n.push(i18n); }
              });     
              params.MyProfile.diplomas.push(item);
         });           
         //console.log(params);
