    ...
    {JqueryScriptsReady}  
        ...
        $("#Favourite-Save").click(function () { 
            return $.ajax2({ data: { EmployeeAdvertI18n : '{$advert_i18n->get('id')}' }, 
                                 url:"{url_to('employees_ajax',['action'=>'SaveEmployeeAdvertFavourite'])}",                                                                 
                                 success : function (resp)
                                {
                                    if (resp.action !='SaveEmployeeAdvertFavourite') return ;
                                    $(".Disable").show();
                                    $(".Enable").hide();
                                }
                });
         ...
         $("#Favourite-Delete").click(function () { 
            return $.ajax2({ data: { EmployeeAdvertI18n : '{$advert_i18n->get('id')}' }, 
                                 url:"{url_to('employees_ajax',['action'=>'DeleteEmployeeAdvertFavourite'])}",                                                                 
                                 success : function (resp)
                                {
                                    if (resp.action !='DeleteEmployeeAdvertFavourite') return ;
                                     $(".Disable").hide();
                                    $(".Enable").show();
                                }
                });
