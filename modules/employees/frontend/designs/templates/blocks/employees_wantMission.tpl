      ...
      <div class="container">
        <div class="row d-flex">
            <div class="col-md-12 text-center" style="padding-top: 62px;">
                <h1 class="StyleH1">{__('Want a Mission')}</h1>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <div class="errors" name="gender"></div> 
                                         <select name="gender" class="form-control EmployeeCoordinatesWantJob Fields Select error">
                                            <option value="">{__('Gender')}</option> 
                                        {foreach $form->coordinates.gender->getChoices() as $key=>$value}                                            
                                             <option value="{$key}" {if $key==$employee->get('gender')}selected=""{/if}>{format_gender($value)}</option>                                                                                         
                                        {/foreach}    
                                         </select>                                        
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control EmployeeCoordinatesWantJob Fields Input error" name="firstname" placeholder="{__('Last name')} {if $form->coordinates.lastname->getOption('required')}*{/if}" value="{$employee->get('firstname')|escape}">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <div class="errors" name="firstname"></div> 
                                        <input type="text" class="form-control EmployeeCoordinatesWantJob Fields Input error" name="lastname" placeholder="{__('First name')} {if $form->coordinates.firstname->getOption('required')}*{/if}" value="{$employee->get('lastname')|escape}">
                                    </div>
                                </div>
                            </div>
                {*========================Second Row=============================*}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control EmployeeCoordinatesWantJob Fields Input error" name="email" placeholder="{__('Email')} {if $form->coordinates.email->getOption('required')}*{/if}" value="{$employee->get('email')|escape}"/>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control EmployeeCoordinatesWantJob Fields Input" name="phone" placeholder="{__('Phone')} {if $form->coordinates.phone->getOption('required')}*{/if}" value="{$employee->get('phone')|escape}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="errors" name="mobile"></div>
                                        <input type="text" class="form-control EmployeeCoordinatesWantJob Fields Input error" name="mobile" placeholder="{__('Mobile')} {if $form->coordinates.mobile->getOption('required')}*{/if}" value="{$employee->get('mobile')|escape}">
                                    </div>
                                </div>
                            </div>
                {*========================Third Row=============================*}
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control EmployeeCoordinatesWantJob Fields Input error" name="address1" placeholder="{__('Your Address')} {if $form->coordinates.address1->getOption('required')}*{/if}" value="{$employee->get('address1')|escape}">
                                    </div>
                                </div>
                            </div>
                {*========================Fourth Row=============================*}
                            <div class="row">
                                <div class="col-md-12" id="Address2" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control EmployeeCoordinatesWantJob Fields Input" name="address2" placeholder="{__("Address cont'd")} {if $form->coordinates.address2->getOption('required')}*{/if}" value="{$employee->get('address2')|escape}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control EmployeeCoordinatesWantJob Fields Input error" name="postcode" placeholder="{__('Postcode')} {if $form->coordinates.postcode->getOption('required')}*{/if}" value="{$employee->get('postcode')|escape}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="errors" name="address2"></div>
                                        <input type="text" class="form-control EmployeeCoordinatesWantJob Fields Input error" name="city" placeholder="{__('City')} {if $form->coordinates.city->getOption('required')}*{/if}" value="{$employee->get('city')|escape}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="errors" name="country"></div>
                                       {select_country preferred=$settings->get('default_countries') selected=$user->getCountry() name="country" class="EmployeeCoordinatesWantJob form-control Fields Select"} 
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control EmployeeCoordinatesWantJob Fields Input user_password error" name="password" placeholder="{__('Password')} {if $form->coordinates.password->getOption('required')}*{/if}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="errors" name="password"></div>
                                        <input type="password" class="form-control EmployeeCoordinatesWantJob Fields Input user_password error" name="repassword" placeholder="{__('Re-password')} {if $form->coordinates.password->getOption('required')}*{/if}">
                    ...
                    <div id="cities">
                       <div class="row">
                            <div class="col-md-3" style="padding-right:0px !important;">
                                    <div class="form-group">
                                        <button id="cities-btn" type="button" class="btn btn-info TextButton btnCities" {* data-toggle="modal" data-target="#City"*} style="width: 184px;">
                                            {__('Your cities')}<span class="mdi mdi-plus"></span>
                                        </button>
                                        <div class="modal fade" id="cities-modal" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="">
                                                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    </div>
                                                    <div id="cities-ctn" class="modal-body">
                                ...
                                <div class="col-md-9 AllCities">
                                    <div class="" style="{*background-color: red;width: 200px;height: 300px;*}">
                                        <ul class="ListeLI" id="AllCities">
                                            <li clas="classLI" id="">Casablanca<span class="closeLi" data-dismiss="modal">×</span></li>
                                            <li clas="classLI" id="">Marrakech<span class="closeLi" data-dismiss="modal">×</span></li>
                                            <li clas="classLI" id="">Ifrane<span class="closeLi" data-dismiss="modal">×</span></li>
                                            <li clas="classLI" id="">Dortmond<span class="closeLi" data-dismiss="modal">×</span></li>
                                            <li clas="classLI" id="">Amsterdam<span class="closeLi" data-dismiss="modal">×</span></li>
                                        </ul>
                                    </div>
                                </div>                      
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control EmployeeWantJob Fields Input error" name="postcode" placeholder="{__('Salary')} {*if $form->coordinates.postcode->getOption('required')}*{/if}" value="{$employee->get('postcode')|escape*}">
                                    </div>
                                </div>
                            </div> 
 ...
 <script type="text/javascript">     
    ...
    $(".SeePassword").click(function () {
     ...
     $("#SaveCoordinates").click(function () {         
             var params = { EmployeeCoordinates: {  token : '{$form->getCSRFToken()}' } };
             $(".EmployeeCoordinatesWantJob.Input").each(function () { params.EmployeeCoordinates[$(this).attr('name')]=$(this).val(); });
             $(".EmployeeCoordinatesWantJob.Select option:selected").each(function () { params.EmployeeCoordinates[$(this).parent().attr('name')]=$(this).val(); });
             return $.ajax2({ data: params, 
                              url:"{url_to('employees_ajax',['action'=>'SaveCoordinates'])}",   
                              success : function (resp)
                                        {
                                            if (resp.errors) 
                                            {
     ...
     $("#SaveAdverts").click(function () {         
             var params = { EmployeeAdvert: {  coordinates: { }, adverts : { }, token : '{$form->getCSRFToken()}' } };
          //   $(".EmployeeCoordinatesWantJob.Input").each(function () { params.EmployeeCoordinates[$(this).attr('name')]=$(this).val(); });
          //   $(".EmployeeCoordinatesWantJob.Select option:selected").each(function () { params.EmployeeCoordinates[$(this).parent().attr('name')]=$(this).val(); });
             return $.ajax2({ data: params, 
                              url:"{url_to('employees_ajax',['action'=>'SaveAdverts'])}",   
                              success : function (resp)
                                        {
                                            if (resp.errors) 
                                            {
        ...
        $("#Publish").click(function () {         
          ...
          //   $(".EmployeeCoordinatesWantJob.Select option:selected").each(function () { params.EmployeeCoordinates[$(this).parent().attr('name')]=$(this).val(); });
             return $.ajax2({ data: params, 
                              url:"{url_to('employees_ajax',['action'=>'PublishAdverts'])}",   
                              success : function (resp)
                                        {
                                            if (resp.errors) 
                                            {
     ...
     $(".EmployeeCoordinatesWantJob.Input[name=email]").keyup(function () { 
                      $(".validateEmail").hide();                    
                      var r = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{ldelim}1,3{rdelim}\.[0-9]{ldelim}1,3{rdelim}\.[0-9]{ldelim}1,3{rdelim}\.[0-9]{ldelim}1,3{rdelim}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{ldelim}2,{rdelim}))$/;
                      if (!r.test($(this).val()))
                         return ;
       ...
       if ($(".DropZoneDocuments").find('.dz-default').length)
        ...
        $(".DropZoneDocuments").dropzone({
            url: "{url_to("employees_ajax",['action'=>'UploadDocumentForAdvert'])}",
            clickable: false,
            params: { },   
    ...
    $("#cities-btn").click(function () { 
            return  $.ajax2({   url:"{url_to('employees_ajax',['action'=>'AddCitiesForAdvert'])}",  
    ...
    $("#categories-btn").click(function () { 
            return  $.ajax2({   url:"{url_to('employees_ajax',['action'=>'AddCategoriesForAdvert'])}",  
