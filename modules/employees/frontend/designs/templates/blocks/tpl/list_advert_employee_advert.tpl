<div class="sidebar-box ftco-animate block-last-adverts">
    ...
    {foreach $pager as $item_i18n}
        {component name="/employees/advertDisplay" advert_i18n=$item_i18n tpl='advert'}       
    {/foreach}     
    ...
    {include file="./_pagers/_employee_default_pager_advert.tpl" pager=$pager class="employer-advert"} 
