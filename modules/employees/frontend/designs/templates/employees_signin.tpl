...
<html lang="{$_request->getCountry()}">
    ...
    <head>
        ...
        <title>{component name="/site_company/Display" field='name' COMMENT=false} - {__('Freelancer - Signin')}</title> 
    ...
    <body class="signInBody" style="background-image: url('/web/files/pictures/sign1.jpg');background-repeat: no-repeat;background-size: cover;">
                            ...
                            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                                <div class="brand-logo">
                                    {if $_request->getSite()->getSite()->hasPicture()}
                                        <a href="/"><img src="{$_request->getSite()->getSite()->getPicture()->getUrl()}" style="max-width: 100%;margin: 0 auto;display: block;"/></a>           
                                        {else}
                                ...
                                <div id="actions" class="SignInDiv">
                                    ...
                                    <div class="mb-4">
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            ...
                                            <label class="custom-control-label" for="defaultInline1" style="line-height: 25px;">
  ...
  <script src="{url('vendors/base/vendor.bundle.base.js','web')}"></script>
  <script src="{url('js/off-canvas.js','web')}"></script> 
    ...
    $('#defaultInline1').change(function() {
       ...
       $(function(){
            ...
            $("#Signup").click(function () {  
                ...
                var params = { Signup: { token : '{mfForm::getToken('EmployeeSigninForm')}' } };
                ...
                return $.ajax2({  data : params,                               
                                  url:"{url_to('employees_ajax',['action'=>'Signin'])}", 
