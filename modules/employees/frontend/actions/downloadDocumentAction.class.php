...
class employees_downloadDocumentAction extends mfAction {
       
    
    function execute(mfWebRequest $request) {               
        $messages = mfMessages::getInstance();                             
        $document= new EmployeeAdvertDocument($request->getRequestParameters(array('file','id')),$this->getUser()->isAuthenticated() && ($this->getUser()->isEmployee() || $this->getUser()->isEmployerUser())?$this->getUser()->getGuardUser():null);               
