...
class employees_listAction extends mfAction {
...
//        $this->formFilter= new EmployeeAdvertControllerFormFilter($request->getPostParameter('filter'));                                     
//        $this->pager=new EmployeeAdvertControllerPager();
        try
        {
