...
class employees_ajaxListPartialDialogCategoryForMyProfileAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {
        ...
        if (!$request->getRequestParameter('EmployeeCategory')) 
        {        
            $form=new EmployeePartnerWorkCategorySelectionForm($request->getPostParameter('EmployeeCategory'));
            $form->bind($request->getPostParameter('EmployeeCategory'));     
        ...
        {              
            $this->node =$request->getRequestParameter('EmployeeCategory');   
