...
class EmployeeFavouriteFormFilter extends mfFormFilter2 {
    ...
    {                         
       ...
       $this->setClass('EmployeeFavourite');
       ...
       $this->setValidators(array( 
        ...
        $this->setQuery(mfQuery::getInstance()
                        ->select("{fields}")
                        ->from(EmployeeFavourite::getTable())
                        ->where(EmployeeFavourite::getTableField('employee_user_id')."='{employee_user_id}'")); 
    }
