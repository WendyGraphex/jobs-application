...
class EmployeeAdvertCountriesControllerFormFilter extends mfFormFilterBase {
    ...
    {  
       ...
       $this->setValidators(array( 
            ...
            'order' => new mfValidatorSchema(array(                                                        
                     ...
                     "number_of_adverts"=>new mfValidatorChoice(array("choices"=>array("asc","desc"),"required"=>false)),
      ...
      $this->_query->select("country, count(".EmployeeAdvertI18n::getTableField('id').") as `number_of_adverts`")
                    ...
                    ->groupBy(Employee::getTableField('country'));
