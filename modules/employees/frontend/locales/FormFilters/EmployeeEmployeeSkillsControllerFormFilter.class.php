...
class EmployeeEmployeeSkillsControllerFormFilter extends mfFormFilterBase {
    ...
    {  
       ...
       $this->setValidators(array( 
        ...
        $this->_query->select("{fields},count(".Employee::getTableField('id').") as `number_of_employees`")
