...
class EmployeeAdvertSkillsControllerFormFilter extends mfFormFilterBase {
    ...
    {  
       ...
       $this->setValidators(array( 
        ...
        $this->_query->select("{fields},count(".EmployeeAdvertI18n::getTableField('id').") as `number_of_adverts`")
                    ...
                    ->groupBy(EmployeeSkill::getTableField('id'));                       
