...
require_once __DIR__."/EmployeeAdvertI18nNewForm.class.php";


class EmployeeAdvertI18nMultipleNewForm extends mfForm {
    ...
    function configure() {           
        $this->setValidators(array(
              'id'=>new ObjectExistsValidator('EmployeeAdvert',array('key'=>false,'required'=>false)),  
    ...
    {                      
       if ($this->advert===null)
       {    
          $this->advert=new EmployeeAdvert($this->getDefault('id')?$this->getDefault('id'):null,$this->getUser());
