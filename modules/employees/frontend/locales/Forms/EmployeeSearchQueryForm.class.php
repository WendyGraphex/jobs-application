...
class EmployeeSearchQueryForm extends mfForm {
    
    
    function configure() {
        $this->setValidators(array(
            'category'=> new mfValidatorChoice(array('required'=>false,'key'=>true,'choices'=>EmployeeWorkCategory::root()->getChildren()->toSelect()->unshift(array(''=>__('Select a category'))))),
    ...
    {
        return $this->_category=$this->_category===null?new EmployeeWorkCategory($this['category']->getValue()):$this->_category;
    }
