<div class="row admin-header-container">
    <div class="col-sm">
        <h3 class="admin-header-big-text">{__("View Freelancer Graduate Diploma")}</h3>
...
<div class="breadcrumb-title">
    <p>
        ...
        <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('View Freelancer Graduate Diploma')}
    </p>
</div>
{alerts}
...
<script language="text/javascript">
    ...
    $(".EmployeeGraduateDiploma,.EmployeeGraduateDiplomaI18n").click(function() {  $('#Save').show(); });  
         
     {* =================== L A N G U A G E ================================ *}
        
     {* =================== A C T I O N S ================================ *}
     $('#Cancel').click(function(){                
             return $.ajax2({ data: { filter: { lang:  '{$item_i18n->get('lang')}', token: "{mfForm::getToken('EmployeeGraduateDiplomaFormFilter')}" } },                              
      ...
      $('#Save').click(function(){                             
            var  params= {      iFrame:true,             
                                EmployeeGraduateDiplomaI18n: { 
                                   graduate_i18n : { lang: '{$item_i18n->get('lang')}', graduate_id : '{$item_i18n->get('graduate_id')}' },
                                    graduate : { },
        ...
        //      alert("Params="+params.toSource());   return ;      
          return $.ajax2({ data : params,  
                           files :'.Files',
                           url: "{url_to('employees_ajax',['action'=>'SaveGraduateI18n'])}",
                           target: "#actions"}); 
        });                          
</script>
