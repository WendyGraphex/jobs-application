...
<div class="row admin-header-container">
    <div class="col-sm">
        <h3 class="admin-header-big-text">{__("New Freelancer Skill")}</h3>
...
<div class="breadcrumb-title">
    <p>
        ...
        <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('New Freelancer Skill')}
    </p>
</div>
{alerts}
     ...
     <div class="the-box bg-white p-3">    
         <div class="row">
          <div class="form-group col-md-12">          
            <div>{$form.skill_i18n.lang->getError()}</div> 
            {component name="/site_languages/selectListLanguagesFrontend" selected=$form.skill_i18n.lang}
          </div>          
        </div>
               ...
               <div class="col-md-12">
                   <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="EmployeeSkill form-control Fields Input Color General input-color" language="text" value="{$item_i18n->getSkill()->get('color')}" name="color" id="color"/>
                        </div>
                   </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="field_with_errors"><input class="EmployeeSkillI18n form-control Fields Input" language="text" value="{$item_i18n->get('title')}" name="title" id="title"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
...
<script language="text/javascript"> 
   ...
   $(".Color").minicolors({
     ...
     $('#Cancel').click(function(){                
             return $.ajax2({ data: { filter: { lang:$("#SelectListLanguages option:selected").attr('id'), token: "{mfForm::getToken('EmployeeSkillFormFilter')}" } },                              
      ...
      $('#Save').click(function(){                             
            var  params= {      iFrame:true,             
                                EmployeeSkillI18n: { 
                                   skill_i18n : { lang: $("#SelectListLanguages option:selected").attr('id')  },
                                   skill : { },
        ...
        //      alert("Params="+params.toSource());   return ;      
          return $.ajax2({ data : params,  
                           files :'.Files',
                           url: "{url_to('employees_ajax',['action'=>'SaveNewSkillI18n'])}",
                           target: "#actions"}); 
        });  
