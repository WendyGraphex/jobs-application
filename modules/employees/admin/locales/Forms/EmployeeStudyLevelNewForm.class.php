...
class EmployeeStudyLevelNewForm extends mfForm {
    ...
    function configure()
    {
        $this->embedForm('level', new EmployeeStudyLevelBaseForm($this->getDefault('level')));
        $this->embedForm('level_i18n', new EmployeeStudyLevelI18nBaseForm($this->getDefault('level_i18n')));
