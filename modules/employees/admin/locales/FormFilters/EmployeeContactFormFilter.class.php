...
class EmployeeContactFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployeeContact');
       
       $this->setFields(array(
           'lastname'=>array(            
              'search'=>array('conditions'=>
                                                 "(".
               EmployeeContact::getTableField('lastname')." COLLATE UTF8_GENERAL_CI LIKE '%%{lastname}%%' OR ".
               EmployeeContact::getTableField('firstname')." COLLATE UTF8_GENERAL_CI LIKE '%%{firstname}%%'".
                                                 ")")
                                ),
           'firstname'=>array(             
              'search'=>array('conditions'=>
           ...
           'email'=>array(                     
                        'search'=>array('conditions'=>EmployeeContact::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{email}%%' ")
                        ),          
           'address1'=>array(                       
                        'search'=>array('conditions'=>EmployeeContact::getTableField('address1')." COLLATE UTF8_GENERAL_CI LIKE '%%{address1}%%' ")
                        ),
           'address2'=>array(                       
                        'search'=>array('conditions'=>EmployeeContact::getTableField('address2')." COLLATE UTF8_GENERAL_CI LIKE '%%{address2}%%' ")
                        ),
           'city'=>array(                       
                        'search'=>array('conditions'=>EmployeeContact::getTableField('city')." COLLATE UTF8_GENERAL_CI LIKE '%%{city}%%' ")
                        ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployeeContact::getTable().                            
                       ";"); 
       // Validators 
