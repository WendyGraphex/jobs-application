...
class EmployeeGalleryFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployeeGallery');
       
       $this->setFields(array(
           'name' => array(
                'class' => 'EmployeeGallery',
                'search' => array('conditions' =>
                    EmployeeGallery::getTableField('name') . " COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%'"
                )
            ),
           'title' => array(
                'class' => 'EmployeeGalleryI18n',
                'search' => array('conditions' =>
                    EmployeeGalleryI18n::getTableField('title') . " COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%'"
                )
            ),
           'tpl' => array(
                'class' => 'EmployeeGallery',
                'search' => array('conditions' =>
                    EmployeeGallery::getTableField('tpl') . " COLLATE UTF8_GENERAL_CI LIKE '%%{tpl}%%'"
                )
            ),
                        
           ));
       $this->setQuery("SELECT {fields} FROM ".EmployeeGallery::getTable().
                        " LEFT JOIN ".EmployeeGalleryI18n::getInnerForJoin('gallery_id')." AND lang='{lang}'".    
                       ";"); 
       // Validators 
