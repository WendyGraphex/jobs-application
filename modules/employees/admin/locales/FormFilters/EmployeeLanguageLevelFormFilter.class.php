...
class EmployeeLanguageLevelFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployeeLanguageLevel');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'EmployeeLanguageLevelI18n',
                        'search'=>array('conditions'=>EmployeeLanguageLevelI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'EmployeeLanguageLevel',
                        'search'=>array('conditions'=>EmployeeLanguageLevel::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployeeLanguageLevel::getTable().                      
