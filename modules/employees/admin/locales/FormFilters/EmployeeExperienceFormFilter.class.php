...
class EmployeeExperienceFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployeeExperience');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'EmployeeExperienceI18n',
                        'search'=>array('conditions'=>EmployeeExperienceI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'EmployeeExperience',
                        'search'=>array('conditions'=>EmployeeExperience::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployeeExperience::getTable().                      
                       " LEFT JOIN ".EmployeeExperienceI18n::getInnerForJoin('experience_id'). " AND ".EmployeeExperienceI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
