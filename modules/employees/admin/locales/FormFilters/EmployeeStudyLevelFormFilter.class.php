...
class EmployeeStudyLevelFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployeeStudyLevel');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'EmployeeStudyLevelI18n',
                        'search'=>array('conditions'=>EmployeeStudyLevelI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'EmployeeStudyLevel',
                        'search'=>array('conditions'=>EmployeeStudyLevel::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployeeStudyLevel::getTable().                      
                       " LEFT JOIN ".EmployeeStudyLevelI18n::getInnerForJoin('level_id'). " AND ".EmployeeStudyLevelI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
