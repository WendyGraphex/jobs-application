...
class EmployeeFormFilter extends mfFormFilter2 {
    ...
    {                         
       ...
       $this->setFields(array(
              ...
              'search'=>array('conditions'=>
                                                 "(".
             Employee::getTableField('username')." COLLATE UTF8_GENERAL_CI LIKE '%%{firstname}%%' OR ".
             Employee::getTableField('lastname')." COLLATE UTF8_GENERAL_CI LIKE '%%{firstname}%%' OR ".
             Employee::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{firstname}%%' OR ".
