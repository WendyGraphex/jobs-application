...
class EmployeeSessionFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployeeSession');
       $this->setFields(array(
          
           
             'email'=>array(
                        'class'=>'EmployeeSession',
                        'search'=>array('conditions'=>EmployeeSession::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{email}%%' ")
                        ), 
           'ip'=>array(
                        'class'=>'EmployeeSession',
                        'search'=>array('conditions'=>EmployeeSession::getTableField('ip')." COLLATE UTF8_GENERAL_CI LIKE '%%{ip}%%' ")
                        ),  
               ));      
       $this->setQuery("SELECT {fields} FROM ".EmployeeSession::getTable().    
                      " INNER JOIN ".EmployeeSession::getOuterForJoin('user_id').
                       ";");
       // Validators 
