...
class EmployeeGraduateDiplomaFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployeeGraduateDiploma');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'EmployeeGraduateDiplomaI18n',
                        'search'=>array('conditions'=>EmployeeGraduateDiplomaI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'EmployeeGraduateDiploma',
                        'search'=>array('conditions'=>EmployeeGraduateDiploma::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployeeGraduateDiploma::getTable().                      
       ...
       $this->setValidators(array( 
            ...
            'equal' => new mfValidatorSchema(array(   
                           // "lang"=>new mfValidatorChoice(array("choices"=>array(""=>"")+ProductFavoriteUtils::getGraduateDiplomasSort($this->getSite()),"key"=>true,"required"=>false)),                            
