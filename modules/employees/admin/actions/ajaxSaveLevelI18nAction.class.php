...
class  employees_ajaxSaveLevelI18nAction extends mfAction {
    
          
    function execute(mfWebRequest $request) {                    
        $messages = mfMessages::getInstance();     
        $this->form = new EmployeeStudyLevelViewForm($request->getPostParameter('EmployeeStudyLevelI18n'));                 
        try
        {   
                     
            $this->item_i18n=new EmployeeStudyLevelI18n($this->form->getDefault('level_i18n'));               
