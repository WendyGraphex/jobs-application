...
class EmployeeValidationTokenBase extends mfObject3 {
    ...
    function loadByUser(Employee $user)
    {
        if ($user->isNotLoaded())
            return $this;
    ...
    {
        return array('url'=>link_i18n('employees_validate_email',array(),null,'frontend')."?token=".$this->get('token')."&email=".$this->getUser()->get('email'));
    }
