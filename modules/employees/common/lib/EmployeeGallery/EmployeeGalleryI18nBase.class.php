...
class EmployeeGalleryI18nBase extends mfObjectI18n {
     
    protected static $fields=array('title','gallery_id','lang','created_at','updated_at');
    const table="t_employee_gallery_i18n"; 
    protected static $foreignKeys=array('gallery_id'=>'EmployeeGallery');  
    ...
    {             
       ...
       $db=mfSiteDatabase::getInstance()           
            ...
            ->setObjects(array('EmployeeGalleryI18n','EmployeeGallery'))
       ...
       if (!$db->getNumRows())
        ...
        $this->toObject($items->getEmployeeGalleryI18n());
        $this->set('gallery_id',$items->getEmployeeGallery());
    }
