...
class EmployeeRemember extends mfObject3 {
   ...
   // SETTERS 
    ...
    function setKey($key)
    {
     ...
     function setUser(Employee $user)
    {
    ...
    function getUser()
    {
        return $this->_user_id=$this->_user_id===null?new Employee($this->get('user_id')):$this->_user_id;
    }
    
    static function getCookieName()
    {
        return md5('EmployeeRememberFrontend');
    }
    
    static function cleanup($time_expiration,Employee $user)
    {
    ...
    static function getUserRemember($key)
    {
         $db=mfSiteDatabase::getInstance()
                ...
                ->setObjects(array('EmployeeRemember','Employee'))
        ...
        $items->getEmployeeRemember()->set('user_id',$items->getEmployee());
        return $items->getEmployeeRemember();
    }
