...
class EmployeeAdvertI18nEmailEngine extends mfEmailEngineCore {
    
    protected $advert_i18n=null,$settings=null;
        
    function __construct(EmployeeAdvertI18n $advert_i18n,$options=array()) {
    ...
    {                 
         ...
         {                        
            ...
            $this->getMailer()->sendMail('employees','emailAdvertI18nCreated',$this->getCompany()->getEmailWithName(), 
                        $this->getAdvertI18n()->getAdvert()->getEmployeeUser()->get('email'), 
                        $model_i18n->get('subject',__('Your job posting has been published.')),
    ...
    {                 
         ...
         {                        
            ...
            $this->getMailer()->sendMail('employees','emailAdvertI18nPublished',$this->getCompany()->getEmailWithName(), 
                        $this->getAdvertI18n()->getAdvert()->getEmployeeUser()->get('email'), 
                        $model_i18n->get('subject',__('Graphex - Your job posting has been published.')),
                        array('advert_i18n'=>$this->getAdvertI18n(),                           
                              'model_i18n'=>$model_i18n,
                              'company'=>$this->getCompany()),
                        array(), // files
    ...
    {                 
         ...
         {                        
          //  $this->getMailer()->debug();          
            ...
            $this->getMailer()->sendMail('employees','emailAdvertI18nRefused',$this->getCompany()->getEmailWithName(), 
                        $this->getAdvertI18n()->getAdvert()->getEmployeeUser()->get('email'), 
                        $model_i18n->get('subject',__('Advert refused')),
                        array('advert_i18n'=>$this->getAdvertI18n(),                           
                              'model_i18n'=>$model_i18n,
                              'company'=>$this->getCompany()),
                        array(), // files
    ...
    {               
         ...
         {                                
            ...
            $email_spooler->add(array(
                            'to'=>$this->getAdvertI18n()->getAdvert()->getEmployeeUser()->get('email'),                                               
                            'from'=>$this->getCompany()->get('email'),
                            'bcc'=>(string)$this->getSettings()->getAdminRecipients()->implode(),
                            'body'=>$message,
                            'subject'=>$model_i18n->get('subject',__('Advert revival')),
                            ));
