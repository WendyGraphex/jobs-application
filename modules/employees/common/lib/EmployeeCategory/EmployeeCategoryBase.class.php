...
class EmployeeCategoryBase extends mfObject3 {
    
     protected static $fields=array('category_id','employee_user_id','created_at','updated_at');    
    const table="t_employee_category"; 
    protected static $foreignKeys=array('employee_user_id'=>'Employee','category_id'=>'PartnerWorkCategory'); // By default
