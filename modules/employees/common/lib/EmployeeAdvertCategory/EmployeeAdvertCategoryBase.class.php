...
class EmployeeAdvertCategoryBase extends mfObject3 {
    
     protected static $fields=array('category_id','advert_id','created_at','updated_at');    
    const table="t_employee_advert_category"; 
    protected static $foreignKeys=array('advert_id'=>'EmployeeAdvert','category_id'=>'PartnerWorkCategory'); // By default
