...
class EmployeeUserPopularBase extends mfObject3 {
     
    protected static $fields=array('employee_user_id','user_id','employer_user_id','lang','country','ip','created_at','updated_at');    
    const table="t_employee_user_popular"; 
    ...
    function __construct($parameters=null) {
      ...
      if (is_array($parameters)||$parameters instanceof ArrayAccess)
      {
          if (isset($parameters['id']))
            ...
            if (isset($parameters['employee']) && isset($parameters['user']) && $parameters['employee'] instanceof Employee)
             return $this->loadbyEmployeeAndUser($parameters['employee'],$parameters['user']);    
      ...
      function loadbyEmployeeAndUser(Employee $employee,$user)
    {
        $this->set('user_id',$employee);
   ...
   {
       return $this->formatter=$this->formatter===null?new EmployeePopularFormatter($this):$this->formatter;
   }
