...
class EmployeeAdvertSearchUserLanguageLetter extends mfString {
    
   
    
     function getUrl()
    {
       return link_i18n('employees_search_advert_user_language_letter',array('letter'=> $this->getValue()),null,'frontend');
    }
    
    
     static function getLetters()
    {     
        $list=new EmployeeAdvertSearchUserLanguageLetterCollection();
        ...
        {          
            $list[]= new EmployeeAdvertSearchUserLanguageLetter($row[0]);
        }                   
        return $list->asort();
    }
