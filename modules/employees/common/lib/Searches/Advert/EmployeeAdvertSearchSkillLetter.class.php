...
class EmployeeAdvertSearchSkillLetter extends mfString {
    
    
    
    function getUrl()
    {
       return link_i18n('employees_search_advert_skill_letter',array('letter'=> $this->getValue()),null,'frontend');
    }
    ...
    {     
        ...
        {          
            $list[]= new EmployeeAdvertSearchSkillLetter(strtoupper($row[0]));
        }                   
        return $list;
    }
