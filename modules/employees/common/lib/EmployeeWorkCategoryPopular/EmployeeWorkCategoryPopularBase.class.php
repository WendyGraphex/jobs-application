...
class EmployeeWorkCategoryPopularBase extends mfObject3 {
    ...
    function __construct($parameters=null) {
      ...
      if (is_array($parameters)||$parameters instanceof ArrayAccess)
      {
          if (isset($parameters['id']))
            ...
            if (isset($parameters['user']) && isset($parameters['category']) && $parameters['category'] instanceof EmployeeWorkCategory)
      ...
      function loadbyCategoryAndUser(EmployeeWorkCategory $category,$user)
    {
   ...
   {
       return $this->formatter=$this->formatter===null?new EmployeeWorkCategoryPopularFormatter($this):$this->formatter;
   }
