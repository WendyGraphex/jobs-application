...
class EmployeeAdvertPopularBase extends mfObject3 {
    ...
    function __construct($parameters=null) {
      ...
      if (is_array($parameters)||$parameters instanceof ArrayAccess)
      {
          if (isset($parameters['id']))
           ...
           if (isset($parameters['advert']) && isset($parameters['user']) && $parameters['advert'] instanceof EmployeeAdvert)
      ...
      function loadbyAdvertAndUser(EmployeeAdvert $advert,$user)
    {
   ...
   {
       return $this->formatter=$this->formatter===null?new EmployeeAdvertPopularFormatter($this):$this->formatter;
   }
   
   function getAdvertI18n()
    {
        return $this->advert_i18n=$this->advert_i18n===null?new EmployeeAdvertI18n(array('advert_id'=>$this->get('advert_id'),'lang'=>$this->get('lang'))):$this->advert_i18n;
    }
    ...
    {     
        ...
        $this->getAdvert()->getEmployeeUser()->addNumberOfViews();
        return $this;
    }
}