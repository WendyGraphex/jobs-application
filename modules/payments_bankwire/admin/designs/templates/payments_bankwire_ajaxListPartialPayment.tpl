     ...
     function getFilterParameters()
        ...
        {                      
           return $.ajax2({ data: getFilterParameters(), 
                            url:"{url_to('payments_bankwire_ajax',['action'=>'ListPartialPayment'])}" ,                          
                            target: "#actions"
                             });
        }
        ...
        $(".pager").click(function () {                     
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('payments_bankwire_ajax',['action'=>'ListPartialPayment'])}?page="+$(this).attr('data-page'),                                
                                 target: "#actions"
                });
        });
             
           $("#init").click(function() {                   
              return $.ajax2({ url:"{url_to('payments_bankwire_ajax',['action'=>'ListPartialPayment'])}",                                    
                         target: "#actions"}); 
           }); 
