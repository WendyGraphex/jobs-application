...
class CustomerRegistrationFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerRegistration');
       
       $this->setFields(array(
           'query'=>array(            
              'search'=>array('conditions'=>
                                                 "(".
               CustomerRegistration::getTableField('firstname')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".
               CustomerRegistration::getTableField('lastname')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".             
               CustomerRegistration::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".
               CustomerRegistration::getTableField('phone')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".
               CustomerRegistration::getTableField('state')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".
               CustomerRegistration::getTableField('city')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' ".
                                                 ")")
                                ),
              ...
              'profession'=>array(                       
                        'search'=>array('conditions'=>CustomerRegistration::getTableField('city')." COLLATE UTF8_GENERAL_CI LIKE '%%{city}%%' ")
                        ),
       ));
       $this->setQuery("SELECT {fields} FROM ".CustomerRegistration::getTable().                            
                       ";"); 
       // Validators 
