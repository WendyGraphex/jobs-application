<div style="color: #fff;background-color: black;padding: 15px;">
    <h3 class="WelcomeModalStyleTitle">Welcome to Graphex Technology!</h3>  
    <p style="text-align: center;font-size: 18px;">We’re so happy you’re here!</p>
    <div class="WelcomeModalStyleDiv">
        ...
        <div style="margin-top: 40px;">
            Thanks for signing up to keep in touch with Graphex Technology.<br/>
    ...
    <div style="text-align: left;">
        <div style="width: 100px;">
            <img src="{url("/files/pictures/graphex-owner.jpg","web")}" class="imageOwner"/>
        </div>
