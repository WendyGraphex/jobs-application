...
class SiteCityI18nBase extends mfObjectI18n {
     
    protected static $fields=array('title','city_id','lang','created_at','updated_at');
    const table="t_site_city_i18n"; 
    protected static $foreignKeys=array('city_id'=>'SiteCity'); // By default
    ...
    function __construct($parameters=null) {
      ...
      {
          if (isset($parameters['lang']) && isset($parameters['city_id']))
              return $this->loadByLangAndCityId((string)$parameters['lang'],(string)$parameters['city_id']); 
     ...
     protected function loadByLangAndCityId($lang,$city_id)
    {
       $this->set('city_id',$city_id);
       $this->set('lang',$lang);
       $db=mfSiteDatabase::getInstance()           
            ->setParameters(array('city_id'=>$city_id,"lang"=>$lang))              
            ->setQuery("SELECT * FROM ".self::getTable().                      
                       " WHERE lang='{lang}' AND city_id={city_id};")
            ->makeSqlQuery();  
    ...
    {     
       $db=mfSiteDatabase::getInstance()           
            ...
            ->setQuery("SELECT ".self::getFieldsAndKeyWithTable()." FROM ".self::getTable().  
                       " LEFT JOIN ".self::getOuterForJoin('city_id').                      
                       " WHERE name='{name}';")
            ->makeSqlQuery();  
        return $this->rowtoObject($db);
    }
    ...
    {
        $db=mfSiteDatabase::getInstance()           
            ->setParameters(array("city_id"=>$this->get('city_id')))              
      ...
      function delete()
    {
     ...
     function getCity()
    {
       return $this->_city_id=$this->_city_id===null?new SiteCity($this->get('city_id')):$this->_city_id;                 
    }    
