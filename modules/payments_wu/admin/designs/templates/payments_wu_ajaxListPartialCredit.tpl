          ...
          <div class="breadcrumb-title">
            <p>               
                ...
                <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('Freelancers')}
                  <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('Wu')}
            </p>
          </div>
          <!-- End breadcrumb -->
{alerts}
     ...
     function getFilterParameters()
        ...
        {                      
           return $.ajax2({ data: getFilterParameters(), 
                            url:"{url_to('payments_wu_ajax',['action'=>'ListPartialCredit'])}" ,                          
                            target: "#actions"
                             });
        }
        ...
        $(".pager").click(function () {                     
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('payments_wu_ajax',['action'=>'ListPartialCredit'])}?page="+$(this).attr('data-page'),                                
                                 target: "#actions"
                });
        });
             
        $("#init").click(function() {                   
              return $.ajax2({ url:"{url_to('payments_wu_ajax',['action'=>'ListPartialCredit'])}",                                    
                         target: "#actions"}); 
        }); 
        ...
        $(".Requests").click(function() {                   
           ...
           $(".Details").click(function() {                   
              return $.ajax2({ data : { PaymentEmployee : $(this).attr('id') },
                         url:"{url_to('payments_wu_ajax',['action'=>'ViewDetails'])}",                                    
                         target: "#actions"}); 
        });
</script>
