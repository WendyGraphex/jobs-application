...
<div class="row admin-header-container">
    <div class="col-sm">
        <h3 class="admin-header-big-text">{__("New Software")}</h3>
...
<div class="breadcrumb-title">
    <p>
        ...
        <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('New Software')}
    </p>
</div>
{alerts}
     ...
     <div class="the-box bg-white p-3">    
         <div class="row">
          <div class="form-group col-md-12">          
            <div>{$form.software_i18n.lang->getError()}</div> 
            {component name="/site_languages/selectListLanguagesFrontend" selected=$form.software_i18n.lang}
          </div>          
        </div>
        ...
        {*<div class="row">          
           ...
           <div class="form-group col-md-6">             
              {if $form->hasErrors()}<div class="alert alert-{if $form.software.icon->hasError()}danger{else}light{/if}" role="alert">&nbsp;{$form.software.icon->getError()}</div>{/if}
            <label for="icon">{__('Icon')}{if $form->software.icon->getOption('required')}*{/if}</label> 
      ...
      $('#Save').click(function(){                             
            var  params= {      iFrame:true,
                                ...
                                CustomerAcademySoftwareI18n: { 
                                   software_i18n : { lang: $("#SelectListLanguages option:selected").attr('id')  },
                                   software : { },
        ...
        //      alert("Params="+params.toSource());   return ;      
          return $.ajax2({ data : params,  
                           files :'.Files',
                           url: "{url_to('customers_academy_ajax',['action'=>'SaveNewSoftwareI18nForCategoryI18n'])}",
                           target: "#actions"}); 
        });                          
