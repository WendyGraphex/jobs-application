...
<div class="row admin-header-container">
    <div class="col-sm">
        <h3 class="admin-header-big-text">{__('CustomerCourseCategorys')}</h3> 
...
<script type="text/javascript">
     $("#Categories tbody").sortable({
        ...
        stop: function (event, ui) {
            ...
            var params = {
                        CustomerCourseCategoryPositions: {
            ...
            $.ajax2({
            data: params,
            url: "{url_to('customers_academy_ajax',['action'=>'MoveCategory'])}"         
        });
        },
    ...
    $("#Cancel").click(function () {
        return $.ajax2({
            data : { CustomerCourseCategoryNode : { node: '{$item_i18n->get('category_id')}', lang: '{$item_i18n->get('lang')}', token : '{mfForm::getToken('CustomerCourseCategoryNodeForm')}'  } },                                
