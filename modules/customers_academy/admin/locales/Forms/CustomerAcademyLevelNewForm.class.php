...
class CustomerAcademyLevelNewForm extends mfForm {
    ...
    function configure()
    {
        $this->embedForm('level', new CustomerAcademyLevelBaseForm($this->getDefault('level')));
        $this->embedForm('level_i18n', new CustomerAcademyLevelI18nBaseForm($this->getDefault('level_i18n')));
