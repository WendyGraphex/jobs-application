    ...
    {                         
       ...
       $this->setFields(array(          
              ...
              'search'=>array('conditions'=>
                                                 "(".
               CustomerCourseCategory::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%'".
                                                 ")")
                                ),
           'title'=>array(
       ...
       $this->setQuery("SELECT {fields} FROM ".CustomerCourseCategory::getTable(). 
                       ...
                       " ORDER BY ".CustomerCourseCategory::getTableField('rb')." ASC".
                       ";"); 
       
//       "SELECT {fields} FROM ".CustomerCourseCategory::getTable(). 
//                       " LEFT JOIN ".CustomerCourseCategoryI18n::getInnerForJoin('category_id')." AND lang='{lang}'".                     
//                       " WHERE level={levelplusone} AND  lb >= {lb} AND rb <= {rb} ".
//                       ";"
//       
                ...
                'equal' => new mfValidatorSchema(array(
                   ...
                   // "is_active"=>new mfValidatorChoice(array("required"=>false,'key'=>true,"choices"=>array(""=>"","YES"=>__("YES"),"NO"=>__("NO")))),
                    //"status"=>new mfValidatorChoice(array("required"=>false,'key'=>true,"choices"=>array(""=>"","DELETE"=>__("DELETE"),"ACTIVE"=>__("ACTIVE")))),
                     //"lang"=>new mfValidatorChoice(array("choices"=>CustomerCourseCategoryUtils::getFormattedLanguages()->unshift(array(''=>'')),'required'=>false,'key'=>true)),                            
