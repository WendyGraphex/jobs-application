...
class CustomerAcademyLevelFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerAcademyLevel');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'CustomerAcademyLevelI18n',
                        'search'=>array('conditions'=>CustomerAcademyLevelI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'CustomerAcademyLevel',
                        'search'=>array('conditions'=>CustomerAcademyLevel::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".CustomerAcademyLevel::getTable().                      
                       " LEFT JOIN ".CustomerAcademyLevelI18n::getInnerForJoin('level_id'). " AND ".CustomerAcademyLevelI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
