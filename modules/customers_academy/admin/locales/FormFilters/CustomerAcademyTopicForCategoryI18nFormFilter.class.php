...
class CustomerAcademyTopicForCategoryI18nFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerAcademyTopic');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'CustomerAcademyTopicI18n',
                        'search'=>array('conditions'=>CustomerAcademyTopicI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'CustomerAcademyTopic',
                        'search'=>array('conditions'=>CustomerAcademyTopic::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".CustomerAcademyTopic::getTable().                      
                       " LEFT JOIN ".CustomerAcademyTopicI18n::getInnerForJoin('topic_id'). " AND ".CustomerAcademyTopicI18n::getTableField('lang')."='{lang}'".                                                        
