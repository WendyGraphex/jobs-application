<?php
 ...
 require_once dirname(__FILE__)."/../locales/Forms/CustomerCourseCategoryViewForm.class.php";
 
class  customers_academy_ajaxSaveCategoryI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {                    
        ...
        $this->form = new CustomerCourseCategoryViewForm($request->getPostParameter('CustomerCourseCategoryI18n'));                    
        try
        {            
          ...
          //      $this->item_i18n->getCategory()->set('number_of_products',$this->form->getCustomerCourseCategoryCategories()->count());
                $this->item_i18n->getCategory()->save();
                $this->item_i18n->save();
           //     $this->item_i18n->getCategory()->updateCustomerCourseCategorys($this->form->getCustomerCourseCategoryCategories());           
