    ...
    <body>
        ...
        <section class="ftco-section bg-light sectionCategoriesTop sectionMarginTop">
            <div id="page-wrapper" class="container">  
                {component name="/customers_academy/breadcrumb" node=$node}                          
                 
                {component name="/customers_academy/subcategories" node=$node}
                
                {component name="/customers_academy/categories" node=$node}                
            </div>                
        </section>
