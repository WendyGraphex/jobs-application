...
<html lang="{$_request->getLanguage()}">
    <head>
        ...
        <script src="/web/js/academy/fontawesome.js"></script>  
        {header}
    </head>
    <body>
        ...
        <section class="ftco-section bg-light sectionCategoriesTop">
            <div id="page-wrapper" class="container">  
                {component name="/customers_academy/breadcrumb" node=$node_i18n->getCategory()}                          
              
                {component name="/customers_academy/subcategories" node=$node_i18n->getCategory()}
                
                {component name="/customers_academy/categories" node=$node_i18n->getCategory() tpl="categories-default"}
