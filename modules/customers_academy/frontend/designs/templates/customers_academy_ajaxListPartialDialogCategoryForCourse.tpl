...
<script type="text/javascript">
     ...
     function getDialogFilterParameters()
        ...
        $(".dialog-pager").click(function () {                     
                return $.ajax2({ data: getDialogFilterParameters(), 
                                 url:"{url_to('customers_course_ajax',['action'=>'ListPartialDialogCategoryForCourse'])}?page="+$(this).attr('data-page'),                                
                                 target: "#Modal-Categories-ctn"
                });
        });
        ...
        $(".CustomerCourseCategoryPath-item").click(function () { 
            $('.DropMenuShowFoldersInside').hide();
             ...
             return $.ajax2({ 
                         ...
                         url:"{url_to('customers_course_ajax',['action'=>'GetChildrenCategory'])}",                                              
                         success : function (resp)
                                {
                                       $(".DropMenuShowFoldersInside").css({
                                        position: "absolute",
