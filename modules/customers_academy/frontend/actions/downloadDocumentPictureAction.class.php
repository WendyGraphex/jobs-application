...
class customers_academy_downloadDocumentPictureAction extends mfAction {
    ...
    function execute(mfWebRequest $request) { 
        ...
        $document= new CustomerAcademyCourseDocument($request->getRequestParameters(array('file','id')),$this->getUser()->isAuthenticated()?$this->getUser()->getGuardUser():null);
