...
class CustomerAcademyCourseDocument extends CustomerAcademyCourseDocumentBase {
     
    
    function __construct($parameters = null,$user=null) {       
           if ($user instanceof CustomerAcademyTeacherUser)
            $this->set('teacher_user_id',$user);      
        if ($parameters instanceof CustomerAcademyCourseI18n)      
            $this->set('course_i18n_id',$parameters);
