...
class CustomerAcademyContactBase extends mfObject3 {
   ...
   const table="t_customer_academy_contact"; 
    ...
    {
        return $this->formatter=$this->formatter===null?new CustomerAcademyContactFormatter($this):$this->formatter;
    }
