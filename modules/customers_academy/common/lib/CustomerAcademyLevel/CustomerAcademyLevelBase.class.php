...
class CustomerAcademyLevelBase extends mfOrderedObject3 {
     
    protected static $fields=array('name','icon','color','position','created_at','updated_at');
    const table="t_customer_academy_level";
    ...
    function hasI18n()
    {
     ...
     {       
         if ($this->i18n===null)
         {
             ...
             $this->i18n=new CustomerAcademyLevelI18n(array('lang'=>$lang,"level_id"=>$this->get('id')));
         }   
         return $this->i18n;
     } 
     ...
     static function getAllI18nForSelect()
    {
        ...
        $db=mfSiteDatabase::getInstance()
                ...
                ->setQuery("SELECT ".CustomerAcademyLevelI18n::getFieldsAndKeyWithTable()." FROM ".CustomerAcademyLevelI18n::getTable().
    ...
    static function getAllForSelect()
    {
        ...
        $db=mfSiteDatabase::getInstance()
                ->setParameters(array("lang"=>mfcontext::getInstance()->getUser()->getLanguage()))
                ->setObjects(array('CustomerAcademyLevelI18n','CustomerAcademyLevel'))
                ->setQuery("SELECT {fields} FROM ".CustomerAcademyLevel::getTable().
        ...
        {             
            $values[$items->getCustomerAcademyLevel()->get('id')]=$items->getCustomerAcademyLevel()->setI18n($items->getCustomerAcademyLevelI18n());
        }              
        return $values;
    }
    ...
    static function getLevelsForSelect()
    {
        ...
        $db=mfSiteDatabase::getInstance()
                ->setParameters(array("lang"=>mfcontext::getInstance()->getUser()->getLanguage()))               
                ->setQuery("SELECT * FROM ".CustomerAcademyLevelI18n::getTable().                           
                           " WHERE lang='{lang}' ORDER BY title ASC;")               
                ->makeSqlQuery(); 
        if (!$db->getNumRows())
            return $values;
    ...
    {          
        ...
        $db=mfSiteDatabase::getInstance()               
                ...
                ->setObjects(array('CustomerAcademyLevel','CustomerAcademyLevelI18n'))
                ->setQuery("SELECT {fields} FROM ".self::getTable(). 
                           " INNER JOIN ".CustomerAcademyLevelI18n::getInnerForJoin('level_id')." AND lang='{lang}'".
       ...
       // var_dump($db->getQuery());
        ...
        {                  
           ...
           $item->setI18n($items->getCustomerAcademyLevelI18n());
   ...
   {
       return $this->formatter=$this->formatter===null?new CustomerAcademyLevelFormatter($this):$this->formatter;
   }
}
