...
class CustomerAcademyLevelI18nBase extends mfObjectI18n {
     
    protected static $fields=array('title','level_id','lang','created_at','updated_at');
    const table="t_customer_academy_level_i18n"; 
    protected static $foreignKeys=array('level_id'=>'CustomerAcademyLevel'); // By default
     ...
     static function create(mfArray $values,$lang)
    {
        ...
        if ($values->isEmpty())
            return ;       
        $collection_i18n = new CustomerAcademyLevelI18nCollection();
        foreach ($values as $value)        
        {
            $item_i18n = new CustomerAcademyLevelI18n();
