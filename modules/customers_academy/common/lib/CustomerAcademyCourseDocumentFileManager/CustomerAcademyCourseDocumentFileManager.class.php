...
class CustomerAcademyCourseDocumentFileManager {
     
    protected $item=null;
     
    function __construct(CustomerAcademyCourseDocument $item) {
        $this->item=$item;
    }
   ...
   /* function escapeFilename(mfString $filename)
    ...
    function getImages()
    {
        return $this->images=$this->images===null?new CustomerAcademyCourseDocumentFileManagerPictures($this):$this->images;
    }
     ...
     function getFile()
    {
        return new FileObject2(array(
                 ...
                 "file"=>$this->getItem()->get('file'),
                  ...
                  "url"=>url_to("customers_course_document_download",array('file'=>$this->getItem()->get('file'),'id'=>$this->getItem()->get('id'),),mfConfig::get('mf_app'))
              ));
    }
    
    function getFlavicons()
    {     
        return $this->flavicons=$this->flavicons===null?new CustomerAcademyCourseDocumentFileFlavicons($this->getItem()->get('extension')):$this->flavicons;
    }
