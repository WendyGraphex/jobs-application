...
class CustomerAcademyCourseDocumentFileManagerPictures extends Pictures {
     
     function __construct(CustomerAcademyCourseDocumentFileManager $item) {
        ...
        if ($this->original===null)
        {
            $this->original=new PictureObject3(array(
                 ...
                 "picture"=>$this->getFileManager()->getItem()->get('file'),
                   "urlPath"=>url_to("customers_course_document_download",array('file'=>'','id'=>''),mfConfig::get('mf_app')),
                  "url"=>url_to("customers_course_document_download",array('file'=>$this->getFileManager()->getItem()->get('file'),'id'=>$this->getFileManager()->getItem()->get('id')),mfConfig::get('mf_app'))
            ));
        }   
    ...
    {               
       return new PictureObject3(array(
             ...
             "urlPath"=>url_to("customers_course_document_download_picture",array('file'=>'','id'=>'','type'=>$type),mfConfig::get('mf_app')),
                  "url"=>url_to("customers_course_document_download_picture",array('file'=>$this->getFileManager()->getItem()->get('file'),'type'=>$type,'id'=>$this->getFileManager()->getItem()->get('id')),mfConfig::get('mf_app'))
        ));
    }
