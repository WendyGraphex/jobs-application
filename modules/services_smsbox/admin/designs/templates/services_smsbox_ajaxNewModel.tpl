...
<div class="content-header row">
  <div class="content-header-left col-md-6 col-12 mb-2">
      <h3 class="content-header-title mb-0">{__("Nouveau modèle")}</h3>
    </div>
          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                  <label>{__("Titre")}{if $form->name->getOption('required')}*{/if}</label>
                  <div> 
            ...
            <div class="col">
              <div class="form-group">    
                  ...
                  <div> 
                      ...
                      <textarea cols="" rows="auto" class="ProductModel Input form-control" name="content">{$item->get('content')}</textarea>
                  </div>
              </div>
            </div>
          </div>
