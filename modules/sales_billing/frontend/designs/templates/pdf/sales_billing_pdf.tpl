        ...
        <div style="font-family: Helvetica, Arial, sans-serif;">
            ...
            <div style="margin-top: 100px;margin-bottom: 50px;">
                ...
                <ul class="listUl">
                    ...
                    <li>
                        <label>{__('Date:')} </label>
                        <label>{format_date($billing.created_at,['d','q'])}</label>
                    </li>
                </ul>
            </div>
            <table border="1" style="width: 100%;border-collapse: collapse;text-align: center;height: 180px;margin-bottom: 50px;">
                ...
                {foreach $billing.products as $item} 
                    <tr>
            ...
            <span style="display: inline-block;width: 25%;">
                ...
                <ul class="listUl">
                    ...
                    <li>{$billing.commission_with_tax}</li>
                </ul>
                <ul class="listUl">
                    <li style="width: 50%;">{__('Sub Total')} :</li>
                    <li>{$billing.global_sale_price_with_tax}</li>
                </ul>
                <ul class="listUl">
            ...
            <div style="height: 50px;line-height: 50px;background-color: #ead632;color: #222;font-size: 25px;font-weight: bold;margin-top: 50px;">
                <label style="margin-right: 100px;float: right;right: 50px;">{__('Total')} : {$billing.general_sale_price_with_tax}</label>
            </div>    
            <div style="margin-top: 50px;position: relative;">
                <div style="width: 40%;display: inline-block;position: absolute;top: 20%;">
                    <h3>{__('Payment info')} :</h3>
                    <div>
                        <div>{__('Your bank name')}: <label>{$billing.method.i18n}</label></div>
                    </div>
                </div>
