...
class SaleBillingStateI18nBase extends mfObjectI18n {
     
    protected static $fields=array('title','state_id','lang','created_at','updated_at');
    const table="t_sales_billing_state_i18n"; 
    protected static $foreignKeys=array('state_id'=>'SaleBillingState'); // By default
      ...
      function delete()
    {
     ...
     function getState()
    {
       return $this->_state_id=$this->_state_id===null?new SaleBillingState($this->get('state_id')):$this->_state_id;                 
    }    
