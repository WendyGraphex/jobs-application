...
class sales_billing_ajaxSaveNewStateI18nAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {                       
        ...
        try
        {      
            $this->form= new SaleBillingStateNewForm($this->getUser()->getLanguage(),$request->getPostParameter('SaleBillingStateI18n'));             
            $this->item_i18n=new SaleBillingStateI18n();
