...
class SaleBillingStateFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('SaleBillingState');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'SaleBillingStateI18n',
                        'search'=>array('conditions'=>SaleBillingStateI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'SaleBillingState',
                        'search'=>array('conditions'=>SaleBillingState::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".SaleBillingState::getTable().                      
                       " LEFT JOIN ".SaleBillingStateI18n::getInnerForJoin('state_id'). " AND ".SaleBillingStateI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
