...
class EmailerSpoolerSchedulerFormFilter extends mfFormFilterBase {
    ...
    {                           
       ...
       $this->setClass('EmailerSpoolerScheduler');
       $this->setFields(array());
       $this->setQuery("SELECT {fields} FROM ".EmailerSpoolerScheduler::getTable().                                                                                            
                       ";"); 
       // Validators 
