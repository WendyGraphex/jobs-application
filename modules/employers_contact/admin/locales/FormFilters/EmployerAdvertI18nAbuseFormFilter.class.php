...
class EmployerAdvertI18nAbuseFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployerAdvertI18nAbuse');
       
       $this->setFields(array(
           'lastname'=>array(            
              'search'=>array('conditions'=>
                                                 "(".
               EmployerAdvertI18nAbuse::getTableField('lastname')." COLLATE UTF8_GENERAL_CI LIKE '%%{lastname}%%' OR ".
               EmployerAdvertI18nAbuse::getTableField('firstname')." COLLATE UTF8_GENERAL_CI LIKE '%%{firstname}%%'".
                                                 ")")
                                ),
           'firstname'=>array(             
              'search'=>array('conditions'=>
           ...
           'email'=>array(                     
                        'search'=>array('conditions'=>EmployerAdvertI18nAbuse::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{email}%%' ")
             ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployerAdvertI18nAbuse::getTable(). 
                        " INNER JOIN ".EmployerAdvertI18nAbuse::getOuterForJoin('advert_i18n_id').  
                        " LEFT JOIN ".EmployerAdvertI18nAbuse::getOuterForJoin('type_id').  
                        " LEFT JOIN ".CustomerAbuseTypeI18n::getInnerForJoin('abuse_id'). " AND ".CustomerAbuseTypeI18n::getTableField('lang')."='{lang}'".                             
                       ";"); 
       // Validators 
