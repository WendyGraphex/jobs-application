...
class EmployerAdvertI18nShareFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployerAdvertI18nShare');
       
       $this->setFields(array(
           'lastname'=>array(            
              'search'=>array('conditions'=>
                                                 "(".
               EmployerAdvertI18nShare::getTableField('lastname')." COLLATE UTF8_GENERAL_CI LIKE '%%{lastname}%%' OR ".
               EmployerAdvertI18nShare::getTableField('firstname')." COLLATE UTF8_GENERAL_CI LIKE '%%{firstname}%%'".
                                                 ")")
                                ),
           'firstname'=>array(             
              'search'=>array('conditions'=>
           ...
           'email'=>array(                     
                        'search'=>array('conditions'=>EmployerAdvertI18nShare::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{email}%%' ")
             ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployerAdvertI18nShare::getTable().       
                      " INNER JOIN ".EmployerAdvertI18nShare::getOuterForJoin('advert_i18n_id').  
                       ";"); 
       // Validators 
