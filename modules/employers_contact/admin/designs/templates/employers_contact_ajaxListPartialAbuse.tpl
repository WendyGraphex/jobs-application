...
<script type="text/javascript">
     ...
     function getFilterParameters()
        ...
        {          
           return $.ajax2({ data: getFilterParameters(), 
                            url:"{url_to('employers_contact_ajax',['action'=>'ListPartialAbuse'])}" ,                          
                            target: "#actions"
                             });
        }
        ...
        $(".pager").click(function () {                     
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('employers_contact_ajax',['action'=>'ListPartialAbuse'])}?page="+$(this).attr('data-page'),                                
                                 target: "#actions"
                });
        });
        
         $("#init").click(function () {                     
                return $.ajax2({   url:"{url_to('employers_contact_ajax',['action'=>'ListPartialAbuse'])}",
                                 target: "#actions"
                });
        });
     ...
     $(".Delete").click( function () { 
                ...
                return $.ajax2({ data :{ EmployerAdvertI18nAbuse: $(this).attr('id') },
