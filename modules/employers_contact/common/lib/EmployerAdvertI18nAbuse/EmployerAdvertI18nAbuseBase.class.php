...
class EmployerAdvertI18nAbuseBase extends mfObject3 {
   ...
   const table="t_employer_advert_i18n_abuse"; 
    ...
    protected static $foreignKeys=array('employer_user_id'=>'EmployerUser',
                                        ...
                                        'advert_i18n_id'=>'EmployerAdvertI18n',
    ...
    {
        return $this->formatter=$this->formatter===null?new  EmployerAdvertI18nAbuseFormatter($this):$this->formatter;
    }
    ...
    {
        return $this->_advert_i18n_id= $this->_advert_i18n_id===null?new EmployerAdvertI18n($this->get('advert_i18n_id')): $this->_advert_i18n_id;
    }
