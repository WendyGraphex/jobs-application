...
class EmployerContactBase extends mfObject3 {
   ...
   const table="t_employer_contact"; 
  ...
  /*      
    ...
    */
    ...
    {
        return $this->formatter=$this->formatter===null?new EmployerContactFormatter($this):$this->formatter;
    }
