...
class EmployerAdvertI18nShareBase extends mfObject3 {
   ...
   const table="t_employer_advert_i18n_share"; 
    ...
    {
        return $this->formatter=$this->formatter===null?new  EmployerAdvertI18nShareFormatter($this):$this->formatter;
    }
