          ...
          <div class="row admin-header-container">
            <div class="col-sm">
              <h3 class="admin-header-big-text">{__('Employee')}</h3>
              <h3 class="admin-header-small-text">{__('Employee alerts management')}</h3>
            </div>
          ...
          <div class="breadcrumb-title">
            <p>
                ...
                <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('Employees')}
                      ...
                      <tbody>
                         {foreach $pager as $item} 
                            <tr class="list" id="{$item->get('id')}" role="row">
                                ...
                                <td>
                                    {$item->getUser()->getFormatter()->getUsername()}
                                </td>
 ...
 <script type="text/javascript">
        ...
        {          
           return $.ajax2({ data: getFilterParameters(), 
                            url:"{url_to('employees_alert_ajax',['action'=>'ListPartialAlert'])}" ,                          
                            target: "#actions"
                             });
        }
        ...
        $(".pager").click(function () {                     
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('employees_alert_ajax',['action'=>'ListPartialAlert'])}?page="+$(this).attr('data-page'),                                
                                 target: "#actions"
                });
        });
        ...
        $(".Delete").click( function () { 
                ...
                return $.ajax2({ data :{ EmployeeAlert: $(this).attr('id') },
                                 url :"{url_to('employees_alert_ajax',['action'=>'DeleteAlert'])}",                               
