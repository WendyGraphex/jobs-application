...
class EmployeeAlertFormFilter extends mfFormFilter2 {
    ...
    {                         
       ...
       $this->setValidators(array( 
        ...
        $this->setQuery(mfQuery::getInstance()
                        ->select("{fields}")
                        ->from(EmployeeAlert::getTable())
                        ->where(EmployeeAlert::getTableField('employee_user_id')."='{employee_user_id}'")); 
    }
