...
class EmployeeAlertBase extends mfObject3 {
   ...
   {
       return $this->formatter=$this->formatter===null?new EmployeeAlertFormatter($this):$this->formatter;
   }
