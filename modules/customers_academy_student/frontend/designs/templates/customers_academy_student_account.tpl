    ...
    <body>   
        <div id="body-ctn" class="container-scroller" {if $user->getGuardUser()->isLocked()}style="display:none"{/if}>
            ...
            <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                    ...
                    <ul class="navbar-nav navbar-nav-right">                    
                        {component name="/customers_academy_cart/SmallCartDisplay"}

                        {component name="/customers_academy_student/profile"}          
                    </ul>
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                {component name="/customers_academy_student/menu"}
                <!-- partial -->
                <div class="main-panel">
                    <div class="content-wrapper" id="page-wrapper">  
                        ...
                        {if $user->getGuardUser()->isCompleted()}
                            {component name="/customers_academy_student/dashboard"}                                   
                        {else}    
                            {component name="/customers_academy_student/completion"}  
                        {/if}  
        ...
        <!-- UNLOCK BEGIN -->          
        {component name="/customers_academy_student/unlock"}
        <!-- UNLOCK END -->        
