                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control AcademyStudentUser Fields Input" name="username" value="{$student_user->get('username')}">
                        ...
                        <div class="col-md-5">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    {html_options class="form-control AcademyStudentUser Fields Select" name="gender" options=$form->gender->getChoices() selected=$student_user->get('gender')}
                                </div>
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" class="form-control AcademyStudentUser Fields Input" name="firstname" value="{$student_user->get('firstname')}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-7">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" class="form-control AcademyStudentUser Fields Input" name="lastname" value="{$student_user->get('lastname')}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            {*<input id="Birthday" type="text" class="form-control AcademyStudentUser Fields Input birthday" name="birthday" value="{if $form->hasErrors()}{$form.birthday}{else}{$student_user->getFormatter()->getBirthday()->getText()}{/if}">*}
                                            {*<input id="Birthday" type="text" class="form-control AcademyStudentUser Fields Input birthday" name="birthday" value="{if $form->hasErrors()}{$form.birthday}{elseif $student_user->hasBirthday()}{$student_user->getFormatter()->getBirthday()->getText()}{/if}">*}
                                            {if $form->hasErrors()}
                                                {html_options class="form-control AcademyStudentUser Select" name="birthday_day" style="display: inline-block;width: 32%;" options=$form->birthday_day->getChoices()->toArray() selected=$form.birthday_day}
                                                {html_options class="form-control AcademyStudentUser Select" name="birthday_month" style="display: inline-block;width: 32%;" options=$form->birthday_month->getChoices() selected=$form.birthday_month}
                                                {html_options class="form-control AcademyStudentUser Select" name="birthday_year" style="display: inline-block;width: 32%;" options=$form->birthday_year->getChoices()->toArray() selected=$form.birthday_year}
                                            {elseif $student_user->hasBirthDay()}    
                                                {html_options class="form-control AcademyStudentUser Select" name="birthday_day" style="display: inline-block;width: 32%;" options=$form->birthday_day->getChoices()->toArray() selected=$student_user->getFormatter()->getBirthday()->getDay()}
                                                {html_options class="form-control AcademyStudentUser Select" name="birthday_month" style="display: inline-block;width: 32%;" options=$form->birthday_month->getChoices() selected=$student_user->getFormatter()->getBirthday()->getMonth()}
                                                {html_options class="form-control AcademyStudentUser Select" name="birthday_year" style="display: inline-block;width: 32%;" options=$form->birthday_year->getChoices()->toArray() selected=$student_user->getFormatter()->getBirthday()->getYear()}                                     
                                            {else}    
                                                {html_options class="form-control AcademyStudentUser Select" name="birthday_day" style="display: inline-block;width: 32%;" options=$form->birthday_day->getChoices()->toArray()}
                                                {html_options class="form-control AcademyStudentUser Select" name="birthday_month" style="display: inline-block;width: 32%;" options=$form->birthday_month->getChoices()}
                                                {html_options class="form-control AcademyStudentUser Select" name="birthday_year" style="display: inline-block;width: 32%;" options=$form->birthday_year->getChoices()->toArray()}                                                                    
                                            {/if}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control AcademyStudentUser Fields Input" name="mobile" value="{$student_user->get('mobile')}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control AcademyStudentUser Fields Input" name="phone" value="{$student_user->get('phone')}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {if $form->hasValidator('email')}
                                        <input type="text" class="form-control AcademyStudentUser Fields Input" name="email" value="{$student_user->get('email')}">
                                    {else}
                                        <input type="text" class="form-control" readonly="" name="email" value="{$student_user->get('email')}">
                                    {/if} 
                                </div>
                            </div>
                        </div> 
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {*if $student_user->hasAvatar()}
                                    <div id="avatar-ctn">
                                    <img src="{$student_user->getAvatar()->getThumb()->getUrl()}"/>                                   
                                    <a href="#" id="AcademyStudentUserAvatar-Delete"><i class="fa fa-trash"></i></a>
                                    </div>
                                    {else}
                                        
                                    {/if}    
                                    <input type="file" class="form-control AcademyStudentUser files" name="MyProfile[avatar]"> *}
                                    <div class="form-group">            
                                        <div id="AvatarForm">                            
                                            <div class="custom-FileInput" id="DivLogo">
                                                {*<img id="blah" alt="" style="display: none;" /><br/>*}
                                                {if $student_user->hasAvatar()}
                                                    <img id="logo" alt="" src="{$student_user->getAvatar()->getThumb()->getUrl()}"{*/if*} /><br/>
                                                {else}
                                            ...
                                            <div class="row">
                                                <div class="">
                                                    ...
                                                    <input type='file' id="logoInp" hidden="" class="files" name="AcademyStudentUserCompletion[avatar]"/>
                                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="password" autocomplete="off" class="form-control AcademyStudentUser Fields Input" name="password">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="password" autocomplete="off" class="form-control AcademyStudentUser Fields Input" name="repassword">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control AcademyStudentUser Fields Input" name="address2" value="{$student_user->get('address2')}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-2">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <input type="text" class="form-control AcademyStudentUser Fields Input" name="postcode" value="{$student_user->get('postcode')}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control AcademyStudentUser Fields Input" name="city" value="{$student_user->get('city')}">
                                </div>
                            </div>
                        </div>   
                        <div class="col-md-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control AcademyStudentUser Fields Input" name="state" value="{$student_user->get('state')}">
                                </div>
                            </div>
                        </div>    
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    {select_country name="country" class="AcademyStudentUser js-example-responsive form-control Fields Select AcademyStudentUserSelect" preferred=['MA','FR'] options=$form->country->getOption('choices') selected=$student_user->get('country')}                               
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">   
    ...
    $(".AcademyStudentUserSelect").select2({
       width: 'resolve',
    });
    ...
    $(".ModeLogo").click(function(){
      ...
      $('#Save').click(function(){                             
          ...
          $(".AcademyStudentUser.Input").each(function() { params.MyProfile[$(this).attr('name')]=$(this).val(); });                                       
          $(".AcademyStudentUser.Select option:selected").each(function () { params.MyProfile[$(this).parent().attr('name')]=$(this).val(); });  
              
         //console.log(params);
          return $.ajax2({ data : params,   
                           files: ".files",
                           url: "{url_to('customers_academy_student_ajax',['action'=>'MyProfile'])}",
                           target: "#page-wrapper"}); 
        }); 
     
       $("#AcademyStudentUserAvatar-Delete").click(function () { 
       return $.ajax2({                        
                           url: "{url_to('customers_academy_student_ajax',['action'=>'DeleteAvatar'])}",
