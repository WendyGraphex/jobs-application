    ...
    $('.Input').keyup(function () { 
        $(".Input").removeClass('intro');
            ...
            function lockScreen()
            {
                ...
                $("#lockscreen-ctn").show();                
                return $.ajax2({                       
                       url :"{url_to('customers_academy_student_ajax',['action'=>'Lock'])}"                                                      
                });               
            }                        
            ...
            {                   
                   ...
                   $("#Unlock").click(function () { 
                        return $.ajax2({  
                               data : { CustomerAcademyStudentUserUnlock:  { password: $("#Password").val(), token:'{mfForm::getToken('CustomerAcademyStudentUserUnlockForm')}'} }, 
                               url :"{url_to('customers_academy_student_ajax',['action'=>'Unlock'])}",                                
