...
<script type="text/javascript">   
    ...
    $(".ModeLogo").click(function(){
      ...
      $('#Save').click(function(){                             
          var  params= { AcademyStudentUserCompletion: { token :'{$form->getCSRFToken()}'  } };                              
          $(".AcademyStudentUser.Input").each(function() { params.AcademyStudentUserCompletion[$(this).attr('name')]=$(this).val(); });                                       
          $(".AcademyStudentUser.Select option:selected").each(function () { params.AcademyStudentUserCompletion[$(this).parent().attr('name')]=$(this).val(); });  
              
         //console.log(params);
          return $.ajax2({ data : params,   
                           files: ".files",
                           url: "{url_to('customers_academy_student_ajax',['action'=>'SaveCompletion'])}",
                           target: "#page-wrapper"}); 
        }); 
