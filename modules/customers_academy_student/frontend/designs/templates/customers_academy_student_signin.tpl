...
<body class="signInBody" style="background-image: url('/web/files/pictures/sign4.jpg');background-repeat: no-repeat;background-size: cover;">
         ...
         {/if}
            ...
            <div id="actions" class="SignInDiv">
                ...
                <div class="text-center mt-4 font-weight-light">
                  ...
                  <a href="{link_i18n("customers_academy_student_login")}" class="text-primary">{__('Login')}</a>
                </div>                              
            </div>
            </div>
          </div>
    ...
    $('#defaultInline1').change(function() {
       ...
       $(function(){
            ...
            $("#Signup").click(function () {  
                ...
                var params = { Signup: { token : '{mfForm::getToken('CustomerAcademyStudentUserSigninForm')}' } };
                ...
                return $.ajax2({  data : params,                               
                                  url:"{url_to('customers_academy_student_ajax',['action'=>'Signin'])}", 
