...
class CustomerAcademyStudentUserForgotPasswordChangeForm extends mfForm {

    function configure() {       
        $this->setValidators(array(
            'password' => new mfValidatorString(),
            'repassword' => new mfValidatorString(),
            'key'=> new ObjectExistsValidator('CustomerAcademyStudentUserForgotPassword',array('key'=>false))
        ));        
