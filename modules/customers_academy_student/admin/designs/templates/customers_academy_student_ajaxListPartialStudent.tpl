    <div class="row admin-header-container">
            <div class="col-sm">
              ...
              <h3 class="admin-header-small-text">{__('Student Accounts')}</h3>
            </div>
          ...
          <div class="breadcrumb-title">
            <p>              
                ...
                <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('Student Accounts')}
            </p>
          </div>
          <!-- End breadcrumb -->
{alerts}
    ...
    {* =================================== METHODS ======================================================== *}
        ...
        {          
           return $.ajax2({ data: getFilterParameters(), 
                            url:"{url_to('customers_academy_student_ajax',['action'=>'ListPartialStudent'])}" ,                          
                            target: "#actions"
                             });
        }
...
{* =================================== PAGER/FILTER ======================================================== *}             
        ...
        $("#init").click(function() {                   
              return $.ajax2({ url:"{url_to('customers_academy_student_ajax',['action'=>'ListPartialStudent'])}",                                    
                         target: "#actions"}); 
        }); 
        ...
        $(".pager").click(function () {                     
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('customers_academy_student_ajax',['action'=>'ListPartialStudent'])}?page="+$(this).attr('data-page'),                                
                                 target: "#actions"
                });
        });
...
{* =================================== ACTIONS ======================================================== *}
        ...
        $(".View").click( function () {                    
                  return $.ajax2({ data : { CustomerAcademyStudentUser : $(this).attr('id') },                               
                                  url:"{url_to('customers_academy_student_ajax',['action'=>'ViewStudent'])}", 
                                  target: "#actions"});
        });
        $(".Display").click( function () {                    
                  return $.ajax2({ data : { CustomerAcademyStudentUser : $(this).attr('id') },                               
                                  url:"{url_to('customers_academy_student_ajax',['action'=>'DisplayStudent'])}", 
                                  target: "#actions"});
        });
    
        $("#New").click( function () {             
                return $.ajax2({                    
                    url: "{url_to('customers_academy_student_ajax',['action'=>'NewStudent'])}",               
                    target: "#actions"
              });
        });
        ...
        $(".ChangeIsActive").click(function () {
            return $.ajax2({
                ...
                url: "{url_to('customers_academy_student_ajax',['action'=>'ChangeIsActiveStudent'])}",              
        ...
        $(".ChangeIsValidated").click(function () {
            return $.ajax2({
                 data : { CustomerAcademyStudentUser : { id: $(this).attr('id') , value:$(this).attr('name'),token :'{mfForm::getToken('ChangeForm')}' } },                  
                url: "{url_to('customers_academy_student_ajax',['action'=>'ChangeIsValidatedStudent'])}",              
                success: function (resp) {
        ...
        $(".ChangeIsCompleted").click(function () {
            return $.ajax2({
                 data : { CustomerAcademyStudentUser : { id: $(this).attr('id') , value:$(this).attr('name'),token :'{mfForm::getToken('ChangeForm')}' } },                  
                url: "{url_to('customers_academy_student_ajax',['action'=>'ChangeIsCompletedStudent'])}",              
                success: function (resp) {
        ...
        $(".Delete").click( function () { 
                ...
                return $.ajax2({ data :{ CustomerAcademyStudentUser: $(this).attr('id') },
                                 url :"{url_to('customers_academy_student_ajax',['action'=>'DeleteStudent'])}",                               
                                 success : function(resp) {
