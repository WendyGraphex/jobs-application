     ...
     function getFilterParameters()
        ...
        {          
           return $.ajax2({ data: getFilterParameters(), 
                            url:"{url_to('customers_academy_student_ajax',['action'=>'ListPartialSession'])}" ,                                              
                            target: "#actions"
                             });
        }
        ...
        function updatePager(n)
        {
          ...
          {* =====================  P A G E R  A C T I O N S =============================== *}  
           ...
           $("#init").click(function() {                  
               $.ajax2({ url:"{url_to('customers_academy_student_ajax',['action'=>'ListPartialSession'])}",                                              
                         target: "#actions"}); 
           }); 
          ...
          $("[name=nbitemsbypage]").change(function() { return updateFilter(); }); 
           ...
           $(".pager").click(function () {                     
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('customers_academy_student_ajax',['action'=>'ListPartialSession'])}?page="+$(this).attr('data-page'),   
                                 target: "#actions"
                });
        });
        ...
        $("#New").click( function () {             
            return $.ajax2({      
                ...
                url: "{url_to('customers_academy_student_ajax',['action'=>'NewSession'])}",               
                target: "#actions"
          });
        });
