...
class CustomerAcademyStudentUserSessionFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerAcademyStudentUserSession');
       $this->setFields(array(
          
           
             'email'=>array(
                        'class'=>'CustomerAcademyStudentUserSession',
                        'search'=>array('conditions'=>CustomerAcademyStudentUserSession::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{email}%%' ")
                        ), 
           'ip'=>array(
                        'class'=>'CustomerAcademyStudentUserSession',
                        'search'=>array('conditions'=>CustomerAcademyStudentUserSession::getTableField('ip')." COLLATE UTF8_GENERAL_CI LIKE '%%{ip}%%' ")
                        ),  
               ));      
       $this->setQuery("SELECT {fields} FROM ".CustomerAcademyStudentUserSession::getTable().    
                      " INNER JOIN ".CustomerAcademyStudentUserSession::getOuterForJoin('user_id').
                       ";");
       // Validators 
       $this->setValidators(array( 
            ...
            'equal' => new mfValidatorSchema(array(   
                          ...
                          //  "customer_id"=>new mfValidatorChoice(array("choices"=>array(""=>"")+ProductFavoriteUtils::getCustomerAcademyStudentUserFieldValuesForSelect($this->getSite()),"key"=>true,"required"=>false)),
                            ),array("required"=>false)),                                         
