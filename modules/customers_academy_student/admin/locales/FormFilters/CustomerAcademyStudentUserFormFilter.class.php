...
class CustomerAcademyStudentUserFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerAcademyStudentUser');
       
       $this->setFields(array(
          
              'lastName'=>array(
              'class'=>'CustomerAcademyStudentUser',
              'search'=>array('conditions'=>
                                                 "(".
             CustomerAcademyStudentUser::getTableField('username')." COLLATE UTF8_GENERAL_CI LIKE '%%{lastname}%%' OR ".
             CustomerAcademyStudentUser::getTableField('lastname')." COLLATE UTF8_GENERAL_CI LIKE '%%{lastname}%%' OR ".
             CustomerAcademyStudentUser::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{lastname}%%' OR ".
             CustomerAcademyStudentUser::getTableField('firstname')." COLLATE UTF8_GENERAL_CI LIKE '%%{firstname}%%'".
                                                 ")")
                                ),               
           ));
       $this->setQuery("SELECT {fields} FROM ".CustomerAcademyStudentUser::getTable().                            
                       ";"); 
       // Validators
