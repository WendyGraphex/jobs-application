...
--
-- Structure de la table `t_customer_academy_student_session`
--
...
--
-- Contraintes pour la table `t_customer_academy_student_session`
--
ALTER TABLE `t_customer_academy_student_user_session`   ADD CONSTRAINT `customer_academy_student_user_session_fk0` FOREIGN KEY (`user_id`) REFERENCES `t_customer_academy_student_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Contraintes pour la table `t_customer_academy_student_remember`
--
ALTER TABLE `t_customer_academy_student_user_remember`  ADD CONSTRAINT `customer_academy_student_user_remember_fk0` FOREIGN KEY (`user_id`) REFERENCES `t_customer_academy_student_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `t_customer_academy_student_user_forgot_password`  ADD CONSTRAINT `customer_academy_student_user_forgot_password_fk0` FOREIGN KEY (`user_id`) REFERENCES `t_customer_academy_student_user` (`id`) ON DELETE CASCADE;


--
-- Contraintes pour la table `t_customer_academy_student_user_validation_token`
--
...
--
-- Contraintes pour la table `t_customer_academy_student_validation_token`
--
ALTER TABLE `t_customer_academy_student_user_validation_token` ADD CONSTRAINT `customer_academy_student_user_validation_token_fk0` FOREIGN KEY (`user_id`) REFERENCES `t_customer_academy_student_user` (`id`) ON DELETE CASCADE;
