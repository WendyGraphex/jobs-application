...
class CustomerAcademyStudentUserValidationTokenBase extends mfObject3 {
    ...
    const table="t_customer_academy_student_user_validation_token";
    ...
    {
        return array('url'=>link_i18n('customer_academy_student_user_validate_email',array(),null,'frontend')."?token=".$this->get('token')."&email=".$this->getUser()->get('email'));
    }
