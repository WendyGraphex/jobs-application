...
class CustomerAcademyStudentUserBase extends mfObject3 {
    ...
    const table="t_customer_academy_student_user"; 
   ...
   {
       return $this->formatter=$this->formatter===null?new CustomerAcademyStudentUserFormatter($this):$this->formatter;
   }
    ...
    {               
         if ($this->isNotLoaded())
            return null;
        $session=new CustomerAcademyStudentUserSession($session_id);
    ...
    function updateRememberMe($ip)
    {
        ...
        CustomerAcademyStudentUserRemember::cleanup(date('Y-m-d H:i:s', time() - $this->getExpirationAge()), $this);       
        $remember=new CustomerAcademyStudentUserRemember();
    ...
    {
        return CustomerAcademyStudentUserRemember::getCookieName();
    }
    ...
    {        
     ...
     function getAvatar()
    {    
        return $this->_avatar=$this->_avatar===null?new CustomerAcademyStudentUserAvatarFrame($this):$this->_avatar;   
    }
