...
class employers_comment_ajaxPublishCommentAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {      
      ...
      {         
          ...
          $id=$item->isValid($request->getPostParameter('EmployerComment'));          
          $item= new EmployerAdvertComment($id);           
          $item->publish();              
