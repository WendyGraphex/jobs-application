    ...
    {  
       ...
       $this->setValidators(array( 
        ...
        $this->setQuery(mfQuery::getInstance()->select("{fields}")
                    ...
                    ->where(
                            EmployerAdvertComment::getTableField('is_active')."='YES' AND ".
                            EmployerAdvertComment::getTableField('employer_advert_id')."='{advert_id}' AND ".
                            EmployerAdvertComment::getTableField('employer_advert_lang')."='{advert_lang}'"));    
    }
