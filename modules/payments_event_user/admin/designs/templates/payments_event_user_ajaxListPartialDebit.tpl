          ...
          <div class="breadcrumb-title">
            <p>              
                ...
                <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('Event Users')}
            </p>
          </div>
          <!-- End breadcrumb -->
{alerts}
     ...
     function getFilterParameters()
        ...
        {                      
           return $.ajax2({ data: getFilterParameters(), 
                            url:"{url_to('payments_event_user_ajax',['action'=>'ListPartialDebit'])}" ,                          
                            target: "#actions"
                             });
        }
        ...
        $(".pager").click(function () {                     
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('payments_event_user_ajax',['action'=>'ListPartialDebit'])}?page="+$(this).attr('data-page'),                                
                                 target: "#actions"
                });
        });
             
           $("#init").click(function() {                   
              return $.ajax2({ url:"{url_to('payments_event_user_ajax',['action'=>'ListPartialDebit'])}",                                    
                         target: "#actions"}); 
           }); 
        ...
        $("#filter").click(function() { return updateFilter(); });                                   
         ...
         $(".Validate").click(function() {                   
              return $.ajax2({ data : { PaymentDebitEventUser: $(this).attr('id') },
                               url:"{url_to('payments_event_user_ajax',['action'=>'ValidatePayment'])}",                                    
