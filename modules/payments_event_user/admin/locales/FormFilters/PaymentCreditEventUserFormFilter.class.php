...
class PaymentCreditEventUserFormFilter extends mfFormFilterBase{
    ...
    {                    
       ...
       $this->setClass('PaymentCreditEventUser');
       $this->setFields(array());
       $this->setQuery("SELECT {fields} FROM ". PaymentCreditEventUser::getTable().      
                       " INNER JOIN ".PaymentCreditEventUser::getOuterForJoin('event_user_id').
                       " INNER JOIN ".PaymentCreditEventUser::getOuterForJoin('order_id').
                       " INNER JOIN ".PaymentCreditEventUser::getOuterForJoin('method_id').
                       ";"); 
       // Validators 
