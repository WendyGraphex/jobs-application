...
class PaymentCreditEventUserMethodFormFilter extends mfFormFilterBase{
    ...
    {                    
       ...
       $this->setClass('PaymentMethod');
       $this->setFields(array());
       $this->setQuery("SELECT {fields} FROM ". PaymentCreditEventUserMethod::getTable().  
