...
class PartnerWorkCategoryCore extends TreeNode {
    
      protected static $fields=array('name','picture','icon','number_of_works','number_of_jobs','rb','lb','level','is_active','state','created_at','updated_at');   
    const table="t_partner_work_category";    
    protected static $fieldsNull=array('state');  
    
    static function root()
    {        
         return  new PartnerWorkCategory('root');         
    }      
