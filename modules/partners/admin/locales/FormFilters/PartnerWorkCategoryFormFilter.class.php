...
class PartnerWorkCategoryFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setFields(array(          
              ...
              'search'=>array('conditions'=>
                                                 "(".
               PartnerWorkCategory::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%'".
                                                 ")")
                                ),
           'title'=>array(
              ...
              'search'=>array('conditions'=>
                                                 "(".
               PartnerWorkCategoryI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%'".
                                                 ")")
                                ),  
           ));
       $this->setQuery("SELECT {fields} FROM ".PartnerWorkCategory::getTable(). 
                       ...
                       " WHERE level={levelplusone} AND  lb >= {lb} AND rb <= {rb} ".
                            // " AND state IS NULL ".
                       " ORDER BY ".PartnerWorkCategory::getTableField('rb')." ASC".
                       ";");        
