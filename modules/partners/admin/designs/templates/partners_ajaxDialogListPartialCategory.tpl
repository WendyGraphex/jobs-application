...
<div class="bg-white px-2 py-2">   
    <div class="row">    
     ...
     {/if}
      ...
      <table id="DialogPartnerWorkCategoryList" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer w-100 list-user"  role="grid" aria-describedby="Myliste_info">
      <thead  class="bgSpec">
        <tr role="row">
            <th>#</th>                                       
...
<script type="text/javascript">
    ...
    $("#DialogPartnerWorkCategoryList").data('selected',{$form->getSelected()});
     ...
     function getDialogFilterParameters()
        {
            var params={ PartnerWorkCategoryNode : { node: '{$node->get('id')}', 
                                             ...
                                             selected:  $("#DialogPartnerWorkCategoryList").data('selected'),
        ...
        $(".dialog-pager").click(function () {                     
                return $.ajax2({ data: getDialogFilterParameters(), 
                                 url:"{url_to('partners_ajax',['action'=>'DialogListPartialCategory'])}?page="+$(this).attr('data-page'),                                
                                 target: "#PartnerWorkCategoryListDialog-ctn"
                });
        });
        ...
        $(".dialog-list").click(function() { 
             $("#DialogPartnerWorkCategoryList").data('selected',$(this).attr('id'));
             $(".dialog-list").removeClass('Selected');
             $(this).addClass('Selected');
        });
        
         $(".dialog-categories,.dialog-PartnerWorkCategory-item").click( function () {                    
