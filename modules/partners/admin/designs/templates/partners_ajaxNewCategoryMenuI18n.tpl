...
<div class="row admin-header-container">
    <div class="col-sm">
        ...
        <h3 class="admin-header-small-text">{__("Work CategoryMenu menu Management")}</h3>
    </div>
...
<div class="breadcrumb-title">
    <p>
        ...
        <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('Work CategoryMenu menu')}
        <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('New CategoryMenu menu')}
    </p>
</div>
          ...
          <div class="tab-pane fade show active" id="referencement" role="tabpanel" aria-labelledby="referencement-tab">
                <div class="row">                                                                              
                    <div class="form-group col-md-12">
                      ...
                      <div class="field_with_errors"><input class="PartnerWorkCategoryMenuI18n form-control Fields Input" type="text" value="{$item_i18n->get('title')}" name="title"></div>
                    </div>
                </div>                              
          </div>  
...
<script type="text/javascript">  
    ...
    $(".deleteCategory").click(function () { 
       ...
       $("#DialogPartnerWorks").click(function () { 
             return $.ajax2({      
                         data : { PartnerWorkCategoryMenu : { lang: $("#SelectListLanguages option:selected").attr('id'), 
                                            selection : $("#CategoryMenuPartnerWorks").data('selection'), 
                                            token : '{mfForm::getToken('DialogPartnerWorkFormFilter')}' } },
                         url:"{url_to('partners_ajax',['action'=>'ListPartialDialogPartnerWorkForCategoryMenu'])}",                                              
     ...
     $(".PartnerWorkCategoryMenuI18n.Input[name=title]").keyup(function () { 
         $(".PartnerWorkCategoryMenuI18n.Input[name=url]").val("{$node->getUrlPathI18n()}"+$(this).val().cleanup());
     });
     {* =================== A C T I O N S ================================ *}
     $('#Cancel').click(function() {                
      ...
      $('#Save').click(function() {
            var  params= {      PartnerWorkCategoryMenu: '{$node->get('id')}',
        ...
        //      alert("Params="+params.toSource());   return ;      
          return $.ajax2({ data : params,                           
                           url: "{url_to('partners_ajax',['action'=>'SaveNewCategoryMenuI18n'])}",
                           target: "#actions"}); 
        });  
