...
class SaleEmployeeCommissionFormFilter extends mfFormFilterBase{
    ...
    {                    
       ...
       $this->setClass('SaleEmployeeCommission');
       $this->setFields(array());
       $this->setQuery("SELECT {fields} FROM ". SaleEmployeeCommission::getTable().                                            
                       ";"); 
       // Validators 
