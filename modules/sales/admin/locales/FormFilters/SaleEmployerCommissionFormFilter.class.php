...
class SaleEmployerCommissionFormFilter extends mfFormFilterBase{
    ...
    {                    
       ...
       $this->setClass('SaleEmployerCommission');
       $this->setFields(array());
       $this->setQuery("SELECT {fields} FROM ". SaleEmployerCommission::getTable().                                            
                       ";"); 
       // Validators 
