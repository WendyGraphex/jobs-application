<div class="row admin-header-container">
    <div class="col-sm">
      ...
      <h3 class="admin-header-small-text">{__('Sale Freelancer commissions')}</h3>
    </div>
...
<div class="breadcrumb-title">
    <p>                
        ...
        <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('Sale Freelancer Commissions')}
...
<div class="tablewhiteback" style="padding: 20px;">    
     <div class="the-box bg-white p-3">    
         <div class="row">                      
            ...
            <div class="field_with_errors"><input class="SaleEmployeeCommission form-control Fields Input" type="text" value="{$item->get('name')}" name="name" id="name"></div>
          </div>  
        </div>  
           <div class="row">                      
            ...
            <div class="field_with_errors"><input class="SaleEmployeeCommission form-control Fields Input Date" type="text" value="{$item->get('started_at')}" name="started_at" id="started_at"></div>
          </div> 
            <div class="form-group col-md-6">
            ...
            <div class="field_with_errors"><input class="SaleEmployeeCommission form-control Fields Input Date" type="text" value="{$item->get('expired_at')}" name="expired_at" id="expired_at"></div>
          </div> 
        </div>  
    </div>          
</div>
<script type="text/javascript">              
     ...
     $(".SaleEmployeeCommission").click(function() {  $('#Save').show(); });  
     ...
     $('#Save').click(function(){                             
            var  params= {     SaleEmployeeCommission: {    
                                   id : '{$item->get('id')}',
                                   token :'{$form->getCSRFToken()}'
                                } };
          $(".SaleEmployeeCommission.Input").each(function() { params.SaleEmployeeCommission[$(this).attr('name')]=$(this).val(); });        
        //      alert("Params="+params.toSource());   return ;      
          return $.ajax2({ data : params,                             
                           url: "{url_to('sales_ajax',['action'=>'SaveEmployeeCommission'])}",
                           target: "#actions"}); 
     });                          
</script>
{else}
