...
class SaleEmployerCommissionRateBase extends mfObject3 {
     
    protected static $fields=array('commission_id','from','to','fix','rate','start_at','expired_at','is_active','created_at','updated_at');
    const table="t_sale_employer_commission_rate";
    protected static $foreignKeys=array('commission_id'=>'SaleEmployerCommission'); // By default
    ...
    {
       return $this->_commission_id=$this->_commission_id===null?new SaleEmployerCommission($this->get('commission_id')):$this->_commission_id;                 
    }   
    
           function getFormatter()
   {
       return $this->formatter=$this->formatter===null?new SaleEmployerCommissionRateFormatter($this):$this->formatter;
   }
