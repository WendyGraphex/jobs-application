...
class CustomerEmployeeMessageFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('CustomerEmployeeMessage');
       
       $this->setFields(array(
           
       ));
       $this->setQuery("SELECT {fields} FROM ". CustomerEmployeeMessage::getTable().  
                       ...
                       " WHERE ".CustomerEmployeeMessage::getTableField('employee_user_id')."='{employee_user_id}' ".
                                    " AND ".CustomerEmployeeMessage::getTableField('state')."='SENT' AND deleted_at IS NULL AND employee_deleted_at IS NULL".  
                       ";"); 
       // Validators 
       $this->setValidators(array( 
            ...
            'order' => new mfValidatorSchema(array(                                                        
                        ...
                        "read_at"=>new mfValidatorChoice(array("choices"=>array("asc","desc"),"required"=>false)),
