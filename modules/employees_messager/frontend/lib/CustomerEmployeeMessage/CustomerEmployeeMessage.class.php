            ...
            $db=mfSiteDatabase::getInstance()
                ...
                ->setQuery("SELECT {fields} FROM ".CustomerEmployeeMessage::getTable().    
                           ...
                           " WHERE ".CustomerEmployeeMessage::getTableField('employee_user_id')."='{employee_user_id}' AND sender !='EMPLOYEE'". 
                                " AND ".CustomerEmployeeMessage::getTableField('state')."='SENT' ".
                                " AND ".CustomerEmployeeMessage::getTableField('deleted_at')." IS NULL ".
                                " AND employee_deleted_at IS NULL ".
                                " AND ".CustomerEmployeeMessage::getTableField('read_at')." IS NULL ".  
