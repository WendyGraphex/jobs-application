<div class="row admin-header-container">
  <div class="col-sm">
       ...
       <h3 class="admin-header-small-text">{__('New currency')}</h3>
    </div>
...
<div class="breadcrumb-title">
    <p>
        ...
        <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('New currency')}
    </p>
</div>
{alerts}
     ...
     <div class="the-box bg-white p-3">          
         <div class="row">          
           <div class="form-group col-md-6">             
            ...
            <div class="field_with_errors">
                {* <input class="SiteCurrency form-control Fields Input" type="text" value="{$item->get('code')}" name="code" id="code"> *}
...
<script type="text/javascript">
     ...
     $(".SiteCurrency").click(function() { $("#Save").show(); });
      
     $('#Cancel').click(function(){                                          
          return $.ajax2({  url: "{url_to('site_currency_ajax',['action'=>'ListPartialCurrency'])}",
                           target: "#actions"}); 
     }); 
