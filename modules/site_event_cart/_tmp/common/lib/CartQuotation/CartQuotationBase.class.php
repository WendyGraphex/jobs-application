...
class CartQuotationBase extends mfObject3 {
     
    protected static $fields=array('signature','cart_id','quotation_id','tax_id',
   ...
   protected static $fieldsNull=array('in_at','out_at','tax_id'); // By default
    ...
    {
        return $this->formatter=$this->formatter===null?new CartQuotationFormatter($this):$this->formatter;
    }
    ...
    function delete()
    {
        ...
        $this->getCart()->getCartQuotations()->deleteQuotation($this);    
