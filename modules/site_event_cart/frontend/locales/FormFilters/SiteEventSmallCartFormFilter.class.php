...
class SiteEventSmallCartFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('SiteEventCartEvent');
       
       $this->setFields(array(
          
         
           ));
       $this->setQuery("SELECT {fields} FROM ".SiteEventCartEvent::getTable(). 
                    ...
                    //   " LEFT JOIN ".EmployeeAdvertI18n::getInnerForJoin('advert_id')." AND ". EmployeeAdvertI18n::getTableField('lang')."=".SaleEmployeeQuotation::getTableField('employee_advert_lang').                                        
                       " WHERE cart_id='{cart_id}' ".
                            " AND ".SiteEventCartEvent::getTableField('status')."='ACTIVE'".
                       ";"); 
       // Validators 
