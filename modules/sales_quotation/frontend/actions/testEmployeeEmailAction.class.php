...
// www.project55.net/quotations/employee/test/Email?quotation=27&type=Refused
/*
 * Proposed ok
 * Accepted ok
 * Refused  ok
 ...
 * 
 */
class sales_quotation_testEmployeeEmailAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {   
      ...
      if ($sale_quotation->isNotLoaded())     
          die("INVALID");      
      $engine = new EmployeeSaleQuotationEmailEngine($sale_quotation);
