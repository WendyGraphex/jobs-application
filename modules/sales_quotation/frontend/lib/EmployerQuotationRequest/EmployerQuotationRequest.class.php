...
class EmployerQuotationRequest extends EmployerQuotationRequestBase {
    ...
    function __construct($parameters = null,$user=null) {      
        ...
        {                                
             $this->getDefaults();
             return $this->add(array('advert_id'=>$parameters->get('advert_id'),
                                     'employee_user_id'=>$parameters->getAdvert()->get('employee_user_id'),
