...
class SaleEmployerQuotationRequestForEmployeeFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setFields(array(
         ...
         $this->setQuery("SELECT {fields} FROM ".EmployerQuotationRequest::getTable().  
                        " LEFT JOIN ".EmployerQuotationRequest::getOuterForJoin('quotation_id').
                       " INNER JOIN ".EmployerQuotationRequest::getOuterForJoin('employer_user_id').
                       " INNER JOIN ".EmployerQuotationRequest::getOuterForJoin('advert_id').                     
                       " INNER JOIN ".EmployeeAdvertI18n::getInnerForJoin('advert_id')." AND ".EmployerQuotationRequest::getTableField('lang')."=".EmployeeAdvertI18n::getTableField('lang').
                       " WHERE ".EmployerQuotationRequest::getTableField('employee_user_id')."='{employee_user_id}' ".
                       ";");  
       // Validators 
