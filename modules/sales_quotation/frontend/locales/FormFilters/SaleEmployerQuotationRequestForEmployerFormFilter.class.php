...
class SaleEmployerQuotationRequestForEmployerFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setQuery("SELECT {fields} FROM ".EmployerQuotationRequest::getTable().  
                     ...
                     // " LEFT JOIN ".EmployerQuotationProjectRequest::getOuterForJoin('quotation_id').
                       " WHERE ".EmployerQuotationRequest::getTableField('employer_user_id')."='{employer_user_id}' ".
                       ";"); 
       // Validators 
