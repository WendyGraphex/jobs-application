...
class SaleEmployerQuotationRequestForEmployeePager extends Pager {
    
    function __construct() {             
        parent::__construct(array("EmployerQuotationRequest","EmployerUser","EmployeeAdvert","EmployeeAdvertI18n","SaleEmployeeQuotation"));                
    }
