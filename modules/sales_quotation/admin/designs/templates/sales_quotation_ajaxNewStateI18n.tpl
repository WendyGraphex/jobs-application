        ...
        <div class="row">          
            <div class="form-group col-md-6">             
             ...
             <div class="field_with_errors">
                <input class="BillingState form-control Fields Input" type="text" value="{$item_i18n->getState()->get('name')}" name="name" id="name">
             </div>
          </div>   
            <div class="form-group col-md-6">
            ...
            <div class="field_with_errors"><input class="BillingStateI18n form-control Fields Input" type="text" value="{$item_i18n->get('title')}" name="title" id="title"></div>
          </div>  
        </div>
             <div class="row">   
            <div class="form-group col-md-6">
            ...
            <input class="BillingState form-control Fields Input Color General input-color" type="text" value="{$item_i18n->getState()->get('color')}" name="color" id="color"/>
          </div> 
...
<script type="text/javascript">              
   $(".Color").minicolors({
     ...
     $('#Cancel').click(function(){                
             return $.ajax2({ data: { filter: { lang:$("#SelectListLanguages option:selected").attr('id'), token: "{mfForm::getToken('BillingStateFormFilter')}" } },                              
      ...
      $('#Save').click(function(){                             
        ...
        //      alert("Params="+params.toSource());   return ;      
          return $.ajax2({ data : params,  
                           files :'.Files',
                           url: "{url_to('sales_quotation_ajax',['action'=>'SaveNewStateI18n'])}",
                           target: "#actions"}); 
        });                          
