...
class SaleQuotationStateFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('SaleQuotationState');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'SaleQuotationStateI18n',
                        'search'=>array('conditions'=>SaleQuotationStateI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'SaleQuotationState',
                        'search'=>array('conditions'=>SaleQuotationState::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".SaleQuotationState::getTable().                      
                       " LEFT JOIN ".SaleQuotationStateI18n::getInnerForJoin('state_id'). " AND ".SaleQuotationStateI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
