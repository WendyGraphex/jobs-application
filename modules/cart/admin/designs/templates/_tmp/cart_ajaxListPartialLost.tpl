          ...
          <div class="breadcrumb-title">
            <p>
                ...
                <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('Lost Carts')}                
            </p>
          </div>
          <!-- End breadcrumb -->
{alerts}
    ...
    <div class="row float-left mt-2 w-100 padd-row">
      ...
      <tbody>
          <tr role="row">
              ...
              <td>
                  {html_options class="equal form-control-sm float-left w-100 Select" name="status" options=$formFilter->equal.status->getChoices() selected=$formFilter.equal.status}
              </td> 
                <td></td> 
          </tr>
      ...
      <tr class="list" id="{$item->get('id')}" role="row">
          ...
          <td>
               <a href="#" class="list-action text-danger Delete" id="{$item->get('id')}" name="{$item->getReference()}" title="{__('Delete')}"><i class="fa fa-trash-alt font-icon"></i></a>            
          </td>
        </tr>
        {/foreach}
         {if !$pager->hasItems()}
