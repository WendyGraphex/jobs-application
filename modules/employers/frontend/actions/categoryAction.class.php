<?php
 ...
 // www.project55.net/employer/category/toto

class employers_categoryAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {   
      $messages = mfMessages::getInstance();   
        $this->node_i18n=new EmployerWorkCategoryI18n(array('url'=>new mfString($request->getRequestParameter('url')),'lang'=>$this->getUser()->getLanguage()));                     
      ...
      //  $this->getViewManager()->getLayoutManager(array("template"=>"/products/city_".$this->page->get('layout')))->compile();
        $this->getViewManager()->setTemplate("./employers_category_".$this->node_i18n->getCategory()->get('template','default.tpl'));       
