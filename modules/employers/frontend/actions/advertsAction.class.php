...
// www.project55.net/employer/adverts
...
class employers_advertsAction extends mfAction {
        ...
        try
        {
               ...
               {    
                 ...
                 //  echo $this->formFilter['nbitemsbypage'];
                   ...
                   // $this->pager->setParameter('user',$this->getUser()->isAuthenticated()?$this->getUser()->getGuardUser():null);
