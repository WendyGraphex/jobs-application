...
<script type="text/javascript">
     ...
     function getDialogFilterParameters()
        {
            var params={ EmployerCategory : { node: '{$node->get('id')}',                                           
        ...
        $(".dialog-pager").click(function () {                     
                return $.ajax2({ data: getDialogFilterParameters(), 
                                 url:"{url_to('employers_ajax',['action'=>'ListPartialDialogCategoryForMyProfile'])}?page="+$(this).attr('data-page'),                                
                                 target: "#Modal-Categories-ctn"
                });
        });
          
        $("#dialog-init").click(function () {                     
                return $.ajax2({ data : { EmployerCategory : {                                              
                                              token : '{$formFilter->getCSRFToken()}' ,
                                              selection : $("#DialogCategoryList").data('selection')
                                         } },
                                 url:"{url_to('employers_ajax',['action'=>'ListPartialDialogCategoryForMyProfile'])}",
