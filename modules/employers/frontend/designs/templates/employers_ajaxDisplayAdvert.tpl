      ...
      <div class="d-flex justify-content-between flex-wrap">
        <div class="d-flex align-items-end flex-wrap">
          ...
          <div class="d-flex">
            ...
            <p class="text-muted mb-0">&nbsp;/&nbsp;{__('Display job')}</p>
          </div>
        </div>      
      </div>
          {component name="/site_help/help" help="employer-display-advert"}
    </div>
</div>
{alerts}
    ...
    <div class="card classMargin">
        <div class="card-body">             
            ...
            <div class="tab-content">                
                ...
                {* ==================================== CATEGORIES  ====================================*}
                <div class="tab-pane fade show" id="categories" role="tabpanel" aria-labelledby="categories-tab" style="padding-top: 20px;">  
                     
                       {foreach $advert->getAdvertCategories()->getCategories() as $category} 
                            <div style="display: inline-block;">                                              
                                 <div class="btn btn-outline-primary EmployerAdvertCategories">
