    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper" id="page-wrapper">  
           {if $user->getGuardUser()->isProfessional()}
          {*  Configured:{if $user->getGuardUser()->getCompany()->isConfigured()}Y{else}N{/if}
            Completed:{if $user->getGuardUser()->getCompany()->isCompleted()}Y{else}N{/if} *}
           {if $user->getGuardUser()->getCompany()->isCompleted() && $user->getGuardUser()->getCompany()->getNumberOfAdverts()}
            {component name="/employers/dashboard"}         
            {component name="/employers/messages"}                       
            {component name="/employers_statistic/dashboard"}                    
            {component name="/employers_statistic/charts"}       
            {component name="/sales_quotations/dashboardForEmployer"}  
          {elseif $user->getGuardUser()->getCompany()->isCompleted() && !$user->getGuardUser()->getCompany()->getNumberOfAdverts()}             
              {component name="/employers/MyFirstAdvert"}          
          {else}    
               {component name="/employers/completion"}  
          {/if}  
         {else}
             {if $user->getGuardUser()->isCompleted() && $user->getGuardUser()->getCompany()->getNumberOfAdverts()}
            {component name="/employers/dashboard"}         
            {component name="/employers/messages"}                       
            {component name="/employers_statistic/dashboard"}                    
            {component name="/employers_statistic/charts"}       
