            ...
            <div class="col-md-4 ftco-animate">
                    ...
                    <div class="profile-card-onProfile">
                        ...
                        <div class="user-information-onProfile">
                            ...
                            <div class="info-onProfile">
                                <p class="TitleUserAds-onProfile">Function</p>
                            ...
                            <label>
                                <a href="#" class="SendMessage btn btn-success">Contact me</a>
                                <a href="#" class="EmployeeAdvertMakeOffer btn btn-primary">Make an offer</a>
                            </label>
                        </div>
                    </div>
                ...
                <div class="description-onProfile">
                    ...
                    <div class="languages-onProfile">
                        <strong>English</strong><span> -- good</span>
                    </div>
