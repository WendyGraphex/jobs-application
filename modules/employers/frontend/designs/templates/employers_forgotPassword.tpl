            ...
            <div id="actions" class="actionsPaddingTop">
              <h4>{__("Forgot your password?")}</h4>
                <div class="form-group">
                  ...
                  <input type="text" name="email" class="EmployerForgotPassword Fields Input form-control form-control-lg" placeholder="{__('Email')}">
                </div>
                </div>
                <div class="mt-3">
    ...
    $('#Send').click(function(){                             
            var  params= {           
                    EmployerForgotPassword: {   
                       email : $(".EmployerForgotPassword[name=email]").val(),
                       token :'{mfForm::getToken('EmployerForgotPasswordForm')}'
                    } };                             
            return $.ajax2({ data : params,                          
                url: "{url_to('employers_ajax',['action'=>'ForgotPassword'])}",
