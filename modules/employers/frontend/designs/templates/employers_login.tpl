                            ...
                            <div class="auth-form-transparent text-left p-3">
                                ...
                                <form class="pt-3" id="f_authent" action="" method="post">
                                    ...
                                    <div class="my-2 d-flex justify-content-between align-items-center">                    
                                        ...
                                        <a href="{link_i18n('employers_forgot_password')}" class="auth-link text-black textSize" style="font-size: 16px;">{__('Forgot password?')}</a>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 classPaddingBottom" style="padding-right: 5px;">
                                            {component name="/facebook_oauth/oauthBtnEmployer"} 
                                        </div>
                                        <div class="col-md-6" style="padding-left: 5px;">
                                            {component name="/google_oauth/oauthBtnEmployer"}  
                                        </div>
                                    </div>
                                    <div class="row" style="padding-top: 10px;">
                                        <div class="col-md-6 classPaddingBottom" style="padding-right: 5px;">
                                            {component name="/instagram_oauth/oauthBtnEmployer"}  
                                             
                                        </div>
                                        <div class="col-md-6" style="padding-left: 5px;">
                                            {component name="/linkedin_oauth/oauthBtnEmployer"} 
                                        </div>
                                    </div>
                                    <div class="text-center mt-4 font-weight-light">
                                        {__("Don't have an account?")} <a href="{link_i18n('employers_signin')}" class="text-primary">{__('Create')}</a>
                                    </div>
                                    <input type="hidden" name="Login[token]"  value="{$form->getCSRFToken()}" /> 
                                </form>
                            </div>
                        </div>
                        <div class="col-lg-6 login-half-bg" style="background-color: rgb(25, 46, 91);padding-left: 0px !important;padding-right: 0px !important;">
                            ...
                            <div class="divImageLogin">
                                <img src="/web/pictures/login-employer.jpg" style="width: 100%;"/>
                            </div>
                            <div>
