      ...
      <div class="d-flex justify-content-between flex-wrap">
        <div class="d-flex align-items-end flex-wrap">
          ...
          <div class="d-flex">
            ...
            <p class="text-muted mb-0">&nbsp;/&nbsp;{__('New user')}</p>
          </div>
        </div>      
      </div>
          {component name="/site_help/help" help="employer-new-user"}
    </div>
</div>
{alerts}
               ...
               {* ==================================== PERSONAL  ====================================*}
                <div class="tab-pane fade show" id="personal" role="tabpanel" aria-labelledby="personals-tab">                                   
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-2 col-form-label">{__('Email')}{if $form->email->getOption('required')}*{/if}</label>
                          <div class="col-sm-10">
                                ...
                                <div style="position: relative;">
                                    ...
                                    <i class="mdi mdi-checkbox-marked-circle respPosition correctFormEmail" aria-hidden="true" style="color: green;display: {if !$form.email->hasError() && $form.email->getValue()}block;{else}none;{/if}"></i>
                                    <i class="mdi mdi-close-circle respPosition inCorrectFormEmail" aria-hidden="true" style="color: red;display: {if $form.email->hasError() && $form.email->getValue()}block;{else}none;{/if}"></i>
                                </div>
                          </div>
                        </div>
                      </div>                                         
    ...
    $(".ModelAvatar").click(function(){
     ...
     $('#Save').click(function(){                             
          ...
          return $.ajax2({ data : params,    
                           files: ".files",
                           url: "{url_to('employers_ajax',['action'=>'NewUser'])}",
                           target: "#actions"}); 
        }); 
