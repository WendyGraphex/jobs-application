            ...
            <div class="row w-100">
                <div class="col-lg-4 mx-auto">
                  ...
                  {*  <div class="social-email">
                        <a href=""><img src="/web/pictures/facebook.png"></a>
                        <a href=""><img src="/web/pictures/twitter.png"></a>
                        <a href=""><img src="/web/pictures/instagram.png"></a>
                        <a href=""><img src="/web/pictures/linkedin.png"></a>
                        <a href=""><img src="/web/pictures/youtube.png"></a>
                    </div> *}
                </div>
            </div>
        </div>
    ...
    $("#Password").click(function() { 
        ...
        $("#error-text").html("&nbsp;");
            ...
            function lockScreen()
            {
                ...
                $("#lockscreen-ctn").show();                
                return $.ajax2({                       
                       url :"{url_to('employers_ajax',['action'=>'Lock'])}"                                                      
                });               
            }                        
            ...
            {                   
                   ...
                   $("#Unlock").click(function () { 
                        $("#error-text").hide();
                        return $.ajax2({  
                               data : { EmployerUserUnlock:  { password: $("#Password").val(), token:'{mfForm::getToken('EmployerUserUnlockForm')}'} }, 
                               url :"{url_to('employers_ajax',['action'=>'Unlock'])}",    
                                 error: function (xhr, ajaxOptions, thrownError) {                                   
                                     if (xhr.status == 401) 
                                       window.location.href =  "{link_i18n('employers_login')}";
                                },
