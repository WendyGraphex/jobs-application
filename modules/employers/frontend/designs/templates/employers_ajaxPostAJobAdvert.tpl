...
<script type="text/javascript">     
    ...
    $("#Modal-Categories").modal({
                ...
                success : function (resp)
                    {
                        if (resp.errors)
                        {
                            $.each(resp.errors,function (name,error) { $(".EmployerAdvertI18n[name="+name+"]").html(error); });
                            return ;
                        }
     ...
     $("#EmployerSignin-Previous").click(function () { 
        return $.ajax2({    url:"{url_to('employers_ajax',['action'=>'PostAJob'])}",                                
                              target: "#t-employer-advert",
                            success: function (resp)
                            {                                                               
                                $("#t-employer-account-tab").addClass('active');
                                $("#t-employer-advert-tab").removeClass('active');
                                $("#t-employer-account").addClass('show active');
                                $("#t-employer-advert").removeClass('show active');
                                $("#t-employer-advert-tab").addClass('nonePointer');
                            }
            });
    });
</script>           
