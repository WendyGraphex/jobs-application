...
<html lang="{$_request->getCountry()}">
    ...
    <body class="signInBody" style="background-image: url('/web/files/pictures/sign3.jpg');background-repeat: no-repeat;background-size: cover;">
                            ...
                            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                                ...
                                <div id="actions" class="SignInDiv">
                                    ...
                                    <div class="form-group groupCkeckBox">
                                        <div class="inner-addon center-block text-center customer-type">
                                            {foreach $form->type->getChoices() as $type=>$value}
                                                <input type="radio" class="Signup Checkboxs Fields Checkbox checksex Radio" id="{$value}" name="type" value="{$type}" {if $form.type->getValue()==$type}checked=""{/if}>
                                    ...
                                    <div class="text-center mt-4 font-weight-light">
                                        ...
                                        <a href="{link_i18n("employers_login")}" class="text-primary">{__('Login')}</a>
                                    </div> 
                                </div>
                            </div>
                        </div>
    ...
    $('#defaultInline1').change(function() {
       ...
       $(function(){
            ...
            $("#Signup").click(function () {  
                ...
                var params = { Signup: { token : '{mfForm::getToken('EmployerSigninForm')}' } };
                ...
                return $.ajax2({  data : params,                               
                                  url:"{url_to('employers_ajax',['action'=>'Signin'])}", 
