    ...
    function getFilterParameters()
        ...
        {          
           return $.ajax2({ data: getFilterParameters(), 
                            url:"{url_to('employers_ajax',['action'=>'ListPartialSearch'])}" ,                          
                            target: "#actions"
                             });
        }
        ...
        $(".pager").click(function () {                     
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('employers_ajax',['action'=>'ListPartialSearch'])}?page="+$(this).attr('data-page'),                                
                                 target: "#actions"
                });
        });
           ...
           $(".Delete").click( function () { 
                ...
                return $.ajax2({ data :{ EmployerSearch: $(this).attr('id') },
                                 url :"{url_to('employers_ajax',['action'=>'DeleteSearch'])}",                               
