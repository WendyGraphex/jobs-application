        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div id="page-wrapper" class="auth-form-light text-center py-5 px-4 px-sm-5 classTopForgotPass">
                ...
                <p class="mt-3" style="font-size: 21px;text-align: center;">{__('Generate a new password')}</p>
	       ...
	       <div class="form-group size center-block">
    			...
    			<input  type="password" class="styleInputPassword form-control-s form-control-lg-s center-block user_password Fields Input" data-toggle="popover" data-html='true' data-placement="top" autocomplete="off" placeholder="{__('Your new password')}" name="password"/>
  		...
  		<div class="form-group size center-block">
    		  <div class="inner-addon left-addon center-block">
                ...
                <div class="form-group btnSize center-block">
                      <center> <a href="#" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn btn-pw-forgot" id="Send" data-loading-text="{__('Envoyer  ')}<i class='fa fa-spinner fa-spin'></i>">{__('Envoyer')}</a> </center>
                </div>
            </div>
       ...
       {JqueryScriptsReady}
           ...
           $("#Send").click(function () { 
                            var params = { EmployerUserForgotPasswordChange :  { 
                                        key: '{$forgot->get('key')}',
                                        token : "{mfForm::getToken('EmployerUserForgotPasswordChangeForm')}"
                                    } };
                          ...
                          $("#Send").button('loading');
                            return $.ajax2({ 
                                data : params,                              
                                url:"{url_to('employers_ajax',['action'=>'ForgotPasswordChange'])}",
                                 error : function (resp) {
                                     $("#Send").button('reset');
