    ...
    <body>
        ...
        <section class="ftco-section bg-light  sectionMarginTop">
            <div id="page-ctn" class="container">  
                ...
                {component name="/employers/siblings" node=$node_i18n->getCategory()}   
                ...
                {if !$node_i18n->getCategory()->isRoot()}          
                    <div class="advertHead">
                        ...
                        <p style="font-family: Tahoma, Geneva, sans-serif;">Grahic Design <i class="mdi mdi-chevron-right"></i> {$node_i18n->getFormatter()->getMetaDescription()->ucfirst()}</p>
                        </div>*}
                    </div>
                {/if}
                ...
                <div id="page-wrapper">  
                    {component name="/employers/categories" node=$node_i18n->getCategory()}
                </div>
            </div>                
        </section>
