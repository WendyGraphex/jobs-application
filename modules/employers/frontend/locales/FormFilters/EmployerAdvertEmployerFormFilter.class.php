...
class EmployerAdvertEmployerFormFilter extends mfFormFilterBase {
    ...
    {     
       ...
       $this->setQuery("SELECT {fields} FROM ".EmployerAdvertI18n::getTable().  
                       ...
                       " WHERE   ".EmployerAdvertI18n::getTableField('status')."='ACTIVE'".
                                ...
                                " AND ".EmployerAdvert::getTableField('employer_user_id').
                             " AND ".EmployerAdvert::getTableField('employer_user_id')."='{employer_user_id}'".
