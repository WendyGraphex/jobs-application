...
class EmployerAdvertSearchFormFilter extends mfFormFilter2 {
    ...
    {                         
       ...
       $this->setValidators(array( 
        ...
        $this->setQuery(mfQuery::getInstance()
                        ->select("{fields}")
                        ->from(EmployerAdvertSearch::getTable())
                        ->left(EmployerAdvertSearch::getOuterForJoin('category_id'))
                        ->left(EmployerWorkCategoryI18n::getInnerForJoin('category_id')." AND ".EmployeeWorkCategoryI18n::getTableField('lang')."='{lang}'")
                        ->where(EmployerAdvertSearch::getTableField('employer_user_id')."='{employer_user_id}'")); 
    }
