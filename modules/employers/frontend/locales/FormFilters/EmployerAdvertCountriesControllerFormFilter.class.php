...
class EmployerAdvertCountriesControllerFormFilter extends mfFormFilter2 {
    ...
    {  
       ...
       $this->setValidators(array( 
        ...
        $this->setQuery(mfQuery::getInstance() 
                    ->select(Country::getTableField('code')." as `country`, count(".EmployerAdvertI18n::getTableField('id').") as `number_of_adverts`")
                    ...
                    ->where(EmployerAdvertI18n::getTableField('published_at')." IS NOT NULL".                                                 
                     ...
                     ->groupBy(Country::getTableField('code')));                 
