...
class EmployerPartnerWorkCategoryDialogFormFilter extends mfFormFilterBase {
    ...
    {  
       ...
       $this->setQuery("SELECT {fields} FROM ".PartnerWorkCategory::getTable(). 
                       ...
                       " WHERE level={levelplusone} AND  lb >= {lb} AND rb <= {rb} AND ".PartnerWorkCategory::getTableField('is_active')."='YES'". 
                       ";"); 
       // Validators 
