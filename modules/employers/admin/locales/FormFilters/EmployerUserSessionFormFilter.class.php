...
class EmployerUserSessionFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployerUserSession');
       $this->setFields(array(
          
           
             'email'=>array(
                        'class'=>'EmployerUserSession',
                        'search'=>array('conditions'=>EmployerUserSession::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{email}%%' ")
                        ), 
           'ip'=>array(
                        'class'=>'EmployerUserSession',
                        'search'=>array('conditions'=>EmployerUserSession::getTableField('ip')." COLLATE UTF8_GENERAL_CI LIKE '%%{ip}%%' ")
                        ),  
               ));      
       $this->setQuery("SELECT {fields} FROM ".EmployerUserSession::getTable().    
                      " INNER JOIN ".EmployerUserSession::getOuterForJoin('user_id').
                       ";");
       // Validators 
