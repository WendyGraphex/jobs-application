...
class EmployerFunctionFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployerFunction');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'EmployerFunctionI18n',
                        'search'=>array('conditions'=>EmployerFunctionI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'EmployerFunction',
                        'search'=>array('conditions'=>EmployerFunction::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployerFunction::getTable().                      
                       " LEFT JOIN ".EmployerFunctionI18n::getInnerForJoin('function_id'). " AND ".EmployerFunctionI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
