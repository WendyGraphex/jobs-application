...
class EmployerCompanyDialogFormFilter extends mfFormFilterBase {

    protected $gallery_i18n=null;
    
    function __construct(EmployerGalleryI18n $gallery_i18n,$defaults=array())
    {
    ...
    {  
       ...
       {    
            $this->setDefaults(array(
                 ...
                 'selection'=>$this->getGalleryI18n()->getGallery()->getEmployers()->getKeys()->toArray(),              
                 'order'=>array(
                                 "position"=>"asc",                        
                 ),  
                'nbitemsbypage'=>10
