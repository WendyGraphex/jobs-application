...
class EmployerLanguageLevelFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployerLanguageLevel');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'EmployerLanguageLevelI18n',
                        'search'=>array('conditions'=>EmployerLanguageLevelI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'EmployerLanguageLevel',
                        'search'=>array('conditions'=>EmployerLanguageLevel::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployerLanguageLevel::getTable().                      
