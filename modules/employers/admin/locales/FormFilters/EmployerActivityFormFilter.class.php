...
class EmployerActivityFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployerActivity');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'EmployerActivityI18n',
                        'search'=>array('conditions'=>EmployerActivityI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'EmployerActivity',
                        'search'=>array('conditions'=>EmployerActivity::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployerActivity::getTable().                      
                       " LEFT JOIN ".EmployerActivityI18n::getInnerForJoin('activity_id'). " AND ".EmployerActivityI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
