...
class EmployerBudgetUnitFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployerBudgetUnit');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'EmployerBudgetUnitI18n',
                        'search'=>array('conditions'=>EmployerBudgetUnitI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'EmployerBudgetUnit',
                        'search'=>array('conditions'=>EmployerBudgetUnit::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployerBudgetUnit::getTable().                      
                       " LEFT JOIN ".EmployerBudgetUnitI18n::getInnerForJoin('unit_id'). " AND ".EmployerBudgetUnitI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
