...
class EmployerContractTypeFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployerContractType');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'EmployerContractTypeI18n',
                        'search'=>array('conditions'=>EmployerContractTypeI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'EmployerContractType',
                        'search'=>array('conditions'=>EmployerContractType::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployerContractType::getTable().                      
                       " LEFT JOIN ".EmployerContractTypeI18n::getInnerForJoin('type_id'). " AND ".EmployerContractTypeI18n::getTableField('lang')."='{lang}'".                                                        
                       ";"); 
       // Validators 
