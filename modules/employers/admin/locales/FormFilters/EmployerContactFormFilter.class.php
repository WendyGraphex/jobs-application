...
class EmployerContactFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployerContact');
       
       $this->setFields(array(
           'lastname'=>array(            
              'search'=>array('conditions'=>
                                                 "(".
               EmployerContact::getTableField('lastname')." COLLATE UTF8_GENERAL_CI LIKE '%%{lastname}%%' OR ".
               EmployerContact::getTableField('firstname')." COLLATE UTF8_GENERAL_CI LIKE '%%{firstname}%%'".
                                                 ")")
                                ),
           'firstname'=>array(             
              'search'=>array('conditions'=>
           ...
           'email'=>array(                     
                        'search'=>array('conditions'=>EmployerContact::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{email}%%' ")
                        ),          
           'address1'=>array(                       
                        'search'=>array('conditions'=>EmployerContact::getTableField('address1')." COLLATE UTF8_GENERAL_CI LIKE '%%{address1}%%' ")
                        ),
           'address2'=>array(                       
                        'search'=>array('conditions'=>EmployerContact::getTableField('address2')." COLLATE UTF8_GENERAL_CI LIKE '%%{address2}%%' ")
                        ),
           'city'=>array(                       
                        'search'=>array('conditions'=>EmployerContact::getTableField('city')." COLLATE UTF8_GENERAL_CI LIKE '%%{city}%%' ")
                        ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployerContact::getTable().                            
                       ";"); 
       // Validators 
               ...
               // "number_of_try"=>new mfValidatorString(array("required"=>false)),    
                ...
                'equal' => new mfValidatorSchema(array(
                  ...
                  //  "status"=>new mfValidatorChoice(array("required"=>false,'key'=>true,"choices"=>array(""=>"","DELETE"=>__("DELETE"),"ACTIVE"=>__("ACTIVE")))),
                          ...
                          //  "customer_id"=>new mfValidatorChoice(array("choices"=>array(""=>"")+ProductFavoriteUtils::getEmployerFieldValuesForSelect($this->getSite()),"key"=>true,"required"=>false)),
                            ),array("required"=>false)),                                         
