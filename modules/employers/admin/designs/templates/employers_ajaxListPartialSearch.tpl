          ...
          <div class="row admin-header-container">
            <div class="col-sm">
              ...
              <h3 class="admin-header-small-text">{__('Employer searchs management')}</h3>
            </div>
          ...
          <div class="breadcrumb-title">
            <p>
                ...
                <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('Searchs')}
            </p>
          </div>
          <!-- End breadcrumb -->
{alerts}
...
{* =================================== ACTIONS ======================================================== *}
      ...
      $(".View").click( function () {                    
                  return $.ajax2({ data : { Employer : $(this).attr('id') },                               
                                  url:"{url_to('employees_ajax',['action'=>'ViewEmployer'])}", 
     ...
     $(".Delete").click( function () { 
                ...
                return $.ajax2({ data :{ EmployerSearch: $(this).attr('id') },
