      ...
      <div class="row">          
           <div class="form-group col-md-6">             
            ...
            <div class="field_with_errors">
                <input class="EmployerCityGallery form-control Fields Input" type="text" value="{$item_i18n->getGallery()->get('name')}" name="name" id="name">
            </div>
          </div>   
            <div class="form-group col-md-6">
            ...
            <div class="field_with_errors">
                <input class="EmployerCityGallery form-control Fields Input" type="text" value="{$item_i18n->getGallery()->get('tpl')}" name="tpl" id="tpl">
            </div>
          </div> 
         </div>
          <div class="row">
            <div class="form-group col-md-6">
                ...
                <div class="field_with_errors">
                    <input class="EmployerCityGalleryI18n form-control Fields Input" type="text" value="{$item_i18n->get('title')}" name="title" id="title">
                </div>
            </div>
            <div class="form-group col-md-6">
                ...
                <div class="field_with_errors">
                    <input class="EmployerCityGallery form-control Fields Input" type="text" value="{$item_i18n->getGallery()->get('number_of_items')}" name="number_of_items" id="number_of_items">
                </div>
            </div>
        </div>                   
    </div>    
...
<script type="text/javascript">              
     ...
     $('#Cancel').click(function(){                
       ...
       $('#Save').click(function(){                             
            var  params= {  EmployerCityGalleryI18n: { 
                                   gallery_i18n : { lang: "{$item_i18n->get('lang')}",gallery_id: "{$item_i18n->get('gallery_id')}"    },
                                   gallery : { },
                                   token :'{$form->getCSRFToken()}'
                                } };
          $(".EmployerCityGalleryI18n.Input").each(function() { params.EmployerCityGalleryI18n.gallery_i18n[this.name]=$(this).val(); });
          $(".EmployerCityGallery.Input").each(function() {  params.EmployerCityGalleryI18n.gallery[this.name]=$(this).val();  });  // Get foreign key           
          //    alert("Params="+params.toSource());   return ;       
          return $.ajax2({ data : params,                           
                           url: "{url_to('employers_ajax',['action'=>'SaveCityI18n'])}",
                           target: "#actions" }); 
        });  
