...
<div class="row admin-header-container">
    <div class="col-sm">
        <h3 class="admin-header-big-text">{__("New gallery for employers ")}</h3>
...
<script type="text/javascript">              
    ...
    $('#Cancel').click(function(){                
      ...
      $('#Save').click(function(){                                      
            var params = { EmployerGalleryI18n : { gallery: { } , 
                                           gallery_i18n : { lang : $("#SelectListLanguages option:selected").attr('id') }, 
                                           token : "{$form->getCSRFToken()}" } };                                
          $(".EmployerGallery.Input").each(function() { params.EmployerGalleryI18n.gallery[$(this).attr('name')]=$(this).val(); });          
          $(".EmployerGalleryI18n.Input").each(function() { params.EmployerGalleryI18n.gallery_i18n[$(this).attr('name')]=$(this).val(); });          
        //      alert("Params="+params.toSource());   return ;      
          return $.ajax2({ data : params,                            
                           url: "{url_to('employers_ajax',['action'=>'SaveNewGalleryI18n'])}",
                           target: "#actions"}); 
        });  
