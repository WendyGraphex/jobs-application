...
class EmployerFunctionI18nBase extends mfObjectI18n {
     
    protected static $fields=array('title','function_id','lang','created_at','updated_at');
    const table="t_employer_function_i18n"; 
    protected static $foreignKeys=array('function_id'=>'EmployerFunction'); // By default
     ...
     static function create(mfArray $values,$lang)
    {
        ...
        if ($values->isEmpty())
            return ;       
        $collection_i18n = new EmployerFunctionI18nCollection();
        foreach ($values as $value)        
        {
            $item_i18n = new EmployerFunctionI18n();
