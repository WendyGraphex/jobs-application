...
class EmployerCategoryBase extends mfObject3 {
    
     protected static $fields=array('category_id','employer_user_id','created_at','updated_at');    
    const table="t_employer_category"; 
    protected static $foreignKeys=array('employer_user_id'=>'EmployerUser','category_id'=>'PartnerWorkCategory'); // By default
