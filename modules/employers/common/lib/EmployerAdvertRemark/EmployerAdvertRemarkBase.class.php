...
class EmployerAdvertRemarkBase extends mfObject3 {
     
    protected static $fields=array('remarks','advert_i18n_id','created_at','updated_at');    
    const table="t_employee_advert_i18n_remark"; 
    protected static $foreignKeys=array('advert_i18n_id'=>'EmployerAdvertI18n');
    ...
    function loadByAvertI18n(EmployerAdvertI18n $advert_i18n)
    {
