...
class EmployerContentPictureFrame  extends Pictures {
    ...
    {   
        return new PictureObject3(array(
                ...
                "transparent"=>true,
                "urlPath"=>url("/data/employers/".$this->getItem()->get('employer_user_id')."/contents/picture/".$type,"web","frontend"),
                "url"=>url("/data/employers/".$this->getItem()->get('employer_user_id')."/contents/picture/".$type."/".$this->getItem()->get('picture'),"web","frontend")
            ));
    }
