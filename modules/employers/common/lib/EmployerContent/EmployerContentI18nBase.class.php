...
class EmployerContentI18nBase extends mfObject3 {
    ...
    const table="t_employer_content_i18n"; 
    protected static $foreignKeys=array('content_id'=>'EmployerContent'); // By default
    ...
    function __construct($parameters=null) {
      ...
      if (is_array($parameters)||$parameters instanceof ArrayAccess)
      {
        ...
        //     return $this->loadbyCompanyAndLang($parameters['company'],(string)$parameters['lang']);   
             if (isset($parameters['content']) && isset($parameters['lang']) && $parameters['content'] instanceof EmployerContent)
     ...
     protected function loadByContentAndLang(EmployerContent $content,$lang)
    {            
  ...
  /*  function getFormatter()
    ...
    function getContent()
    {
        return $this->_content_id=$this->_content_id===null?new EmployerContent($this->get('content_id')):$this->_content_id;
    }
      
     function getFormatter()
   {
       return $this->formatter=$this->formatter===null?new EmployerContentI18nFormatter($this):$this->formatter;
   } 
