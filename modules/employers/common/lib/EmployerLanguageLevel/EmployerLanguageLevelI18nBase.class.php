...
class EmployerLanguageLevelI18nBase extends mfObjectI18n {
     
    protected static $fields=array('title','level_id','lang','created_at','updated_at');
    const table="t_employer_language_level_i18n"; 
    protected static $foreignKeys=array('level_id'=>'EmployerLanguageLevel'); // By default
