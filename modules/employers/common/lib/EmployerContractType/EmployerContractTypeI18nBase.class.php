...
class EmployerContractTypeI18nBase extends mfObjectI18n {
     
    protected static $fields=array('title','type_id','lang','created_at','updated_at');
    const table="t_employer_contract_type_i18n"; 
    protected static $foreignKeys=array('type_id'=>'EmployerContractType'); // By default
      ...
      function delete()
    {
     ...
     function getType()
    {
       return $this->_type_id=$this->_type_id===null?new EmployerContractType($this->get('type_id')):$this->_type_id;                 
    }    
