...
class EmployerLevelI18nBase extends mfObjectI18n {
     
    protected static $fields=array('title','level_id','lang','created_at','updated_at');
    const table="t_employer_level_i18n"; 
    protected static $foreignKeys=array('level_id'=>'EmployerLevel'); // By default
      ...
      function delete()
    {
     ...
     function getLevel()
    {
       return $this->_level_id=$this->_level_id===null?new EmployerLevel($this->get('level_id')):$this->_level_id;                 
    }    
