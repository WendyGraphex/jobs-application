...
class EmployerAdvertI18nCollection extends mfObjectCollection3 {
    
    
    function add(EmployerAdvertI18n $advert_i18n)
    {
    ...
    function getCollection()
    {
        ...
        {                
            $this->_collection=new EmployerAdvertI18nCollection();          
            foreach ($this as $item)
            {               
                if ($item->get('title'))                   
          ...
          //  var_dump($this->_collection->getLanguages(),$this->getFirst()->get('advert_id'));
             $db=mfSiteDatabase::getInstance()               
                ...
                ->setQuery("DELETE FROM ".EmployerAdvertI18n::getTable().                         
