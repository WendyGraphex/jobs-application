...
class EmployerFavouriteBase extends mfObject3 {
    ...
    const table="t_employer_favourite"; 
   ...
   {
       return $this->formatter=$this->formatter===null?new EmployerFavouriteFormatter($this):$this->formatter;
   }
