...
class EmployerUserForgotPassword extends mfObject3 {
   ...
   function __construct($parameters=null) {
    ...
    function toArray()
    {
        ...
        $values['uri']=link_i18n('employers_forgot_password_change')."?k=".$this->get('key');
        return $values;
    }
    
    function createKeyAndPassword()
    {
        if ($this->getEmployerUser()->isNotLoaded())
            return $this;
        $this->cleanup();
