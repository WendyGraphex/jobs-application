...
class EmployerAdvertDocumentFileManager {
     
    protected $item=null;
     
    function __construct(EmployerAdvertDocument $item) {
        $this->item=$item;
    }
   ...
   /* function escapeFilename(mfString $filename)
    ...
    function getImages()
    {
        return $this->images=$this->images===null?new EmployerAdvertDocumentFileManagerPictures($this):$this->images;
    }
  ...
  /*   function getFile()
    {
        return new FileObject2(array(
                 ...
                 "url"=>url($this->getPathForUrl()."/".$this->getItem()->get('file'),"web","frontend")
              ));
    }*/
      ...
      function getFile()
    {
        return new FileObject2(array(
                 ...
                 "urlPath"=>url_to("employers_document_download",array('file'=>'','id'=>''),mfConfig::get('mf_app')),
                  "url"=>url_to("employers_document_download",array('file'=>$this->getItem()->get('file'),'id'=>$this->getItem()->get('id'),),mfConfig::get('mf_app'))
              ));
    }
    function getFlavicons()
    {     
        return $this->flavicons=$this->flavicons===null?new EmployerAdvertDocumentFileFlavicons($this->getItem()->get('extension')):$this->flavicons;
    }
