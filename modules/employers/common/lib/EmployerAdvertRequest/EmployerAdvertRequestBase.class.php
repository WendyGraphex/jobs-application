...
class EmployerAdvertRequestBase extends mfObject3 {
     
    protected static $fields=array('created_at','updated_at');    
    const table="t_employer_advert_request"; 
   ...
   {
       return $this->formatter=$this->formatter===null?new EmployerAdvertAlertFormatter($this):$this->formatter;
   }
