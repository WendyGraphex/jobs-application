...
class EmployerSearchUserLanguageLetter extends mfString {
    
   
    
     function getUrl()
    {
       return link_i18n('employers_search_user_language_letter',array('letter'=> $this->getValue()),null,'frontend');
    }
    
    
     static function getLetters()
    {     
        $list=new EmployerSearchUserLanguageLetterCollection();
        ...
        {          
            $list[]= new EmployerSearchUserLanguageLetter($row[0]);
        }                   
        return $list->asort();
    }
