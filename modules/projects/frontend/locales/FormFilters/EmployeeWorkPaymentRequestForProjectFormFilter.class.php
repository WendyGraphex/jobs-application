...
class EmployeeWorkPaymentRequestForProjectFormFilter extends mfFormFilterBase{
    ...
    {                    
       ...
       $this->setQuery("SELECT {fields} FROM ". EmployeeWorkPaymentRequest::getTable().   
                       " WHERE employee_user_id='{employee_user_id}' AND quotation_id='{quotation_id}'".
                       ";"); 
       // Validators 
       $this->setValidators(array( 
            ...
            'equal' => new mfValidatorSchema(array(   
                           // "lang"=>new mfValidatorChoice(array("choices"=>array(""=>"")+ProductFavoriteUtils::getLanguagesSort($this->getSite()),"key"=>true,"required"=>false)), 
                             "status"=> new mfValidatorChoice(array("choices"=>array(""=>"",'ACCEPTED'=>__('Accepted'),'ACTIVE'=>__('Active'),'PLANNED'=>__('Planned'),'REFUSED'=>__('Refused'),'PAID'=>__('Paid')),"key"=>true,"required"=>false)),
                            ),array("required"=>false)),  
