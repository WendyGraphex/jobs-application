                        ...
                        {foreach $pager as $item}
                            <tr class="Task list DblClick" id="{$item->get('id')}"> 
                                ...
                                <td>                  
                                    ...
                                    <div>
                                        <i style="font-size:11px">{$item->getFormatter()->getCreatedAt()->getText()} -  
   ...
   // $('.selectColors').selectpicker();                
    ...
    $("#all").click(function () {
        ...
        function updatePager(n)
        {
          ...
          $("[name=nbitemsbypage],.equal.Select").change(function() { return updateFilter(); });                     
           ...
           $(".pager").click(function () {                      
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('projects_ajax',['action'=>'ListPartialTaskForProjectForEmployee'])}?page="+$(this).attr('data-page'),
                                target: "#actions"
                });
        });
          {* =====================  A C T I O N S =============================== *}  
         ...
         $(".View").click( function () {                
          ...
          $(".Documents").click( function () {                
                return $.ajax2({ data : { ProjectTask :  $(this).attr('id') },                                
                                url:"{url_to('projects_documents_ajax',['action'=>'ListPartialDocumentForTaskForEmployee'])}",                              
                                target: "#actions"
                            });
         });
     ...
     $(".Multiple").click(function(){ 
         ...
         return $.ajax2({   data: params,
                            url:"{url_to('projects_ajax',['action'=>'MultipleSelectionTaskForProjectForEmployee'])}" ,                      
                            target: "#actions" });
    });
