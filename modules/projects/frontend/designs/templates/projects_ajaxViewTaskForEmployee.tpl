            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    ...
                    <div class="d-flex">
                        ...
                        <p class="text-muted mb-0">&nbsp;/&nbsp;{__('Project [%s]' ,$item->getProject()->getReference())}</p>
                        <a id="Tasks"><p class="text-primary mb-0 hover-cursor">&nbsp;/&nbsp;{__('Tasks')}</p></a>                       
                        <p class="text-muted mb-0">&nbsp;/&nbsp;{__('View task [%s]',$item->get('reference'))}</p>
                    </div>
                </div> 
                {component name="/site_help/help" help="project-task-view-display"}
            </div>
        </div>
    </div>
            ...
            <div class="card-body">             
             <div class="row">
                <div class="col-md-3">
                 ...
                 <div class="col-md-3">
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label">{__('Color')}{if $form->name->getOption('required')}*{/if}</label>                       
                        <div class="col-sm-8">
                            {if $form.name->hasError()}<div class="w-auto alert {if $form.name->hasError()}alert-danger{/if}">{$form.name->getError()}</div>{/if}
                 ...
                 <div class="col-md-3">
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label">{__('State')}{if $form->name->getOption('required')}*{/if}</label>                                                                 
                        <div class="col-sm-8">                            
...
<script type="text/javascript">      
     ...
     $('#Tasks').click(function(){                                       
      ...
      $("#Save").click(function () { 
        var params = {  ProjectTask :  { id:'{$item->get('id')}', token : '{$form->getCSRFToken()}' } };             
       ...
       // console.log(params); return ;
        return $.ajax2({
            data : params,
            url: "{url_to('projects_ajax',['action'=>'SaveTaskForEmployee'])}",           
            target: "#actions"
        });
