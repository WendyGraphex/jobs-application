...
<script type="text/javascript">
      ...
      function getFilterParameters()
        ...
        {          
           return $.ajax2({ data: getFilterParameters(), 
                            url:"{url_to('site_event_order_ajax',['action'=>'ListPartialOrder'])}" ,                          
                            target: "#actions"
                             });
        }
        ...
        $(".pager").click(function () {                     
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('site_event_order_ajax',['action'=>'ListPartialOrder'])}?page="+$(this).attr('data-page'),                                
                                 target: "#actions"
                });
        });
  ...
  {* =====================  P A G E R  A C T I O N S =============================== *}  
           ...
           $("#init").click(function() {                   
               $.ajax2({ url:"{url_to('site_event_order_ajax',['action'=>'ListPartialOrder'])}",                                    
                         target: "#actions"}); 
           }); 
         ...
         // $("[name=name]").change(function() { return updateFilter(); }); 
           ...
           $(".pager").click(function () {                      
                return $.ajax2({ data: getFilterParameters(), 
                                 url:"{url_to('site_event_order_ajax',['action'=>'ListPartialOrder'])}?"+this.href.substring(this.href.indexOf("?")+1, this.href.length),
                                target: "#actions"
                });
        });    
...
{*  $(".Payments").click(function() {                   
               $.ajax2({ data : { SietEventOrder : $(this).attr('id') },
                         url:"{url_to('site_event_order_ajax',['action'=>'ListPartialPaymentForOrder'])}",                                    
                         target: "#actions"}); 
           });*}
           
      $(".Display").click(function() {                   
               $.ajax2({ data : { SiteEventOrder : $(this).attr('id') },
                         url:"{url_to('site_event_order_ajax',['action'=>'DisplayOrder'])}",                                    
                         target: "#actions"}); 
           });
</script>
