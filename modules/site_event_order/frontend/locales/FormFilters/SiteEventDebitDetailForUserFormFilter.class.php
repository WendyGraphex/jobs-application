...
class SiteEventDebitDetailForUserFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('SiteEventOrderEvent');
       
       $this->setFields(array(
          
         
           ));
       $this->setQuery("SELECT {fields} FROM ".SiteEventOrderEvent::getTable().                         
                       " WHERE ".SiteEventOrderEvent::getTableField('order_id')."='{order_id}'".
                       ";"); 
       // Validators 
