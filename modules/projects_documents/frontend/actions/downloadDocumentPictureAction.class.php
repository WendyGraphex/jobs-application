...
class projects_documents_downloadDocumentPictureAction extends mfAction {
       
    
    function execute(mfWebRequest $request) {               
        $messages = mfMessages::getInstance();            
        $this->user=$this->getUser();                
        $document= new ProjectDocument($request->getRequestParameters(array('file','id')),$this->getUser()->isAuthenticated()?$this->getUser()->getGuardUser():null);
