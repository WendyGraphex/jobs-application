 ...
 return array('all'=>array('classView'=>'SmartyView',                        
     ...
     'ajaxListCategory'=>array( 
      ...
      'ajaxSaveNewCategoryI18n'=>array(
                                    'template'=>"employers_notation_ajaxNewCategoryI18n.tpl",  
      ), 
     
      'ajaxSaveCategoryI18n'=>array(
                                    'template'=>"employers_notation_ajaxViewCategoryI18n.tpl",  
      ), 
     
     "ajaxSaveNewMultipleCategoryI18n"=>array(
         'template'=>'employers_notation_ajaxNewMultipleCategoryI18n.tpl'
     ),
     ...
     'ajaxListCriteria'=>array( 
      ...
      'ajaxSaveNewCriteriaI18n'=>array(
                                    'template'=>"employers_notation_ajaxNewCriteriaI18n.tpl",  
      ), 
     
      'ajaxSaveCriteriaI18n'=>array(
                                    'template'=>"employers_notation_ajaxViewCriteriaI18n.tpl",  
      ), 
     
     "ajaxSaveNewMultipleCriteriaI18n"=>array(
         'template'=>'employers_notation_ajaxNewMultipleCriteriaI18n.tpl'
     ),
