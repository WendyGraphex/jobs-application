...
class EmployerNotationCategoryFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployerNotationCategory');
       $this->setFields(array(
              'title'=>array(
                        'class'=>'EmployerNotationCategoryI18n',
                        'search'=>array('conditions'=>EmployerNotationCategoryI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'name'=>array(
                        'class'=>'EmployerNotationCategory',
                        'search'=>array('conditions'=>EmployerNotationCategory::getTableField('name')." COLLATE UTF8_GENERAL_CI LIKE '%%{name}%%' ")
                            ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployerNotationCategory::getTable().                      
