...
class EmployerAdvertNotationFormFilter extends mfFormFilter2 {
    ...
    {                         
       ...
       $this->setClass('EmployerAdvertI18nEmployerCriteriaNotation');
       ...
       $this->setQuery(mfQuery::getInstance()->select('{fields}')
                       ->from(EmployerAdvertI18nEmployerCriteriaNotation::getTable())                      
                       ->inner(EmployerAdvertI18nEmployerCriteriaNotation::getOuterForJoin('employee_user_id'))
                       ->inner(EmployerAdvertI18nEmployerCriteriaNotation::getOuterForJoin('employer_user_id'))
                       ->inner(EmployerAdvertI18nEmployerCriteriaNotation::getOuterForJoin('employer_criteria_id'))         
                       ->inner(EmployerNotationCriteriaI18n::getInnerForJoin('criteria_id')." AND ".EmployerNotationCriteriaI18n::getTableField('lang')."='{lang}'")  
                       ->left(EmployeeAdvertI18n::getTable()." ON ".EmployeeAdvertI18n::getTableField('advert_id')."=".EmployeeAdvertI18nEmployeeCriteriaNotation::getTableField('employee_advert_id')." AND ".EmployeeAdvertI18n::getTableField('lang')."=".EmployeeAdvertI18nEmployeeCriteriaNotation::getTableField('employee_advert_lang'))                      
                       ->left(EmployerAdvertI18n::getTable()." ON ".EmployerAdvertI18n::getTableField('advert_id')."=".EmployerAdvertI18nEmployerCriteriaNotation::getTableField('employer_advert_id')." AND ".EmployerAdvertI18n::getTableField('lang')."=".EmployerAdvertI18nEmployerCriteriaNotation::getTableField('employer_advert_lang'))                      
                       ->where(EmployerAdvertI18nEmployerCriteriaNotation::getTableField('sender')."='EMPLOYEE'")                   
                       ); 
    }
