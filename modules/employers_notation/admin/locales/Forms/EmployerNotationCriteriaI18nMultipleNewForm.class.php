...
class EmployerNotationCriteriaI18nMultipleNewForm extends mfForm {
    ...
    function configure() {
        $this->setValidators(array(
            ...
            "lang"=> new LanguagesExistsValidator(array(),'frontend'),
             ...
             'category_id'=>new mfValidatorCHoice(array('key'=>true,'required'=>false,'choices'=> EmployerNotationCategory::getCategoriesByPositionForSelect()->unshift(array(''=>''))))
        ));
    }
