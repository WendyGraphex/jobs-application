<h4 style="margin-bottom: 20px;">{__('My review from %s',$project->getEmployeeUser()->get('username'))}</h4>  
    {if !$project->hasEmployeeNotation()}{__('(Not yet reviewed)')}{/if}
{if $project->isLoaded()}

    {foreach $project->getEmployerReviews()->forEmployer() as $category}
<div>
