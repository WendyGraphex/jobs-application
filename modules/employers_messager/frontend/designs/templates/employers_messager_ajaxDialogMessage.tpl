        ...
        <div class="modal-body">       
            ...
            <div id="DropZone" class="form-group dropzone" style="padding: 20px;">        
              <div class="tab-content">   
                ...
                <input class="form-control Fields CustomerEmployerMessage Input" name="subject" type="text" placeholder="{__('Subject')}"/>
                </div>
                <div class="form-group">    
...
<script type="text/javascript">                    
        ...
        $("#Send").click(function () { 
            ...
            return $.ajax2({      data :params,
                                  url :"{url_to('employers_messager_ajax',['action'=>'SendMessageToEmployee'])}",                                                                
