...
require_once __DIR__."/../locales/Forms/SendMessageForRequestForm.class.php";
        
class employers_messager_ajaxSendMessageForRequestAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {     
      ...
      try 
      {    
          $response = new mfArray(array("action"=>"SendMessageForRequest"));
          $form = new SendMessageForRequestForm($this->getUser()->getGuardUser());
