...
class PaymentEmployerUserFormFilter extends mfFormFilterBase{
    ...
    {                    
       ...
       $this->setQuery("SELECT {fields} FROM ". PaymentEmployerUser::getTable().      
                       " INNER JOIN ".PaymentEmployerUser::getOuterForJoin('employer_user_id').
                       " INNER JOIN ".PaymentEmployerUser::getOuterForJoin('order_id').
