...
class EmployeeInvitationFormFilter extends mfFormFilterBase {
    ...
    {                         
       ...
       $this->setClass('EmployeeInvitation');
       
       $this->setFields(array(
           'query'=>array(            
              'search'=>array('conditions'=>
                                                 "(".
               EmployeeInvitation::getTableField('firstname')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".
               EmployeeInvitation::getTableField('lastname')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".             
               EmployeeInvitation::getTableField('email')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".
               EmployeeInvitation::getTableField('phone')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".
               EmployeeInvitation::getTableField('state')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".
               EmployeeInvitation::getTableField('city')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' ".
                                                 ")")
                                ),
              ...
              'profession'=>array(                       
                        'search'=>array('conditions'=>EmployeeInvitation::getTableField('city')." COLLATE UTF8_GENERAL_CI LIKE '%%{city}%%' ")
                        ),
       ));
       $this->setQuery("SELECT {fields} FROM ".EmployeeInvitation::getTable().                            
                       ";"); 
       // Validators 
