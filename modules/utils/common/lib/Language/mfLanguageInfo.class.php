...
class mfLanguageInfo {
    
protected $data=array(),$language=null;
  ...
  public static function getInstance($language = 'en')
  {
    ...
    {
      $instances[$language] = new mfLanguageInfo($language);
    }
  ...
  {
      return array('aa','ab','ae','af','ak','am','an','ar','as','av','ay','az','ba','be','bg','bh','bi','bm','bn','bo',
