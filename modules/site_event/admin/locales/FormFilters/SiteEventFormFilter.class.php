...
class SiteEventFormFilter extends mfFormFilterBase{
    ...
    {                         
       ...
       $this->setFields(array(
              'title'=>array(
                        'class'=>'SiteEventI18n',
                        'search'=>array('conditions'=>SiteEventI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{title}%%' ")
                            ),
              'query'=>array(
                        'class'=>'SiteEventI18n',
                        'search'=>array('conditions'=>
                            "(".
                               SiteEventI18n::getTableField('title')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".
                               SiteEventI18n::getTableField('content')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' OR ".
                               SiteEventI18n::getTableField('short_description')." COLLATE UTF8_GENERAL_CI LIKE '%%{query}%%' ".
                            ")"
                            ),
               ),
       ));
