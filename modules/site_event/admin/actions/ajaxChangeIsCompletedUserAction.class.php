...
class site_event_ajaxChangeIsCompletedUserAction extends mfAction
{
    ...
    function execute(mfWebRequest $request) {   
      ...
      {        
        ...
        $response = array("action"=>"ChangeIsCompletedUser","id"=>$item->get('id'),"value" =>$item->get('is_completed'));                                              
      } 
      catch (mfException $e) {
          $messages->addError($e);
      }
