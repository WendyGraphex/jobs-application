            ...
            <div class="tab-pane fade" id="t-picture" role="tabpanel" aria-labelledby="t-picture-tab">                     
                <div class="row portfolio-grid">
                    ...
                    <div class="col-2">  
                        ...
                        <a href="#" {if !$event_i18n->getEvent()->hasPicture()}style="display:none"{/if} id="DeletePicture" name="{$event_i18n->getEvent()->get('picture')}" class="list-action"><i class="fa fa-trash"></i></a>
                    </div>           
                </div>
            </div>  
            {* ============== SPEAKERS ========================================= *}
...
<script type="text/javascript">
        ...
        $('#Save').click(function(){          
          var params= { SiteEventI18n : { 
                               ...
                               event :{ },
                               event_i18n: {  
                                    event_id: '{$event_i18n->get('event_id')}',
                                    lang: $("#SelectListLanguages option:selected").attr('id')                              
                                         },
         ...
         // alert("Params="+params.toSource());   return;
          return $.ajax2({ 
                            data : params,
                            url: "{url_to('site_event_ajax',['action'=>'SaveEventI18n'])}",
                            target: "#actions"                            
               }); 
   ...
   $("#DeletePicture").click( function () { 
            ...
            return $.ajax2({ data :{ SiteEvent: '{$event_i18n->get('event_id')}' },
...
if ($("#DropZonePicture").find('.dz-default').length)
     ...
     $("#DropZonePicture").dropzone({
      url: "{url_to("site_event_ajax",['action'=>'UploadPictureEvent'])}",
     // clickable: false,
      params: {               
                "SiteEvent" : '{$event_i18n->get('event_id')}',
                "UploadPictureEvent[token]" : '{mfForm::getToken('UploadPictureEventForm')}' 
              },   
       ...
       if ($("#DropZone").find('.dz-default').length)
         ...
         $("#DropZone").dropzone({
            ...
            params: {  
                      ...
                      "UploadDocumentEvent[id]" : '{$event_i18n->getEvent()->get('id')}'
                    },   
