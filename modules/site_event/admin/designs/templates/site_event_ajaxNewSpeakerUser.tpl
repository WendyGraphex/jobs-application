<div class="row admin-header-container">
  <div class="col-sm">
       ...
       <h3 class="admin-header-small-text">{__('New speaker')}</h3>
    </div>
...
<div class="breadcrumb-title">
    <p>
        ...
        <i class="fa fa-angle-right" style="margin: 0 5px 0 5px; font-size: 1em;"></i>{__('New speaker')}
    </p>
</div>
{alerts}
...
<script type="text/javascript">
        ...
        $('#Save').click(function(){ 
              var params= { SiteEventSpeakerUser: {  
                                    token :'{$form->getCSRFToken()}' } };
            $(".SiteEventSpeakerUser.Input").each(function() {  params.SiteEventSpeakerUser[$(this).attr('name')]=$(this).val();  }); 
            $(".SiteEventSpeakerUser.Select option:selected").each(function() {  params.SiteEventSpeakerUser[$(this).parent().attr('name')]=$(this).val();  });  
             $(".SiteEventSpeakerUser.Radio:checked").each(function() {  params.SiteEventSpeakerUser[$(this).attr('name')]=$(this).val();  });
