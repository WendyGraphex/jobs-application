...
class SiteEventSellerCommissionRateBase extends mfObject3 {
     
    protected static $fields=array('commission_id','from','to','fix','rate','start_at','expired_at','is_active','created_at','updated_at');
    const table="t_site_event_seller_commission_rate";
    protected static $foreignKeys=array('commission_id'=>'SiteEventSellerCommission'); // By default
    ...
    {
       return $this->_commission_id=$this->_commission_id===null?new SiteEventSellerCommission($this->get('commission_id')):$this->_commission_id;                 
    }   
    
           function getFormatter()
   {
       return $this->formatter=$this->formatter===null?new SiteEventSellerCommissionRateFormatter($this):$this->formatter;
   }
