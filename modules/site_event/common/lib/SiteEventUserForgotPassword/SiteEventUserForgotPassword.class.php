...
class SiteEventUserForgotPassword extends mfObject3 {
   ...
   function __construct($parameters=null) {
    ...
    function toArray()
    {
        ...
        $values['uri']=link_i18n('site_event_user_forgot_password_change')."?k=".$this->get('key');
        return $values;
    }
