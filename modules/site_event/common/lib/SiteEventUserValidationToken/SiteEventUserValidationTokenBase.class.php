...
class SiteEventUserValidationTokenBase extends mfObject3 {
    ...
    function __construct($parameters=null) {
      ...
      {  
         if ($parameters instanceof SiteEventUser)
    ...
    {
        return array('url'=>link_i18n('site_event_user_validate_email',array(),null,'frontend')."?token=".$this->get('token')."&email=".$this->getUser()->get('email'));
    }
