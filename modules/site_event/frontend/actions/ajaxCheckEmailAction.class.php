...
require_once __DIR__."/../locales/Forms/SiteEventUserCheckEmailForm.class.php";

class site_event_ajaxCheckEmailAction extends mfAction {
    ...
    function execute(mfWebRequest $request) {           
        ...
        {           
            ...
            $form = new SiteEventUserCheckEmailForm($request->getPostParameter('EmailChecker'));
