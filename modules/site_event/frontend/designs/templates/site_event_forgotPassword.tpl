            ...
            <div id="actions" class="actionsPaddingTop">
              <h4>{__("Forgot your password?")}</h4>
                <div class="form-group">
                  ...
                  <input type="text" name="email" class="SiteEventUserForgotPassword Fields Input form-control form-control-lg" placeholder="{__('Email')}">
                </div>
                </div>
                <div class="mt-3">
...
<script type="text/javascript">
    ...
    $('#Send').click(function(){                             
            var  params= {           
                    SiteEventUserForgotPassword: {   
                       email : $(".SiteEventUserForgotPassword[name=email]").val(),
                       token :'{mfForm::getToken('SiteEventUserForgotPasswordForm')}'
                    } };                             
            return $.ajax2({ data : params,                          
                url: "{url_to('site_event_ajax',['action'=>'ForgotPassword'])}",
