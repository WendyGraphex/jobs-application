<div class="row RowTop">
    <div class="col-md-12 grid-margin classConducteurTop">
        ...
        {component name="/site_help/help" help="event-new-place"}
    </div>
</div>
{alerts}
    ...
    <div class="the-box bg-white p-3">          
        ...
        <div class="row">     
            ...
            <div class="form-group col-md-4">             
                ...
                <div class="field_with_errors">
                    {select_country name="country" class="SiteEventPlace SiteEventPlaceSelect form-control Fields Select {if $form.country->hasError()}intro{/if}"  options=$form->country->getOption('choices') selected=$item->get('country')}
                </div>
            </div>          
        </div>
    </div>          
...
<script type="text/javascript">
    ...
    $(".SiteEventPlaceSelect").select2({
        width: 'resolve',
    });
                          
     $(".SiteEventPlace").click(function() { $("#Save").show(); });
      
     $('#Cancel').click(function(){                                          
          return $.ajax2({  url: "{url_to('site_event_ajax',['action'=>'ListPartialPlace'])}",
                           target: "#actions"}); 
     }); 
