<li class="nav-item nav-profile dropdown">
    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
        {if $user->hasAvatar()}  
            <img id="SiteEventUserAvatar" src="{$user->getAvatar()->getThumb()->getUrl()}" alt="{__('My profile')}"/>
        {else}
            <img id="SiteEventUserAvatar" src="{url('icons/user_84308.png','picture')}" alt="{__('My profile')}"/>
        {/if}    
    ...
    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
        ...
        {component name="/site_event/logout"}
    </div>
</li>
