...
<script type="text/javascript">   
    ...
    $(".ModeLogo").click(function(){
      ...
      $('#Save').click(function(){                             
          var  params= { SiteEventUserCompletion: { token :'{$form->getCSRFToken()}'  } };                              
          $(".SiteEventUser.Input").each(function() { params.SiteEventUserCompletion[$(this).attr('name')]=$(this).val(); });                                       
          $(".SiteEventUser.Select option:selected").each(function () { params.SiteEventUserCompletion[$(this).parent().attr('name')]=$(this).val(); });  
              
         //console.log(params);
          return $.ajax2({ data : params,   
                           files: ".files",
                           url: "{url_to('site_event_ajax',['action'=>'SaveCompletion'])}",
                           target: "#page-wrapper"}); 
        }); 
