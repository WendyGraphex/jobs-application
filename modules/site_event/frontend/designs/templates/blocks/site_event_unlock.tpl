    ...
    $('.Input').keyup(function () { 
        $(".Input").removeClass('intro');
            ...
            function lockScreen()
            {
                ...
                $("#lockscreen-ctn").show();                
                return $.ajax2({                       
                       url :"{url_to('site_event_ajax',['action'=>'Lock'])}"                                                      
                });               
            }                        
            ...
            {                   
                   ...
                   $("#Unlock").click(function () { 
                        return $.ajax2({  
                               data : { SiteEventUserUnlock:  { password: $("#Password").val(), token:'{mfForm::getToken('SiteEventUserUnlockForm')}'} }, 
                               url :"{url_to('site_event_ajax',['action'=>'Unlock'])}",                                
