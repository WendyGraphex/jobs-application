...
<div>
  <a href="#" class="btn" id="{$site->getSiteID()}-UserFunction-New" title="{__('new function')}" ><i class="fa fa-plus" style="margin-right:10px;"></i>{*<img  src="{url('/icons/new.gif','picture')}" alt="{__('new')}"/>*}{__('New function')}</a>   
 <a class="btn" id="{$site->getSiteID()}-UserFunction-Import" href="#">
     <i class="fa fa-caret-square-o-up" style=" margin-right: 10px;"></i>
...
<button id="{$site->getSiteID()}-UserFunction-filter" class="btn-table">{__("filter")|capitalize}</button>   <button id="{$site->getSiteID()}-UserFunction-init" class="btn-table">{__("init")|capitalize}</button>
<div>       
...
<table class="tabl-list  footable table" cellpadding="0" cellspacing="0">  
    ...
    <tr class="{$site->getSiteID()}-UserFunction list" {if $item->hasUserFunctionI18n()}id="{$site->getSiteID()}-UserFunction-{$item->getUserFunctionI18n()->get('id')}"{/if}> 
...
<script type="text/javascript">
	...
	$('.footable').footable();
	 ...
	 $("#{$site->getSiteID()}-UserFunction-Import").click( function () { 
                return $.ajax2({
