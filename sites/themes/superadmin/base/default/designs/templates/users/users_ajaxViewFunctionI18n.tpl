...
<div>
    <a href="#" id="{$site->getSiteID()}-UserFunction-Save" class="btn" style="display:none">
         <i class="fa fa-floppy-o" style="color:#000; margin-right:10px;"></i>
         {*<img  src="{url('/icons/save.gif','picture')}" alt="{__('save')}"/>*}{__('save')}</a>
    <a href="#" id="{$site->getSiteID()}-UserFunction-Cancel" class="btn">
...
<table class="tab-form" >
    ...
    <tr class="full-with">
         ...
         <td>
            <div id="UserFunction-error_value" class="error-form">{$form.function.name->getError()}</div>
    ...
    <tr class="full-with">
         <td class="label"><span>{__("function")}</span></td>
         <td>
             <div id="UserFunction-error_value" class="error-form">{$form.function_i18n.value->getError()}</div>
