...
<div>
  <a href="#" class="btn" id="{$site->getSiteID()}-UserAttribution-New" title="{__('new function')}" ><i class="fa fa-plus" style="margin-right:10px;"></i>{*<img  src="{url('/icons/new.gif','picture')}" alt="{__('new')}"/>*}{__('New attribution')}</a>   
...
<button id="{$site->getSiteID()}-UserAttribution-filter" class="btn-table">{__("filter")|capitalize}</button>   <button id="{$site->getSiteID()}-UserAttribution-init" class="btn-table">{__("init")|capitalize}</button>
<div>       
...
<table class="tabl-list  footable table" cellpadding="0" cellspacing="0">
    ...
    <tr class="{$site->getSiteID()}-UserAttribution list" {if $item->hasUserAttributionI18n()}id="{$site->getSiteID()}-UserAttribution-{$item->getUserAttributionI18n()->get('id')}"{/if}> 
