...
<button id="{$site->getSiteID()}-log-filter" class="btn-table">{__("filter")|capitalize}</button>   
<button class="btn-table" id="{$site->getSiteID()}-log-init">{__("init")|capitalize}</button>
<table class="tabl-list footable table" cellpadding="0" cellspacing="0">
    ...
    <tr class="{$site->getSiteID()}-log list" id="{$site->getSiteID()}-log-{$log->getName('log')}">
