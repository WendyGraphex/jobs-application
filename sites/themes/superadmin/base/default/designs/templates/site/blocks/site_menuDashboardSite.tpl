    ...
    {if $menu}
        ...
        {foreach $menu as $item_0}
             {if $user->hasCredential($item_0->get('credentials'))}
              <ul class="list-menu-l1 {$site->getSiteId()}-menu-site-dashboard-level0 menu-site-dashboard-level0">                  
                  {if $item_0.type==null OR $item_0.type==$site->getType()}
                          <li>
                            <h3>{__($item_0.title)|capitalize}</h3>                          
                            <ul class="list-menu-l2 {$site->getSiteId()}-menu-site-dashboard-level1 menu-site-dashboard-level1"> 
