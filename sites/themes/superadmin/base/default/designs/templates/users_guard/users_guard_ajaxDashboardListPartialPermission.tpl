...
<button id="DashboardPermissions-filter" class="btn-table">{__("filter")|capitalize}</button>   <button id="DashboardPermissions-init" class="btn-table">{__("init")|capitalize}</button>
