...
{if  $group->isLoaded()}
    ...
    <div>
        <a id="AddPermissions" class="btn" href="#">
    ...
    {if  $pager->getNbItems()}
        ...
        <button id="PermissionsGroup-filter" class="btn-table">{__("Filter")}</button>   
        <button id="PermissionsGroup-init" class="btn-table">{__("Init")}</button>
