...
<table class="tab-form" cellpadding="0" cellspacing="0">
    ...
    <tr id="group_{$smarty.section.index.index}" class="group_form">
        ...
        <td> 
            <div class="error-form">&nbsp;{$form['groups'][$smarty.section.index.index]['name']->getError()}</div> 
...
<div>
    <a id="Add" href="#" class="btn"  style="{if (string)$form['groups_count'] >= $form->groups_count->getOption('max')}display:none{/if}">
...
<script type="text/javascript">
        ...
        $("#Add").click(function() { 
            ...
            $("#group_"+(id-1)).after('<tr id="group_'+(id)+'" class="group_form"><td>#'+(id+1)+
                  ...
                  '<a href="#" title="{__("delete")}" class="Delete" id="'+(id)+'"> <i class="fa fa-trash" style=" margin-right: 10px"></i></a>'+
                  '</td></tr>');
        });
