...
<div>
    ...
    <a href="{url('/module/users_guard/models/permissions.csv','web')}">{__('Download model')}</a>
</div>
...
<script type="text/javascript">    
      ...
      $('#Cancel').click(function(){   
             ...
             return $.ajax2({ url : "{url_to('users_guard_site_ajax',['action'=>'ListPartialPermission'])}",
