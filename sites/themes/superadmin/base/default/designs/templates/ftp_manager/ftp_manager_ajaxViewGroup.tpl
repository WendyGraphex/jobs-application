...
<table cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td> 
            ...
            <input type="text" class="FtpManagerGroup" name="groupname" size="40" value="{$item->get('groupname')}"/>
        </td>
    </tr>
    <tr>
        ...
        <td><div class="errors_settings">{$form.gid->getError()}</div>
           <input type="text" class="FtpManagerGroup" name="gid" size="10" value="{$item->get('gid')}"/>  
        </td>
    </tr>
     <tr>
        ...
        <td>  <div class="errors_settings">{$form.members->getError()}</div>
              <input type="text" class="FtpManagerGroup" name="members" size="60" value="{$item->get('members')}"/>
        </td>
    </tr>
</table>            
    <script type="text/javascript">
     
        $('#Cancel').click(function(){  return $.ajax2({ url: "{url_to('ftp_manager_ajax',['action'=>'ListPartialGroup'])}",
        ...
        $('#Save').click(function(){ 
              ...
              return $.ajax2({ data: params, 
                               url: "{url_to('ftp_manager_ajax',['action'=>'SaveGroup'])}",
                               target: "#tab-panel-dashboard-superadmin-actions"                            
                               }); 
        });  
