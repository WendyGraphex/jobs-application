...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
        ...
        <!-- Place favicon.ico in the root directory -->
         <link rel="stylesheet" media="all" href="MediConnect%20-%20Home_fichiers/css/bootstrap.css">
...
<script src="MediConnect%20-%20Home_fichiers/app.js"></script>
   ...
   <link rel="stylesheet" media="all" href="MediConnect%20-%20Home_fichiers/mystyle.css">
                ...
                <div class="navbar-header nav-top">
                    <div class="logo mlogo">
                        <div class="logo-img">
                           ...
                           <a href="http://medica10.ewebsolutionskech-dev.com/patient"><img src="MediConnect%20-%20Home_fichiers/logo-5f39a5c9bc03a9322ca6723415553deb98659b530e8d4c558774a1a.PNG" alt="Logo"></a> 
                        </div>
                    </div>
                    <div class="search">
                        <div class="search-icon">
                          
                            <img class="img-search" src="MediConnect%20-%20Home_fichiers/search-9da07c445e954b831233f0223d284667991fb5e5f880c54c7914e.PNG" alt="Search">
                    ...
                    <div class="nav-notification">
                        <div class="notif">
                            <div class="header-icon notif-icon">
                              ...
                              <a href="" title="List of your favorite content" class=""><img src="MediConnect%20-%20Home_fichiers/like.png" alt="Like"></a>
                                
                            </div>
                            <div class="header-icon contact-icon">
                                <img src="MediConnect%20-%20Home_fichiers/notification.PNG" alt="Contact">
                            </div>
                            <div class="header-icon profil-icon">
                                <div class="profil-icon-container">
                                    <div class="profil">
                                      <img src="MediConnect%20-%20Home_fichiers/profil.PNG" alt="Profil">
                                    </div>
                                </div>
                            </div>
...
<div class="div-right" >
    <div class="container-right">
        <div class="dropbtn">
            <img onclick="" src="MediConnect%20-%20Home_fichiers/be-1184aa887fa22c51a08515bc8ee4676b6e12c795da03a5ec2cbd3c765.png" alt="Be" id="ShowCountries" class="ShowCountries">
                      ...
                      <ul class="test">
                         <li class="unread">
                            <a href="http://medica10.ewebsolutionskech-dev.com/">
                              <img src="MediConnect%20-%20Home_fichiers/pictures/flags/ma.png" alt="ma">
                              <label>Morocco</label>
                            </a>
                          </li>
                          <li class="unread">
                            <a href="http://medica10.ewebsolutionskech-dev.com/">
                              <img src="MediConnect%20-%20Home_fichiers/pictures/flags/fr.png" alt="fr">
                              <label>France</label>
                            </a>
                          </li>
                          <li class="unread">
                            <a href="http://medica10.ewebsolutionskech-dev.com/">
                              <img src="MediConnect%20-%20Home_fichiers/pictures/flags/eg.png" alt="eg">
                              <label>Egypt</label>
                            </a>
                          </li>
                           <li class="unread">
        ...
        <p class="dropdown-title">Russian</p>
          ...
          <!----------------Language-------------------->
           ...
           <!-- <img onclick="CountryFunction()" src="patient/country/usa.png"> -->
                                ...
                                <div class="div-medecin-container">
                                    <div class="div-medecin-mouse">
                                        ...
                                        <div class="mouse">
                                            ...
                                            <img src="MediConnect%20-%20Home_fichiers/mouse-6ec64af25b008798307f19204ab966c6038cff7ea2a63e3938c4b0.PNG" alt="Mouse">
                                        </div>
                                    </div>
                          ...
                          <img src="MediConnect%20-%20Home_fichiers/photo-ac030807a4a94874c8c31d6d26abee106be3561031e61cf54976dd.png" alt="Photo" style="width: 100%;">
...
<script src="MediConnect%20-%20Home_fichiers/bootstrap.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
        ...
        <script src="MediConnect%20-%20Home_fichiers/app-4ca33f1f6b96be43223cc753512a78abb4fc0105da9c1583a6df0865.htm"></script>
 ...
 <div class="navbar nav-bottom row">
                <nav class="navbar-nav navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="navbar-collapse" id="navbarSupportedContent" >
                        ...
                        <button class="col-sm items">Contact</button>
                    </div>
                </nav>
  </div>
<main id="view-home">
  <div class="lists-scrollable">
    <nav class="column-left">
      ...
      <a href="http://medica10.ewebsolutionskech-dev.com/patient/items/36534" title="Prévention" class="content-group" style="border-color:;">
        <div class="image" style="border-color:;">
          <img alt="" src="MediConnect%20-%20Home_fichiers/Info.htm">
        </div>
        <section class="title  ">
...
<!-- Begin Collapse menu nav -->
 ...
 <script type="text/javascript">
  ...
  $("#ShowCountries").click(function() {  
                   ...
                   $("#myDropdown").toggle("slide");
                });
  $("#dropbtn-title").click(function() {  

                   $("#myDropdown-title").toggle("slide");
                });
   });
    
    function CountryFunction() {
    if (document.getElementById("myDropdown-title").classList == 'dropdown-title-content show') {
        document.getElementById("myDropdown-title").classList.remove("show");
    }
    console.log('Ok');
    document.getElementById("myDropdown").classList.toggle("show");
}
function CountryLangFunction(lang) {
    ...
    console.log($('.dropdown-title-menu[data-lang=' + lang + ']').length);
    $('.dropdown-title-menu').hide();
    $('.dropdown-title-menu[data-lang=' + lang + ']').show();
...
$(document).ready(function () {
    document.getElementById(".test2").click(function () {
        console.log($(this).text());
        document.getElementById(".dropbtn-title").text($(this).text());
        document.getElementById("myDropdown-title").classList.toggle("show");
    });
    let mainBtn = $('.dropbtn');

    $('.mdropdown-submenu a.test').on("click", function (e) {
        e.stopPropagation();
        e.preventDefault();
        ...
        switch (lng) {
            case "fr":
                mainBtn.html('<div class="dropbtn-title" data-lang="fr" onclick="CountryLangFunction(\'fr\')">France</div><img onclick="CountryFunction()" src="/patient/country/french.jpg">');
                break;
            case "ar":
                mainBtn.html('<div class="dropbtn-title" data-lang="ar" onclick="CountryLangFunction(\'ar\')">Arabic</div><img onclick="CountryFunction()" src="/patient/country/morocco.jpg">');
                break;
            case "jp":
                mainBtn.html('<div class="dropbtn-title" onclick="CountryLangFunction()">Japanese</div><img onclick="CountryFunction()" src="/patient/country/japan.png">');
                break;
            case "kr":
                mainBtn.html('<div class="dropbtn-title" onclick="CountryLangFunction()">Korean</div><img onclick="CountryFunction()" src="/patient/country/korean.jpg">');
                break;
            case "gr":
                mainBtn.html('<div class="dropbtn-title" onclick="CountryLangFunction()">German</div><img onclick="CountryFunction()" src="/patient/country/german.png">');
                break;
            case "sw":
                mainBtn.html('<div class="dropbtn-title" data-lang="ch" onclick="CountryLangFunction(\'ch\')">Swidish</div><img onclick="CountryFunction()" src="/patient/country/swidish.png">');
                break;
            case "us":
                mainBtn.html('<div class="dropbtn-title" onclick="CountryLangFunction()">USA</div><img onclick="CountryFunction()" src="patient/country/usa.png">');
                break;
