...
<div class="tablewhiteback" style="padding: 20px;">
      <div class="row">
            ...
            <table cellpadding="0" cellspacing="0"> 
                ...
                <tr style="height: 60px;">
                   ...
                   <td>
                       ...
                       <input class="CmsPage Input Fields form-control" type="text" name="name" size="10" value="{$page_i18n->getPage()->get('name')|escape}"/>
                   </td>
               </tr>
               <tr style="height: 60px;">
                   ...
                   <input id="last_time_from" class="CmsPageI18n Input form-control" type="text" name="start_at" size="10" value="{if $form->hasErrors()}{$form.page_i18n.start_at}{else}{format_date($page_i18n->get('start_at'),'a')}{/if}"/></td>
               </tr>
               <tr style="height: 60px;">
                   ...
                   <input class="CmsPageI18n Fields Input form-control" id="last_time_to" type="text" name="expired_at" size="10" value="{if $form->hasErrors()}{$form.page_i18n.expired_at}{else}{format_date($page_i18n->get('expired_at'),'a')}{/if}"/></td>
               </tr>              
           </table>
        </div>
             ...
             <table cellpadding="0" cellspacing="0">
               <tr style="height: 60px;">
                   ...
                   <td>
                       ...
                       <input class="CmsPageI18n Fields Input form-control" type="text" name="url" value="{$page_i18n->getURL()}"/>
                   </td>
               </tr>
               <tr style="height: 60px;">
                   <td>{__('Title')}:</td>
                   <td><input class="CmsPageI18n Fields Input form-control" type="text" name="meta_title" value="{$page_i18n->get('meta_title')}"/></td>
               </tr>
               <tr style="height: 60px;">
                   <td>{__('Description')}:</td>
                   <td><textarea class="CmsPageI18n Fields Input form-control" name="meta_description" rows="5" cols="40" style="margin-bottom: 20px;">{$page_i18n->get('meta_description')}</textarea></td>
               </tr>
               <tr style="height: 60px;">
                   <td>{__('Keywords')}:</td>
                   <td><textarea class="CmsPageI18n Fields Input form-control" name="meta_keywords" rows="5" cols="40">{$page_i18n->get('meta_keywords')}</textarea>
                   </td>
               </tr> 
           </table>
         </div>
             ...
             <table cellpadding="0" cellspacing="0">
                <tr style="height: 60px;">
                    ...
                    <td>
                        ...
                        <input class="CmsPageI18n Fields Input form-control" type="text" name="layout" size="10" value="{$page_i18n->get('layout')|escape}"/>
                    </td>
                </tr>
                <tr style="height: 60px;">
                    ...
                    <td>
                       ...
                       <input class="CmsPageI18n Fields Input form-control" type="text" name="template" size="10" value="{$page_i18n->get('template')|escape}"/>
                    </td>
                </tr>
            </table>
         </div>     
        ...
        <div class="tab-pane fade" id="t-content" role="tabpanel" aria-labelledby="t-content-tab">
             <textarea  id="Content" name="content" rows="15" cols="80" style="margin-top: 15px;" class="CmsPageI18n Input Fields form-control">{$page_i18n->get('content')}</textarea>
         </div>
         </div>
    </div>  
</div>
<script type="text/javascript">
        ...
        $('#Save').click(function(){          
          ...
          $(".CmsPageI18n").each(function() { params.CmsPageI18n.page_i18n[$(this).attr('name')]=$(this).val(); });
          $(".CmsPage").each(function() { params.CmsPageI18n.page[$(this).attr('name')]=$(this).val(); });
         // alert("Params="+params.toSource());   return;
          return $.ajax2({ 
                            data : params,
                            url: "{url_to('cms_pages_ajax',['action'=>'SaveNewPageI18n'])}",
                            target: "#actions",
                            success : function (resp) { 
                                    if (resp.action !='SaveNewPageI18n') return ;
                                    if (resp.errors)
                                    {                                        
                                        $('.Input').keyup(function () { 
                                            $(".CmsPageI18n").removeClass('intro');
                                        });
                                        $.each(resp.errors,function (name,error) { $(".CmsPageI18n[name="+name+"]").addClass('intro'); });
                                        return ;
                                    }
                                }
               }); 
