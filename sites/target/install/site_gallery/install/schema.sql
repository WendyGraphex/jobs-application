...
CREATE TABLE IF NOT EXISTS `t_site_gallery` (
    ...
    `type` ENUM('SYSTEM','STANDARD','CUSTOMER','') NOT NULL DEFAULT '',
    PRIMARY KEY (`id`)      
...
CREATE TABLE IF NOT EXISTS `t_site_gallery_i18n` (
            `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
            `site_gallery_id` int(11) unsigned NOT NULL,
...
ALTER TABLE `t_site_gallery_picture` ADD CONSTRAINT `site_picture_fk0` FOREIGN KEY (`site_gallery_id`) REFERENCES `t_site_gallery` (`id`) ON DELETE CASCADE;
